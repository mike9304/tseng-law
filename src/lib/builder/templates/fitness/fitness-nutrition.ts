...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-fitnutri-plan-1-title', { x: 24, y: 24, width: 302, height: 36 }, '다이어트 식단', 3, '#14181f', 'left', 'tpl-fitnutri-plan-1'),
  createTextNode({
  ...
  heading('tpl-fitnutri-plan-2-title', { x: 24, y: 24, width: 302, height: 36 }, '벌크업 식단', 3, '#14181f', 'left', 'tpl-fitnutri-plan-2'),
  createTextNode({
  ...
  heading('tpl-fitnutri-plan-3-title', { x: 24, y: 24, width: 302, height: 36 }, '건강 관리 식단', 3, '#14181f', 'left', 'tpl-fitnutri-plan-3'),
  createTextNode({
  ...
  ...buildCategoryProofSections('fitness', 'fitness-nutrition', STAGE_H),
]);
