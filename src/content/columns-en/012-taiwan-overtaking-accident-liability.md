...
[Article 101 of Taiwan's current Road Traffic Safety Regulations](https://laws.gov.taipei/Law/LawSearch/LawArticleContent/FL012455) sets out both conditions in which overtaking is prohibited and the sequence drivers must follow when overtaking is permitted.
...
When seeking to pass a vehicle in the same lane, the driver behind must first sound two short horn signals or flash the headlights once. The driver must not repeatedly sound the horn or flash the headlights to force the vehicle ahead to yield.
...
## An anonymized account handled by the firm
...
According to those assessments, A was found primarily responsible for the collision. That conclusion was limited to the facts of this case. The assessments considered several circumstances together: A attempted to pass two vehicles traveling in a line ahead, entered the oncoming lane, was traveling at a speed that left too little time to brake, and had not given the prescribed horn or headlight signal. Vehicle 2's rapid lane change was also part of the accident sequence.
...
Before overtaking, first determine whether the location or traffic conditions make the maneuver prohibited. Where the same-lane procedure applies, use the prescribed horn or headlight signal without trying to force the vehicle ahead to yield, wait for a clear indication of yielding, and complete the passing sequence with adequate clearance and a safe return distance.

Compliance with Article 101 is important, but it does not guarantee that an accident will be avoided or determine the outcome of a later expert assessment or lawsuit. Drivers should leave additional safety margins and respond to the road conditions in front of them.

For supplementary reading, see [Illustrated guide to overtaking rules and steps](https://gonews.com.tw/car/daily/21934/). Because it is a secondary source, consult the current official regulations when checking the legal requirements.
