...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  bn: {
    consultationNotice:
      'এই পাতাগুলো বাংলায় লেখা, কিন্তু আইনজীবীর পরামর্শ কেবল ইংরেজি, চীনা (中文), জাপানি ও কোরীয়তে হয়।',
    discoveryNotice:
  ...
  my: {
    ...
    discoveryNotice:
      'llms.txt ဖိုင်သည် အများပြည်သူ စာမျက်နှာများကို ရှာရန် မြေပုံသာ ဖြစ်သည်။ ရှာဖွေမှု အဆင့်၊ ထောက်ခံချက်၊ ဉာဏ်ရည်တု အကြံပြုချက် သို့မဟုတ် ပြသမှုကို အာမမခံပါ။',
    confidentialNotice:
  ...
  ta: {
    consultationNotice:
      'இந்தப் பக்கங்கள் தமிழில் எழுதப்பட்டுள்ளன; ஆனால் வழக்கறிஞரின் ஆலோசனை ஆங்கிலம், சீனம் (中文), ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
    discoveryNotice:
  ...
  km: {
    consultationNotice:
      'សេចក្ដីណែនាំនេះសរសេរជាភាសាខ្មែរ ប៉ុន្តែការពិគ្រោះយោបល់ជាមួយមេធាវីធ្វើឡើងតែជាភាសាអង់គ្លេស ភាសាចិន (中文) ភាសាជប៉ុន និងភាសាកូរ៉េ',
    discoveryNotice:
      'ឯកសារ llms.txt នេះគ្រាន់តែជាផែនទីសម្រាប់រកទំព័រសាធារណៈ។ វាមិនធានាលំដាប់ក្នុងលទ្ធផលស្វែងរក ការគាំទ្រ ការណែនាំដោយ AI ឬការបង្ហាញនៅទំព័រណាមួយឡើយ។',
    confidentialNotice:
      'ដោយអត្ថបទដើមត្រូវបានរក្សាទុក សូមកុំសរសេរព័ត៌មានដែលមិនទាន់ចាំបាច់នៅដំណាក់កាលដំបូង ដូចជាលេខលិខិតឆ្លងដែន លេខអត្តសញ្ញាណប័ណ្ណ ឬទិន្នន័យគណនីធនាគារ។',
  },
  mn: {
    consultationNotice:
