...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-petgal-grid-title', { x: 80, y: GRID_Y, width: 400, height: 50 }, '갤러리', 2, '#2b2018', 'left'),
  ...imgNodes,
  ...buildCategoryContactMethods('pet', 'pet-gallery-dir', STAGE_H),
  ...buildCategoryProofSections('pet', 'pet-gallery', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
