...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Info cards ─────────────────────────────────────────── */
  heading('tpl-cafecon-info-title', { x: 80, y: INFO_Y, width: 400, height: 50 }, '방문 정보', 2, '#1f2622', 'left'),
  ...
  heading('tpl-cafecon-loc-t', { x: 24, y: 24, width: 312, height: 36 }, '위치 & 지도', 3, '#1f2622', 'left', 'tpl-cafecon-location'),
  createTextNode({
  ...
  heading('tpl-cafecon-hours-t', { x: 24, y: 24, width: 312, height: 36 }, '영업시간', 3, '#1f2622', 'left', 'tpl-cafecon-hours'),
  createTextNode({
  ...
  heading('tpl-cafecon-extra-t', { x: 24, y: 24, width: 312, height: 36 }, '편의시설', 3, '#1f2622', 'left', 'tpl-cafecon-extra'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('cafe', 'cafe-contact-dir', STAGE_H),
  ...buildCategoryProofSections('cafe', 'cafe-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
