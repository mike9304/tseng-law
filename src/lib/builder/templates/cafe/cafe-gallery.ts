...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-cafegal-grid-title', { x: 80, y: GRID_Y, width: 400, height: 50 }, '카페의 순간들', 2, '#1f2622', 'left'),
  ...imgNodes,
  ...buildCategoryContactMethods('cafe', 'cafe-gallery-dir', STAGE_H),
  ...buildCategoryProofSections('cafe', 'cafe-gallery', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
