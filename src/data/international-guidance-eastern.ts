...
export const greekGuidanceContent: GuidanceLocaleContent = {
  ...
  pages: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Δεν υποσχόμαστε ούτε διερμηνέα, ούτε προθεσμία απάντησης, ούτε ραντεβού μέσω αυτής της σελίδας. Αν δεν μπορείτε να χρησιμοποιήσετε καμία από τις τέσσερις γλώσσες, η σελίδα «Επικοινωνία» εξηγεί πώς εξετάζουμε έναν τρόπο επικοινωνίας.',
          ],
        },
        {
    ...
    lawyers: {
      ...
      description: 'Προφίλ των δικηγόρων, του νομικού συνεργάτη, του υπευθύνου λειτουργιών και του συνεργαζόμενου λογιστή της Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
