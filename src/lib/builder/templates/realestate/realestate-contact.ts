...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-recontact-office-1-title', { x: 24, y: 16, width: 300, height: 28 }, '강남 본점', 3, '#26313d', 'left', 'tpl-recontact-office-1'),
  createTextNode({
  ...
  heading('tpl-recontact-office-2-title', { x: 24, y: 16, width: 300, height: 28 }, '여의도 지점', 3, '#26313d', 'left', 'tpl-recontact-office-2'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('realestate', 'realestate-contact-dir', STAGE_H),
  ...buildCategoryProofSections('realestate', 'realestate-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
