...
faq:
  - q: "停止經營的台灣公司，資本金可以直接匯回韓國嗎？"
    a: "不行。必須經過公司「解散」與「清算」程序，股東才能收回公司的剩餘財產（資本金）。若直接挪用公司資金，依公司法第9條可處5年以下有期徒刑、拘役或新台幣50萬元以上250萬元以下罰金。"
  - q: "公司解散的決議要件為何？"
    a: "有限公司須經全體股東表決權三分之二以上同意（公司法第113條第1項）；股份有限公司須有代表已發行股份總數三分之二以上股東出席，出席股東表決權過半數同意（公司法第316條），並於15日內向主管機關提交股東會決議議事錄及公司解散申請書（公司登記法第4條）。"
  - q: "不想解散、清算，只想收回投資款怎麼辦？"
    a: "可進行「減資」程序。但即使公司沒有資本金，若放著不管，仍須依法辦理稅務申報，否則可能被處罰鍰甚至停業處分；若想暫時觀望，可向國稅局及經濟部申請「停業」（每次1年，屆滿可延長）。"
---
