...
export const guidanceContent: Record<GuidanceLocale, GuidanceLocaleContent> = {
  ...
  ar: {
    ...
    home: {
      ...
      columnsOriginalLanguageNote:
        'المقالات أدناه ليس لها نسخة عربية. وتبقى القائمة بلغتها الأصلية وتفتح الصفحة بتلك اللغة؛ ولا يُترجَم المحتوى ترجمة آلية.',
      imageBandAlt:
    ...
    pages: {
      ...
      columns: {
        ...
        description:
          'فهارس مقالات القانون التايواني بلغاتها الأصلية. وليست في هذه الصفحة مقالات بالعربية بعد؛ والمحتوى معلومات عامة وقت النشر، وليس رأيًا قانونيًا في قضيتك.',
        intro:
          'ينشر المكتب مقالات تشرح موضوعات شائعة في القانون التايواني. ولا تضمّ هذه الصفحة مقالات بالعربية بعد؛ وفيها أربعة روابط، يفتح كل رابط منها فهرس المقالات بإحدى اللغات الأصلية. وعند توفّر نسخة عربية من مقال تُدرَج في هذه الصفحة.',
        sections: [
          {
            ...
            paragraphs: [
              ...
              'وهذه الفهارس الأربعة فهارس باللغة الأصلية، لا قوائم ترجمات. وليست في هذه الصفحة مقالات بالعربية.',
            ],
          },
          {
