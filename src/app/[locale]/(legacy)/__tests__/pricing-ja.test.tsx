...
describe('Japanese pricing integration', () => {
  it('publishes Japanese metadata with the reviewed SEO contract', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      pt: `${SITE_URL}/pt/pricing`,
      'zh-Hans': `${SITE_URL}/zh-hans/pricing`,
      ...
      bn: `${SITE_URL}/bn/pricing`,
      ur: `${SITE_URL}/ur/pricing`,
      fa: `${SITE_URL}/fa/pricing`,
      my: `${SITE_URL}/my/pricing`,
      ta: `${SITE_URL}/ta/pricing`,
      ne: `${SITE_URL}/ne/pricing`,
      km: `${SITE_URL}/km/pricing`,
      mn: `${SITE_URL}/mn/pricing`,
      sk: `${SITE_URL}/sk/pricing`,
      bg: `${SITE_URL}/bg/pricing`,
      hr: `${SITE_URL}/hr/pricing`,
      sr: `${SITE_URL}/sr/pricing`,
      sl: `${SITE_URL}/sl/pricing`,
      lt: `${SITE_URL}/lt/pricing`,
      lv: `${SITE_URL}/lv/pricing`,
      et: `${SITE_URL}/et/pricing`,
      ca: `${SITE_URL}/ca/pricing`,
      is: `${SITE_URL}/is/pricing`,
  ...
  it('renders the exact reviewed Japanese prices, qualifications, and CTA', () => {
    ...
    expect(html).toContain('メールで相談日程を問い合わせる');
    expect(html).toContain('相談日時はメールで調整した後に確定します。');
    expect(html).not.toContain('法律相談を申し込む');
  ...
  it.each([
    ...
    (locale, currency, consultationTitle, litigationPrice, ctaLabel, ctaNote) => {
