...
describe('Japanese privacy integration', () => {
  it('publishes exact Japanese metadata with four-language alternates', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      'zh-Hans': `${SITE_URL}/zh-hans/privacy`,
      ...
      da: `${SITE_URL}/da/privacy`,
      nb: `${SITE_URL}/nb/privacy`,
      fi: `${SITE_URL}/fi/privacy`,
      cs: `${SITE_URL}/cs/privacy`,
      hu: `${SITE_URL}/hu/privacy`,
      ro: `${SITE_URL}/ro/privacy`,
      uk: `${SITE_URL}/uk/privacy`,
      el: `${SITE_URL}/el/privacy`,
      he: `${SITE_URL}/he/privacy`,
      bn: `${SITE_URL}/bn/privacy`,
      ur: `${SITE_URL}/ur/privacy`,
      fa: `${SITE_URL}/fa/privacy`,
      my: `${SITE_URL}/my/privacy`,
      ta: `${SITE_URL}/ta/privacy`,
      ne: `${SITE_URL}/ne/privacy`,
      km: `${SITE_URL}/km/privacy`,
      mn: `${SITE_URL}/mn/privacy`,
      sk: `${SITE_URL}/sk/privacy`,
      bg: `${SITE_URL}/bg/privacy`,
      hr: `${SITE_URL}/hr/privacy`,
      sr: `${SITE_URL}/sr/privacy`,
      sl: `${SITE_URL}/sl/privacy`,
      lt: `${SITE_URL}/lt/privacy`,
      lv: `${SITE_URL}/lv/privacy`,
      et: `${SITE_URL}/et/privacy`,
      ca: `${SITE_URL}/ca/privacy`,
      is: `${SITE_URL}/is/privacy`,
