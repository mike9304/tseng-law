...
Šis raksts, pamatojoties uz lietu, kurā korejiešu students sporta zālē (健身房) Taivānā savainojās, saņemot trenera (教練) norādījumus, skaidro tiesisko kārtību, ko pēc traumas sporta zālē var izvērtēt, prasījuma termiņus, pierādījumu saglabāšanas (保全證據) veidus un zaudējumu atlīdzības (損害賠償) posteņus.
...
Ja ir izpildītas noziedzīga nodarījuma — aiz neuzmanības nodarīta miesas bojājuma (過失傷害) — likumā noteiktās pazīmes, var izvērtēt kriminālo sūdzību (告訴). Var izvērtēt arī civiltiesisku prasījumu par zaudējumu atlīdzību, tomēr kurš pamats piemērojams — līgumiskā atbildība, delikts (侵權行為) vai patērētāju aizsardzība — un atbildības apjoms atšķiras pēc konkrētajiem lietas apstākļiem. Tas, ka vienā negadījumā var izvērtēt vairākas procedūras, nenozīmē ne to, ka tās visas jāveic, ne to, ka kādā no tām panākums būtu garantēts.
...
## 4. Kādus zaudējumu posteņus var prasīt no sporta zāles?
