...
export const guidanceContent: Record<GuidanceLocale, GuidanceLocaleContent> = {
  ...
  ar: {
    ...
    menuLabel: 'قائمة الصفحات',
    languageLabel: 'لغة العرض',
    mega: {
      services: {
        description: 'يتولّى المكتب مجموعات العمل الرئيسية وفق القانون التايواني.',
    ...
    pages: {
      home: {
        ...
        sections: [
          ...
          {
            heading: 'مجموعات العمل التي يقبلها المكتب',
            paragraphs: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'وعند إرسال الطلب يمكنك كتابة الملخّص بلغتك. ويُحفَظ النص الأصلي كما كتبته ولا يُترجَم ترجمة آلية. والطلب المُرسَل طلب ينتظر المراجعة: فإرساله ليس جلسة جرت، وليس موعدًا مؤكّدًا.',
            ],
          },
        ],
      },
      services: {
        ...
        description:
          'مجموعات العمل الست التي تدخل في نطاق خدمات المكتب في تايوان، مع الحدود التي ينبغي معرفتها قبل التواصل.',
        intro:
          'فيما يلي مجموعات العمل التي يقبلها المكتب فعليًا، مع النقاط التي يكثر السؤال عنها في المرحلة الأولى. ويساعدك هذا العرض على تحديد ما إذا كانت قضيتك تدخل في نطاق المساعدة؛ وهو معلومات عامة، وليس تحليلًا قانونيًا لملف بعينه.',
        sections: [
          {
          ...
          },
          {
            ...
            paragraphs: [
              'يقبل المكتب قضايا الطلاق (離婚)، وتقسيم الأموال، وممارسة الحقوق والواجبات تجاه الأبناء القاصرين وتحمّلها (未成年子女權利義務之行使或負擔)، والزيارة (會面交往)، والميراث (繼承)، بما في ذلك الحالات التي يوجد فيها الأطراف أو الأموال في دول متعددة. والقضايا ذات العنصر الأجنبي تحتاج غالبًا إلى بحث إضافي في وثائق الأحوال المدنية (戶籍) وفي شكل المحررات وطريقة إثباتها في تايوان.',
      ...
      about: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'بعد تسلّم ملخّصك، يراجع المحامي محتواه ثم يتحدث معك عن نطاق العمل الممكن، وعن المستندات اللازمة، وعن الخطوات التالية. وفي القضايا التي تنشأ فيها مسائل محاسبية أو ضريبية، يمكن أن يعمل المكتب مع قسم المحاسبة لمعالجتها ضمن المسار نفسه.',
      ...
      disclaimer: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'ليس في هذه الصفحات ما يُعدّ التزامًا بنتيجة قضية، أو بقبول ملف، أو بصفة الإقامة وصفة العمل.',
