...
const faq = [
  ...
  },
  {
    ...
    a: '広告は、文言だけでなく、名称、文字、画像、記号、音声等の表現全体を基準に判断されます。虚偽・誇大な表現と医療的効能の標榜は禁止されており、ニキビの治療、抗炎症、殺菌等の医療的な表現には特に注意が必要です。行政上の過料は、虚偽・誇大広告の場合はNT$4万～NT$20万、医療的効能を標榜した場合はNT$60万～NT$500万です。インフルエンサー等の投稿も、実質的に広告であれば同じ基準で確認する必要があります。',
  },
];
