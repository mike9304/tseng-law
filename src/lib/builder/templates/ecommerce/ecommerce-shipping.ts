...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-ecship-zone-1-title', { x: 24, y: 12, width: 292, height: 30 }, '수도권', 3, '#1a1a2e', 'left', 'tpl-ecship-zone-1'),
  createTextNode({
  ...
  heading('tpl-ecship-zone-2-title', { x: 24, y: 12, width: 292, height: 30 }, '지방', 3, '#1a1a2e', 'left', 'tpl-ecship-zone-2'),
  createTextNode({
  ...
  heading('tpl-ecship-zone-3-title', { x: 24, y: 12, width: 292, height: 30 }, '제주/도서산간', 3, '#1a1a2e', 'left', 'tpl-ecship-zone-3'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('ecommerce', 'ecommerce-shipping-dir', STAGE_H),
  ...buildCategoryProofSections('ecommerce', 'ecommerce-shipping', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
