...
export function createHeroDecomposedNodes(
  ...
  const nodes: BuilderCanvasNode[] = [
    ...
    createHomeContainerNode({
      id: searchWrapperId,
      parentId: rootId,
      rect: { x: 72, y: 630, width: 1120, height: 120 },
      zIndex: 2,
    ...
    createHomeContainerNode({
      ...
      rect: { x: 0, y: 0, width: 1120, height: 120 },
      zIndex: 0,
    ...
    createHomeContainerNode({
      ...
      rect: { x: 0, y: 0, width: 620, height: 96 },
      zIndex: 0,
    ...
    createHomeContainerNode({
      ...
      rect: { x: 0, y: 12, width: 620, height: 54 },
      zIndex: 0,
    ...
    createHomeTextNode({
      id: 'home-hero-search-placeholder',
      parentId: searchBarId,
      rect: { x: 20, y: 12, width: 500, height: 28 },
      zIndex: 0,
    ...
    createHomeButtonNode({
      ...
      parentId: searchBarId,
      rect: { x: 560, y: 0, width: 54, height: 54 },
      zIndex: 1,
      label: '⌕',
      href: `/${locale}/search`,
      style: 'ghost',
