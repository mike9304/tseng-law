---
title: "Pacto de período mínimo de trabajo en Taiwán: criterios de validez, gastos de formación y cláusula penal"
...
faq:
  - q: "¿El pacto de período mínimo de trabajo (最低服務年限約定) del contrato laboral de Taiwán es automáticamente nulo?"
    a: "No. Según el artículo 15-1 de la Ley de Normas Laborales de Taiwán (勞動基準法), si el empleador imparte formación técnica especializada (專業技術培訓) y asume el coste, o proporciona una compensación razonable (合理補償) para que el trabajador observe el período mínimo de trabajo, el pacto puede reunir los requisitos legales. No es necesario reunir ambos requisitos a la vez, pero, aun habiendo uno de ellos, el pacto debe mantenerse dentro de un alcance razonable a la luz del conjunto de circunstancias, como la duración y el coste de la formación, la posibilidad de sustituir al personal (人力替補可能性) y el importe y el alcance de la compensación."
...
# Pacto de período mínimo de trabajo en Taiwán: criterios de validez, gastos de formación y cláusula penal
...
Aunque estas cuatro cuestiones figuren juntas en el mismo contrato, el precepto aplicable y la prueba necesaria son distintos. Por ello deben examinarse por separado si el pacto es válido, cuándo produce efectos la manifestación de dimisión, si hay responsabilidad de devolver la prestación anticipada (預付性給付) o el gasto de formación, y si se produjo realmente un daño separado.

## 1. Cuándo produce efectos el pacto de período mínimo de trabajo

El pacto no es automáticamente nulo. Según el artículo 15-1 de la Ley de Normas Laborales de Taiwán (勞動基準法), si el empleador imparte formación técnica especializada (專業技術培訓) y asume el coste, o proporciona una compensación razonable (合理補償) para que el trabajador observe el período mínimo de trabajo, el pacto puede reunir los requisitos legales. No es necesario reunir ambos requisitos a la vez, pero, aun habiendo uno de ellos, el pacto debe mantenerse dentro de un alcance razonable a la luz del conjunto de circunstancias, como la duración y el coste de la formación, la posibilidad de sustituir al personal (人力替補可能性) y el importe y el alcance de la compensación.
...
El artículo 15-1 exige uno de los dos requisitos legales y, además, un examen separado de razonabilidad. Ello no significa que deban proporcionarse siempre a la vez la formación técnica especializada y la compensación razonable, ni que el pacto entero sea automáticamente válido con solo consignar de forma meramente formal uno de los dos.

Tras confirmar el requisito legal, según el apartado 2 se examina por separado si el período pactado y el alcance de la responsabilidad son razonables. El pacto que infringe el requisito legal del apartado 1 o el criterio de razonabilidad del apartado 2 es nulo según el apartado 3. Sin embargo, esta norma es un criterio para examinar el contenido y los hechos de cada pacto, no una norma que declare de entrada válidos o nulos todos los pactos de período mínimo de trabajo.

La circunstancia de que el trabajador haya firmado el contrato puede ser un dato que confirma la existencia del acuerdo, pero no sustituye los requisitos legales. A la inversa, más que extraer de inmediato una conclusión solo porque el pacto es de larga duración, debe comprobarse qué inversión o compensación hubo y por qué se fijó ese período.

## 2. Primer requisito legal: formación técnica especializada y asunción del coste
...
El segundo requisito legal es que el empleador proporcione una compensación razonable por la promesa del trabajador de observar el período mínimo de trabajo. Aquí la compensación debe tener una finalidad y una estructura distintas del salario habitual o de la contraprestación del trabajo que ya debe prestarse. El carácter jurídico no se decide solo porque en el detalle de pago se haya etiquetado como prima de firma, prima de permanencia o prestación anticipada.

Primero debe confirmarse la finalidad del pago. Si es una condición salarial general de contratación, una contraprestación de la promesa de permanecer un período determinado o una recompensa por el logro de resultados, debe quedar claro en el contrato y en los documentos de comunicación. También se examina si la fecha de pago, el importe, el momento de atribución, la conexión con el período de permanencia, las causas de devolución y la fórmula se presentaron de modo que el trabajador pudiera comprenderlos antes del contrato.

La orientación (函釋) del Ministerio de Trabajo de Taiwán (勞動部) de 5 de junio de 2026 explica que, si se toma como compensación razonable del pacto de período mínimo de trabajo una prima de permanencia, una prima de firma u otra prestación anticipada, esa función debe comunicarse con claridad. El que el empleador interprete de nuevo después la finalidad del pago o reclasifique una parte del salario como compensación difícilmente sustituye la comunicación del momento del contrato.
...
## 4. Alcance razonable y cuatro factores de examen

Aunque exista uno de los requisitos legales, el período pactado y la responsabilidad deben estar dentro de un alcance razonable. El artículo 15-1, apartado 2, no ofrece una respuesta fija según el nombre o el oficio, sino que dispone que el contrato concreto y la estructura de inversión y compensación se examinen con los cuatro factores siguientes.

1. Duración y coste de la formación técnica especializada
2. Posibilidad de sustituir a un trabajador del mismo puesto o de un puesto similar
...
El segundo factor, la posibilidad de sustitución, no se fija solo con la alegación del empleador de dificultad de contratación. Se examina si puede obtenerse personal del mismo puesto o de un puesto similar, qué cualificación y nivel de pericia se necesitan, cuánto se tarda habitualmente en cubrir el puesto y si la necesidad operativa que alega el empleador encaja con datos objetivos.
...
En la práctica no se mira solo la portada del material de formación, sino que se contrastan el índice detallado y el registro real de impartición. Debe comprobarse si es un curso periódico que se repite, un curso para una cualificación o una competencia de manejo de equipos concretos, una formación legalmente obligatoria, si el trabajador participó realmente y si el importe reclamado coincide con los justificantes del gasto de formación.
...
Para aplicar el principio de proporción al período no cumplido deben fijarse primero la fecha de inicio y de fin del pacto, los días realmente trabajados y el importe base del cálculo de devolución. Por ejemplo, un importe fijo que no refleja en absoluto el período ya cumplido debe examinarse a la luz del criterio de proporción de la orientación. Si la estructura es de pago fraccionado o de atribución por etapas, también debe calcularse por separado a qué período corresponde cada fracción.

La cuestión de la devolución debe confirmarse por orden: validez del pacto, carácter jurídico de la suma pagada, período ya trabajado, causa de extinción y fórmula de devolución; el importe reclamado no se fija solo porque el contrato emplee la expresión «cláusula penal».
...
Los datos de examen pueden incluir la notificación de despido, la carta de dimisión, el documento de extinción de común acuerdo, el correo electrónico y el registro de mensajería, los datos de cambio de condiciones de trabajo y el registro de asistencia y de trabajo. Aunque se mencionen la salud o las circunstancias del trabajo, esa sola expresión no debe determinar el resultado, sino que se valoran en conjunto el curso real, el fundamento legal de la extinción y las pruebas relacionadas.
...
La valoración de la causa de extinción influye de forma directa también en el alcance de la devolución. Si se aplica el apartado 4, no puede exigirse al trabajador la responsabilidad por infracción del pacto de período mínimo de trabajo ni la devolución del gasto de formación, de modo que la imputación debe confirmarse antes de aplicar la fórmula. Si hay también prestación anticipada y otras reclamaciones separadas, se examinan el carácter jurídico y el fundamento de cada reclamación.
...
1. Si es de 3 meses o más y menos de 1 año: 10 días
2. Si es de 1 año o más y menos de 3 años: 20 días
3. Si es de 3 años o más: 30 días
...
1. Se precisa primero el requisito legal: si se proporcionó formación técnica especializada y se asumió el coste, o si se proporcionó una compensación razonable por la promesa de permanencia.
2. Se distinguen la formación general, la periódica y la legalmente obligatoria de la formación técnica especializada, según el contenido real del curso, la duración y la finalidad.
3. Se conservan el programa del curso, el calendario, el registro de aprovechamiento, las facturas, los recibos y los datos de quién asumió el coste, y se registran por separado el fundamento de los costes externos y de los internos.
4. Se conectan con claridad por escrito la finalidad de la compensación, la fecha de pago, el importe, las condiciones de atribución, la comunicación hecha al trabajador y la fórmula de devolución del período no cumplido.
5. Se documentan el fundamento de cálculo del período pactado, la posibilidad de sustituir personal del mismo puesto o de un puesto similar y la relación entre la necesidad operativa del empleador y la inversión real.
6. Se examina si el período pactado y el importe de devolución son proporcionales al alcance del gasto de formación o de la compensación, y se refleja en la liquidación el período ya trabajado.
7. Tras confirmar de forma individual la causa de extinción y la imputación de responsabilidad, se calculan la fecha real de extinción, el período cumplido y el no cumplido.
8. Antes de descontar del salario o de exigir la devolución, se contrastan el contrato, los datos de pago, la nómina, las comunicaciones de las partes, el requerimiento y el registro de descuentos para comprobar el fundamento jurídico y el procedimiento.

Aunque se utilice un contrato tipo, no debe aplicarse de forma mecánica el mismo período y el mismo importe a cada puesto y a cada trabajador. Las cláusulas deben diseñarse reflejando la inversión formativa real, la compensación y la posibilidad de sustitución, y la finalidad del pago y la fórmula proporcional deben comunicarse de forma comprensible antes de celebrar el contrato.

### Aspectos que el trabajador debe comprobar

1. Se reúnen el original del contrato de trabajo firmado y de los acuerdos de modificación, el material explicativo de la contratación, el material de formación, el programa, el calendario y el registro de aprovechamiento.
2. Se confirman el contenido profesional y técnico de la formación, si es formación general de adaptación o formación legalmente obligatoria, el importe de facturas y recibos y quién asumió realmente el coste.
...
- [Base de datos de normativa nacional de Taiwán: artículo 15-1 de la Ley de Normas Laborales](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=15-1&pcode=N0030001)
- [Base de datos de normativa nacional de Taiwán: artículo 15 de la Ley de Normas Laborales](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=15&pcode=N0030001)
- [Base de datos de normativa nacional de Taiwán: artículo 16 de la Ley de Normas Laborales](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=16&pcode=N0030001)
- [Ministerio de Trabajo de Taiwán: orientación de 5 de junio de 2026 sobre período mínimo de trabajo y devolución de cláusula penal](https://laws.mol.gov.tw/FLAW/FLAWDOC03.aspx?cnt=926&datatype=etype&edate=99991231&lnabndn=1&now=1&recordno=10&sdate=20180000)
