...
faq:
  - q: "Onko kosmetiikan myymiseksi Taiwanissa aina perustettava tytäryhtiö tai sivuliike?"
    a: "Perustaminen ei ole aina vaadittua. On myös mahdollista luovuttaa maahantuonti ja myynti taiwanilaiselle maahantuojalle, joka voi samalla toimia myyntiedustajana. Jos haluatte itse hoitaa taiwanilaista liiketoimintaa, taiwanilaisen tytäryhtiön (子公司) perustaminen ja rekisteröinti eroavat ulkomaisen yhtiön sivuliikkeen (分公司) perustamisesta ja rekisteröinnistä, ja vastuu- ja verorakenne eroavat samoin; ulkomaisen sijoituksen hyväksyntään (僑外投資核准) sekä yhtiön tai sivuliikkeen rekisteröintiin tarvittava aika vaihtelee asian ja sen mukaan, joudutaanko asiakirjoja oikaisemaan tai täydentämään. Ensin on päätettävä liiketoimintamalli ja se taho, jonka on kannettava vastuu kosmetiikan valmistajana tai maahantuojana (化粧品製造或輸入業者)."
...
Jos ulkomaisen sijoituksen menettely on tarpeen, on vahvistettava **talousministeriön sijoitustarkastusosaston (經濟部投資審議司)** ohjeistus nykyisenä toimivaltaisena viranomaisena. Sijoituksen hyväksyntään, varojen siirtoon, yhtiön tai sivuliikkeen rekisteröintiin, pankkitilin avaamiseen, verorekisteröintiin (稅籍登記) ja maahantuojan aseman saamiseen tarvittava aika vaihtelee sijoittajan, toimialan, organisaatiomuodon, toimitettujen asiakirjojen ja sen mukaan, joudutaanko asiakirjoja oikaisemaan tai täydentämään. Siksi on, sen sijaan että markkinoilletulopäivä sidottaisiin oletukseen yhdestä kiinteästä ajanjaksosta, ensin vahvistettava kunkin muodollisuuden soveltaminen ja uusimmat jättämisvaatimukset.
...
PIF on järjestetty tietokokonaisuus, niin jäsennelty, että tuotteen laadusta ja turvallisuudesta voidaan jatkuvasti antaa selvitys. Laadun, turvallisuuden, koostumuksen, väitetyn toiminnon (宣稱功能), valmistustavan, koetulosten ja turvallisuusarvion lisäksi on tuotekohtaisesti järjestettävä perustiedot tuotteesta ja valmistajasta sekä tukitiedot, kuten etiketti. Määräykset kosmetiikan tuotetiedoston hallinnasta (化粧品產品資訊檔案管理辦法) järjestävät tarvittavat tiedot 16 luokkaan, joten kunkin luokan tiedot sekä allekirjoitus- ja kelpoisuusvaatimukset on vahvistettava tuotetyypin mukaan.
...
PIF-työtä, mukaan lukien turvallisuusarvion, voi tukea kolmas osapuoli (第三人), jolla on tarvittava kelpoisuus ja kyky. Myös silloin, kun turvaudutaan kolmannen osapuolen laatimistukeen tai tietojen säilytyspalveluun, lakisääteinen vastuu jää kosmetiikan valmistajalle tai maahantuojalle. On sovittava järjestelystä, jossa alkuperäisvalmistaja, koelaboratorio, turvallisuusarvioija ja taiwanilainen yritys vaihtavat muutostietoja ja kulloinkin allekirjoitettuja tietoja.

### Ajan tasalle saattaminen ja säilytys

Jos raaka-aine tai kaava, valmistustapa ja valmistuspaikka, merkinnät mukaan lukien etiketti, väitetty toiminto tai turvallisuustiedot muuttuvat, on asianomaiset PIF-tiedot tarkastettava ja saatettava ajan tasalle. On myös tutkittava, vaikuttavatko kuluttajavalitukset, ei-toivottujen reaktioiden tapaukset ja uudet koetulokset olemassa olevaan arvioon, joten menettely muutosten hallintaan ensimmäisen laatimisen jälkeen jää tarpeelliseksi.

Määräysten kosmetiikan tuotetiedoston hallinnasta 7 artiklan mukaan säilytysaika on vähintään 5 vuotta siitä päivästä, joka seuraa tuotteen viimeistä toimittamista markkinoille. Samojen määräysten 8 artiklan mukaan säilytyspaikka on kosmetiikan hygienian ja turvallisuuden hallintalain (化粧品衛生安全管理法) 7 artiklan 1 momentin 7 kohdassa tarkoitettu valmistajan tai maahantuojan osoite. Säilytysaikaa koskeva säännös ja säilytyspaikkaa koskeva säännös on pidettävä käytännössä erillään.
...
Kun toimivaltainen viranomainen tarkastaa PIF:n, se ilmoittaa periaatteessa kosmetiikan valmistajalle tai maahantuojalle (化粧品製造或輸入業者) viimeistään 7 päivää ennen tarkastuspäivää. Jos asia kuitenkin kuuluu lakisääteiseen poikkeukseen, joka on määrätty liittyvässä sääntelyssä, tarkastus voi tapahtua ilman ennakkoilmoitusta. Riippumatta siitä, onko ilmoitusta, täydelliset ajan tasalla olevat tiedot on pidettävä jatkuvasti sellaisessa tilassa, että ne voidaan paikantaa ja esittää.

Valheellisten tietojen ilmoittamisesta tuoterekisteröinnissä tai valheellisten tietojen kirjaamisesta PIF:ään voidaan määrätä hallinnollinen sakko (罰鍰) 10.000–1.000.000 TWD (新臺幣). Jos PIF-tiedot sen sijaan ovat epätäydellisiä, toimivaltainen viranomainen määrää tavallisesti korjaamisen määräajassa (限期改正), ja hallinnollinen sakko tulee kysymykseen vasta, jos puutetta ei korjata siinä määräajassa. Valheellisia tietoja ja vielä täydennettävissä olevaa tietojen epätäydellisyyttä ei saa katsoa tuottavan samaa seuraamusta.
...
Influenssereiden, arvioijien tai myyntikumppaneiden julkaisut voidaan sisällön ja kaupallisen kontekstin mukaan katsoa asiallisesti mainonnaksi. Vastikkeen maksaminen, tuotteen luovutus, myyntilinkki, merkin ohje julkaista ja toistuva yhteistyö ovat tekijöitä, jotka kuuluvat tähän arvioon. Sitä vastoin jokaisesta henkilökohtaisesta julkaisusta ei automaattisesti tule merkin mainontaa, joten suhde julkaisijan ja merkin välillä, konkreettinen sisältö ja merkin osallisuuden aste on vahvistettava.
