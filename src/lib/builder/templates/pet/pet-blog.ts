...
const cards: BuilderCanvasNode[] = articles.flatMap((a, i) => {
  ...
  return [
    ...
    heading(`${prefix}-t`, { x: 24, y: 52, width: 312, height: 72 }, a.title, 3, '#2b2018', 'left', prefix),
    createTextNode({
      id: `${prefix}-d`,
      parentId: prefix,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-petblog-grid-title', { x: 80, y: GRID_Y, width: 400, height: 50 }, '최신 글', 2, '#2b2018', 'left'),
  ...cards,
  ...buildCategoryProofSections('pet', 'pet-blog', STAGE_H),
]);
