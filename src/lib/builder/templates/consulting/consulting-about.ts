...
const leaderCards: BuilderCanvasNode[] = leaders.flatMap((l, i) => {
  ...
  return [
    ...
    heading(`${prefix}-name`, { x: 24, y: 24, width: 212, height: 36 }, l.name, 3, '#1f2a2e', 'left', prefix),
    createTextNode({
      id: `${prefix}-role`,
      parentId: prefix,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Firm history ───────────────────────────────────────── */
  heading('tpl-consabt-hist-title', { x: 80, y: HISTORY_Y, width: 400, height: 50 }, '회사 연혁', 2, '#1f2a2e', 'left'),
  createTextNode({
  ...
  /* ── Leadership team ────────────────────────────────────── */
  heading('tpl-consabt-leader-title', { x: 80, y: LEADERS_Y, width: 400, height: 50 }, '리더십 팀', 2, '#1f2a2e', 'left'),
  ...leaderCards,
  ...
  heading('tpl-consabt-values-title', { x: 80, y: 40, width: 400, height: 50 }, '핵심 가치', 2, '#1f2a2e', 'left', 'tpl-consabt-values'),
  createTextNode({
  ...
  ...buildConsultingProofSections('consulting-about', STAGE_H),
]);
