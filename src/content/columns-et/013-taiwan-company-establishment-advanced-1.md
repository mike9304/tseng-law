...
Investeeringute läbivaatamise osakonnal tuleb uurida, kas kõnealust kapitali (資本額) kasutatakse tegelikult investeerimiseesmärkidel
...
Üks Taiwani panga töötaja on mulle isiklikult öelnud, et
...
Kuna investeerimiskava kontroll võtab samuti aega,

tasub teil koostada investeerimiskava ja otsida äriühingu registreerimisaadressi samal ajal.

Välismaalaste investeerimise seaduse (外國人投資條例) artikli 9 järgi peab heakskiidetud sissemakse saabuma täies ulatuses pädeva asutuse määratud tähtaja (核定期限) jooksul; tähtaeg tuleb kinnitada heakskiidudokumendis igas asjas (praktikas määratakse see sageli umbes 1 aastaks).

Selle tähtaja jooksul jääb pärast äriühingu aadressi leidmist ja üürilepingu sõlmimist

piisavalt aega avada pangas ettevalmistuskonto ja kanda kapital.
...
kuid immigratsiooniamet (移民署) on väga hõivatud, seega tasub tulla varakult ja võtta järjekorranumber.
...
kuid kontroll puudutab seda, kas kava on ehtne, mitte seda, kas haridus vastab valdkonnale täpselt.

Võite märkida mitmesuguseid töökogemusi, sealhulgas osalise tööajaga tööd,

ja selgitada nii üksikasjalikult, et kontrollivad isikud saaksid veenduda.

Seda punkti tasub põhjalikult arutada Taiwani advokaadiga.
...
seetõttu tasub lepingu jõustumise päev paigutada võimalikult hiljaks.
...
Seetõttu soovitan otsida tegevuskohta varakult.

Kui läbirääkimine üürileandjaga ei suju ladusalt,

võite vajaduse korral pakkuda üürilepingu notariaalset kinnitamist (公證) või täiendavat tagatist.
...
Näide: kui tegevusala on toitlustus ja soovitakse üürida tavalist ärikontoripinda, on pangakonto avamine väga raske.

Nagu juba öeldud, uurib pank üürilepingut ja kontrollib äriühingu aadressi kohapeal.
...
Näide: kui tegemist on tegevusaladega (營業項目), mis on võimalikud tavalisel ärikontoripinnal, nagu reklaam või hulgimüük, võib äriühingu asutada tavalisel ärikontoripinnal. Enne üürilepingu sõlmimist
