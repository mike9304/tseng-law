...
function songBlock(n: number): BuilderCanvasNode[] {
  ...
  return [
    ...
    heading(`${cId}-title`, { x: 40, y: 24, width: 600, height: 40 }, s.title, 2, '#181320', 'left', cId),
    createTextNode({
      id: `${cId}-text`,
      parentId: cId,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...songBlock(3),
  ...songBlock(4),
  ...buildCategoryContactMethods('music', 'music-lyrics-dir', STAGE_H),
  ...buildCategoryProofSections('music', 'music-lyrics', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
