...
| M158 | CMS | CMS collections/content manager v1 | F07~F16 | 24h | M157 | 🟡 editable CRUD + duplicate/search/sort + CSV + revisions + image fields/asset picker + permissions UI/gates + typecheck/unit/security passed / dataset binding remains |
