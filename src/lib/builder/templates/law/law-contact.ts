...
import { buildLawContactMethods, buildLawProofSections, CONTACT_METHODS_HEIGHT, SUBPAGE_PROOF_HEIGHT } from '../_shared/subpage-proof-sections';
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildLawContactMethods('law-contact-dir', STAGE_H),
  ...buildLawProofSections('law-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
