...
faq:
  - q: "Tayvan’da kozmetik satmak için bağlı şirket veya şube mutlaka kurulmalı mıdır?"
    a: "Tayvan’da bağlı şirket veya şube kurulması zorunlu değildir. İthalat ve satışı, dağıtıcı da olan bir Tayvan ithalatçısına bırakmak da mümkündür. Tayvan işini bizzat işletmek istenirse Tayvan bağlı şirketinin (子公司) kuruluş ve tescili, yabancı şirket şubesinin (分公司) kuruluş ve tescilinden farklıdır; sorumluluk ve vergi yapısı da farklıdır. Yabancı yatırım onayı (僑外投資核准) ile şirket veya şube tescili için gereken süre, her işe ve belgelerinin düzeltilmesi veya tamamlanması olup olmadığına göre değişir. Önce faaliyet modeli ve kozmetik üreticisi veya ithalatçısı (化粧品製造或輸入業者) olarak sorumluluğu üstlenecek taraf belirlenmelidir."
...
Tayvan’da bağlı şirket veya şube kurulması zorunlu değildir. İthalat ve satışı, dağıtıcı da olan bir Tayvan ithalatçısına bırakmak da mümkündür. Tayvan işini bizzat işletmek istenirse Tayvan bağlı şirketinin kuruluş ve tescili, yabancı şirket şubesinin kuruluş ve tescilinden farklıdır; sorumluluk ve vergi yapısı da farklıdır. Yabancı yatırım onayı ile şirket veya şube tescili için gereken süre, her işe ve belgelerinin düzeltilmesi veya tamamlanması olup olmadığına göre değişir. Önce faaliyet modeli ve kozmetik üreticisi veya ithalatçısı olarak sorumluluğu üstlenecek taraf belirlenmelidir.

### Yerel ithalatçıya bırakıldığında

Bir Tayvan ithalatçısı veya dağıtıcı (銷售代理商) ithalat ve satışı üstlenirse, yabancı marka Tayvan’da kendi bağlı şirketi veya şubesi olmadan da bir yapı seçebilir. Dağıtıcı aynı zamanda ithalatçı olabilir veya ayrı bir ithalatçı katılabilir. Ancak hukuki sorumluluğun yüklenmesi, acente, ana dağıtıcı veya dağıtıcı gibi yalnızca sözleşmesel ada göre belirlenmez.

Gerçek iş bölümü tasarlanırken önce kim ürünü ithal eder ve ürün tescilini yapar, kim PIF’i hazırlar, günceller ve saklar doğrulanmalıdır. Etiketleme incelemesi, dağıtım kayıtlarının tutulması, tüketici şikâyetleri ve güvenlik bilgilerinin alınması ile yetkili makamın denetim ve veri taleplerine yanıt için de sorumlu belirlenmelidir. Kozmetik üreticisi veya ithalatçısına yüklenen yasal yükümlülükler ile marka ile satış ortağı arasında sözleşmeyle paylaştırılan işlerin örtüşüp örtüşmediği birlikte incelenmelidir.
...
Aynı usul değildir. Ürün tescili, TFDA’nın (衛生福利部食品藥物管理署) kozmetik ürün tescil platformunda yürütülen ayrı bir işlemdir. PIF, kalite, güvenlik, bileşim, ileri sürülen işlev, üretim yöntemi, deneme sonuçları ve güvenlik değerlendirmesi vb. verileri toplayan ve kozmetik üreticisi veya ithalatçısının hazırladığı, güncellediği ve sakladığı bir dosyadır; PIF’in kendisi TFDA’ya önceden sunulması gereken bir belge değildir. 1 Temmuz 2026’dan itibaren kural olarak bütün kozmetikler PIF rejimine girer; fabrika tescilinden (工廠登記) muaf bir üretim yerinde üretilen katı el yapımı sabun (固態手工香皂) istisnadır.

### Ürün tescilinin anı ve geçerlilik süresi
...
### PIF verileri ve aşamalı uygulama

PIF, ürünün kalitesi ve güvenliğini açıklamaya devam edebilmek için yapılandırılmış bir veri kümesidir. Kalite, güvenlik, bileşim, ileri sürülen işlev (宣稱功能), üretim yöntemi, deneme sonuçları ve güvenlik değerlendirmesinin yanı sıra ürün ve üreticiye ilişkin temel bilgiler ile etiket gibi dayanak verileri ürüne göre sıralanmalıdır. Kozmetik ürün bilgi dosyası yönetim yönetmeliği (化粧品產品資訊檔案管理辦法) gereken verileri 16 kategoride düzenler; her kategorinin verileri ile imza ve yeterlilik şartları ürün türüne göre doğrulanmalıdır.
...
Yanlış veya abartılı reklam (虛偽誇大廣告) için idari para cezası 40.000 ile 200.000 TWD, tıbbi etkinlik iddiası için 600.000 ile 5.000.000 TWD arasındadır. Para cezası aralıkları ihlalin türüne göre değiştiğinden, yayından önce reklamın bütün sunumu dayanak verilerle karşılaştırılmalıdır.

### Influencer’lar, değerlendirme yazarları ve satış ortakları

Influencer’ların, değerlendirme yazarlarının veya satış ortaklarının paylaşımları da içerik ve ticari bağlama göre özünde reklam sayılabilir. Ücret ödenmesi, bedelsiz ürün verilmesi, satış bağlantısı, markanın yayımlama talimatı ve tekrarlayan işbirliği bu değerlendirmede dikkate alınan etkenlerdir. Buna karşılık her kişisel paylaşım kendiliğinden markanın reklamı olmaz; yayımlayan ile marka arasındaki ilişki, somut içerik ve markanın katılım derecesi doğrulanmalıdır.
...
- [Kozmetik Hijyen ve Güvenlik Yönetimi Kanunu](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030013)
- [Kozmetik ürün tescil yönetmeliği (化粧品產品登錄辦法)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030097)
- [Kozmetik ürün bilgi dosyası yönetim yönetmeliği](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030098)
- [TFDA — kozmetik ürün tescilinin konu alanı bildirimi](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30612)
- [TFDA — PIF’in aşamalı uygulanması bildirimi](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30614)
- [TFDA — PIF hazırlama yönergeleri](https://www.fda.gov.tw/tc/includes/GetFile.ashx?id=f639179794512621908&iid=13384)
- [TFDA — kozmetik ürün tescili özel alanı](https://www.fda.gov.tw/TC/siteContent.aspx?sid=3435)
- [TFDA — kozmetik ürün bilgi dosyası özel alanı](https://www.fda.gov.tw/TC/site.aspx?sid=12523)
