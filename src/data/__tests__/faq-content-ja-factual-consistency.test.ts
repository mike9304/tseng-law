...
const expectedJapaneseFaq = [
  ...
  {
    // WO-X1 (J03): nationality-neutral subject; same Article 1050 facts, no Japan-specific rule added.
...
// nationality-neutral ("What is the process for a foreign national to divorce
// in Taiwan?") with the same Article 1050 facts.
const reviewedEnglishFaqBaselineHash =
  'da6e84178701b3f1097e269443958a340c497a0fe7d12d0e45eca193e32a8c77';
