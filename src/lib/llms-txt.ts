...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  el: {
    ...
    discoveryNotice:
      'Το αρχείο llms.txt είναι μόνο χάρτης για την εύρεση των δημόσιων σελίδων· δεν υπόσχεται θέση στην αναζήτηση, έγκριση, σύσταση από τεχνητή νοημοσύνη ούτε εγγυημένη προβολή.',
    confidentialNotice:
