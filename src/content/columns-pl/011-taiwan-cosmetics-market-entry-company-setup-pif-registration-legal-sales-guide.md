...
To nie jest ta sama procedura. Rejestracja produktu jest odrębną formalnością, która odbywa się na platformie rejestracji produktów kosmetycznych TFDA (衛生福利部食品藥物管理署). PIF jest teczką, która zbiera dane o jakości, bezpieczeństwie, składzie, deklarowanej funkcji, sposobie wytwarzania, wynikach badań i ocenie bezpieczeństwa, między innymi, i którą wytwórca lub importer kosmetyków sporządza, aktualizuje i przechowuje; sam PIF nie jest dokumentem, który trzeba z góry przedstawić TFDA. Od 1 lipca 2026 r. co do zasady wszystkie kosmetyki podlegają reżimowi PIF, z wyjątkiem mydła stałego wytwarzanego ręcznie (固態手工香皂) wytwarzanego w miejscu produkcji zwolnionym z rejestracji fabryki (工廠登記).
...
Reżim PIF stosowano etapowo według grup produktów. Od 1 lipca 2026 r. pozostałe kosmetyki też są objęte zakresem stosowania, więc co do zasady stosuje się do wszystkich kosmetyków. Wyjątek ogranicza się do mydła stałego wytwarzanego ręcznie wytwarzanego w miejscu produkcji zwolnionym z rejestracji fabryki. Produkt nie jest wyłączony tylko dlatego, że jest wytwarzany ręcznie albo że używa nazwy mydła; trzeba potwierdzić oba, postać stałą i warunek zwolnienia z rejestracji fabryki miejsca produkcji.
