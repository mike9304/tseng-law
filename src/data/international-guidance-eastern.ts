    ...
    services: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'אנו מטפלים בגירושין (離婚), בחלוקת רכוש, באחריות ההורית כלפי ילדים קטינים (未成年子女權利義務之行使或負擔), בקשר עם הילד (會面交往) ובירושה (繼承), גם כאשר הצדדים או הנכסים מצויים במדינות שונות. עניינים משפחתיים חוצי גבולות מצריכים לעיתים קרובות בדיקה נוספת של מרשם התושבים (戶籍), של צורת המסמכים ושל כוחם הראייתי בטאיוואן.',
