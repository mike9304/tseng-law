...
![Publicació a PTT: un noi universitari coreà pateix una ruptura de disc intervertebral durant un pes mort de 90 kg; en primera instància es condemna el gimnàs a pagar 1.570.000 TWD](../images/010-taiwan-gym-injury-lawsuit/img-06.jpg)

[Publicació a PTT: un noi universitari coreà pateix una ruptura de disc intervertebral durant un pes mort de 90 kg; en primera instància es condemna el gimnàs a pagar 1.570.000 TWD](https://www.ptt.cc/bbs/MuscleBeach/M.1680935985.A.BF6.html)
...
Les imatges es poden sobreescriure en vèncer el període de conservació o quedar inutilitzables per altres raons. Per això es pot considerar demanar al gimnàs la conservació mitjançant una carta amb constància de contingut (存證信函) o una carta d’advocat (律師函) que hi consigni de manera concreta la franja horària, el lloc i la posició de la càmera necessaris. Aquest escrit és una mesura pràctica per deixar constància de què es va demanar i quan. Tanmateix, per si mateix no imposa a l’altra part una nova obligació jurídica de conservar les imatges ni impedeix que s’esborrin, i el mer fet que les imatges ja no existeixin tampoc no duu el tribunal a presumir automàticament en contra d’aquesta part.
...
Una caiguda en un establiment, un dany a la salut per aliments i una lesió ocorreguda en utilitzar un servei professional també poden plantejar qüestions d’obligació de seguretat, de nexe causal, de dany i de prova. Tanmateix, la conclusió d’un assumpte de gimnàs no es pot traslladar sense més a un altre accident, de manera que el contracte, la conducta i les normes aplicables de cada cas s’han d’examinar per separat.
