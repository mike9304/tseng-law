...
const ELEMENTS = {
  ...
  'not-the-consultation-step': {
    ...
    nb: /rådgivningsmøte/,
    fi: /ei korvaa neuvontaa/,
    cs: /není poradou/,
    hu: /nem helyettesíti a tanácsadást/,
    ro: /nu ține loc de consultanță/,
    ...
    mn: /энэ хуудас зөвлөгөө биш/,
    sk: /nenahrádza konzultáciu/,
    bg: /тази страница не е консултация/,
    hr: /nije savjetovanje/,
    sr: /korak konsultacije/,
    sl: /ta stran ni posvet/,
