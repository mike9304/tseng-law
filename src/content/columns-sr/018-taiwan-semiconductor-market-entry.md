...
Pre nego što matična kompanija odluči o strukturi ulaska, može interno da razjasni:

| Stavka rada | Pitanja koja treba najpre urediti |
|---|---|
| Ugovori s kupcima | Ko će biti ugovorna strana: strana matična kompanija, tajvansko zavisno društvo ili lokalni zastupnik? |
...
| Osoblje | Da li dolaze zaposleni matične kompanije, da li se zapošljava na Tajvanu, ili se posao poverava spoljnom izvođaču? |
| Ugradnja i tehnička podrška | Ko snosi obavezu podrške prema kupcu i ko reaguje na probleme pri radu na licu mesta? |
| Naknade i troškovi | Ko fakturiše i naplaćuje i kako se namiruju troškovi između matične kompanije i organizacije na Tajvanu? |
...
| Tajvanski ogranak stranog društva | Ogranak upisan na Tajvanu prema propisima; nema pravni subjektivitet odvojen od matične kompanije i razlikuje se od posebno osnovanog zavisnog društva. | Ogranak je deo strane matične kompanije, a ne samostalno pravno lice, pa matična kompanija neposredno snosi obaveze i odgovornost. Treba potvrditi obim ovlašćenja odgovornog lica ogranka i unutrašnju podelu spoljnih ugovora, isporuke, jemstva i postprodajnog servisa. |
...
Kada strano društvo osniva tajvansko zavisno društvo, naziv se načelno prethodno ocenjuje i podnosi se zahtev za investiciono odobrenje Odeljenju za pregled i odobravanje investicija Ministarstva ekonomije (經濟部投資審議司). Nakon odobrenja prenose se sredstva, utvrđuje visina investicije i ovlašćeni računovođa (會計師) overava kapital, zatim se dovršavaju osnivanje i poreska registracija.

Nasuprot tome, pri osnivanju tajvanskog ogranka običnog stranog društva načelno nije potrebno investiciono odobrenje Odeljenja za pregled i odobravanje investicija; Uprava za razvoj trgovine Ministarstva ekonomije (經濟部商業發展署) obavlja upis ogranka i povezano utvrđivanje kapitala. I dalje su potrebni prethodna ocena naziva, prenos operativnih sredstava, overa kapitala i poreska registracija; kalendar je obično kraći.

Navedeno je savet o tome kako urediti ugovore. Samo izbor jednog određenog pravnog oblika ne čini posao zakonitim i ne sprečava sporove.
...
Ako osnovate zavisno društvo, a ne ogranak, matična kompanija načelno ne snosi obaveze iz ugovora zaključenih u ime zavisnog društva. Ipak treba proveriti izuzetke zbog zloupotrebe pravnog subjektiviteta i to da li je matična kompanija posebno dala jemstvo ili preuzela sopstvene ugovorne obaveze.
...
Ako planirate na Tajvanu prodaju, upravljanje zalihama, podršku pri ugradnji ili lokalno zapošljavanje, uredite najpre posao koji će obaviti matična kompanija i posao koji će pripasti tajvanskoj organizaciji. Nakon provere tema konsultacije i sukoba interesa kancelarija će objasniti potrebnu dokumentaciju i obim usluga koje mogu da se pruže.

Primer predmeta: Konsultacija o strukturi ulaska preduzeća poluprovodnika na Tajvan. Pri prvom kontaktu navedite naziv društva, državu matične kompanije, predviđeni proizvod ili uslugu, plan rada na Tajvanu i željeni jezik konsultacije (samo engleski, kineski (中文), japanski ili korejski). Poverljivu projektnu dokumentaciju i potpune ugovore pošaljite tek nakon daljeg uputstva. Stvarno dostupne jezike konsultacije i obim eventualnog mandata treba potvrditi pri kontaktu.
