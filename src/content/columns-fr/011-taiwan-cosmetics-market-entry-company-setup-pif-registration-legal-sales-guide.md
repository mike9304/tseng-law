---
title: "Entrée sur le marché des cosmétiques à Taïwan : choix du sujet importateur, enregistrement du produit, établissement et conservation du PIF et régulation de la publicité"
url: "https://www.wei-wei-lawyer.com/post/taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide"
lastmod: "2026-07-25"
date_display: "4 février 2026"
...
faq:
  - q: "Pour vendre des cosmétiques à Taïwan, faut-il toujours constituer une filiale ou une succursale ?"
    a: "Il n’est pas toujours nécessaire de la constituer. Il est aussi possible de confier l’importation et la vente à un importateur taïwanais (y compris le cas où il agit en même temps comme agent de vente). Si vous entendez exploiter vous-même l’activité à Taïwan, la constitution et l’enregistrement d’une filiale (子公司) taïwanaise diffèrent de la constitution et de l’enregistrement d’une succursale (分公司) de société étrangère, et la structure de responsabilité et la fiscalité diffèrent aussi ; le délai nécessaire pour l’approbation de l’investissement étranger (僑外投資核准) et pour l’enregistrement de la société ou de la succursale varie selon chaque affaire et selon qu’il y a correction ou complément de documents. Il faut d’abord fixer le modèle d’activité et le sujet qui assumera la responsabilité comme fabricant ou importateur de cosmétiques (化粧品製造或輸入業者)."
  - q: "Qu’est-ce que le PIF et s’agit-il de la même procédure que l’enregistrement de produit auprès de la TFDA ?"
    a: "Ce n’est pas la même procédure. L’enregistrement de produit (產品登錄) est une formalité distincte qui se réalise sur la plateforme d’enregistrement des produits cosmétiques de la TFDA (衛生福利部食品藥物管理署). Le PIF est un dossier qui réunit des données sur la qualité, la sécurité, la composition, la fonction alléguée, le mode de fabrication, les résultats d’essai et l’évaluation de sécurité, entre autres, et que le fabricant ou l’importateur de cosmétiques établit, met à jour et conserve ; le PIF lui-même n’est pas un document qui doive être présenté d’avance à la TFDA. À compter du 1 juillet 2026, en principe tous les cosmétiques relèvent du régime du PIF, à l’exception du savon solide artisanal fabriqué dans un lieu de production exempté d’enregistrement d’usine (工廠登記)."
  - q: "Quelles expressions faut-il surveiller dans la publicité des cosmétiques à Taïwan ?"
    a: "La publicité s’apprécie non seulement d’après la phrase, mais d’après l’ensemble de la présentation, y compris le nom du produit, le texte, l’image, le symbole et le son. Sont interdites les expressions fausses ou exagérées et l’allégation d’efficacité médicale, et il faut prêter une attention particulière aux expressions médicales comme traiter l’acné, anti-inflammatoire ou bactéricide. L’amende administrative est de 40.000 à 200.000 dollars de Taïwan (新臺幣, TWD) pour une publicité fausse ou exagérée, et de TWD 600.000 à TWD 5.000.000 pour une allégation d’efficacité médicale. Les publications d’influenceurs et d’autres doivent aussi être examinées selon le même critère si, au fond, elles sont de la publicité."
---

# Entrée sur le marché des cosmétiques à Taïwan : choix du sujet importateur, enregistrement du produit, établissement et conservation du PIF et régulation de la publicité

![Données de produit et examen normatif nécessaires pour entrer sur le marché des cosmétiques à Taïwan](../images/011-taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide/featured-01.jpg)
...
Quelle que soit la structure choisie, le sujet de responsabilité central dans la régulation des cosmétiques est le **fabricant ou importateur de cosmétiques**. L’ordonnancement des données du produit ou l’évaluation de sécurité (安全性評估) peut être confié à un expert externe, mais le seul fait de confier le travail ne transfère pas la responsabilité juridique du fabricant ou de l’importateur. Distinguer la répartition du travail selon le contrat du sujet de responsabilité selon la réglementation est le point de départ de l’examen de la structure d’entrée.
...
La période de validité de l’enregistrement de produit est de 3 ans. Si l’on entend poursuivre l’approvisionnement, la demande de prorogation (展延) doit être présentée dans les 3 mois précédant l’échéance. Si changent les mentions enregistrées, comme le nom du produit, l’usage, la forme pharmaceutique (劑型), la composition et le lieu de fabrication, il faut aussi confirmer si une formalité correspondant au contenu du changement est nécessaire.

L’enregistrement de produit est la formalité de déclarer sur la plateforme les mentions déterminées. L’achèvement de l’enregistrement ne signifie pas que sont complets tous les documents nécessaires au PIF, ni n’est un jugement selon lequel l’étiquetage ou la publicité du produit seraient conformes au droit. Le calendrier d’enregistrement de produit, la gestion du PIF et la revue de l’étiquetage et de la publicité doivent être opérés comme des points de conformité distincts.

### Données du PIF et application par étapes

Le PIF est un ensemble de données structuré pour pouvoir continuer à expliquer la qualité et la sécurité du produit. Outre la qualité, la sécurité, la composition, la fonction alléguée (宣稱功能), le mode de fabrication, les résultats d’essai et l’évaluation de sécurité, il faut ordonner par produit les informations de base sur le produit et le fabricant et les données d’appui, comme l’étiquette. Le règlement de gestion du dossier d’information des produits cosmétiques (化粧品產品資訊檔案管理辦法) organise les données nécessaires en 16 catégories, de sorte que les données de chaque catégorie et les exigences de signature et de qualification doivent être confirmées selon le type de produit.

Le régime du PIF s’est appliqué par étapes selon des groupes de produits. À compter du 1 juillet 2026, les cosmétiques restants sont aussi inclus dans l’objet d’application, de sorte qu’en principe il s’applique à tous les cosmétiques. L’exception se limite au savon solide artisanal fabriqué dans un lieu de production exempté d’enregistrement d’usine. Un produit n’est pas exclu seulement parce qu’il est artisanal ou qu’il use du nom de savon ; il faut confirmer les deux, la forme solide et la condition d’exemption d’enregistrement d’usine du lieu de production.
...
Déclarer une information fausse dans l’enregistrement de produit ou consigner une information fausse dans le PIF peut faire l’objet d’une amende administrative (罰鍰) de 10.000 à 1.000.000 de dollars de Taïwan (新臺幣, TWD). En revanche, si les données du PIF sont incomplètes, l’autorité compétente ordonne d’ordinaire la correction dans un délai déterminé (限期改正), et l’amende administrative ne se pose que si l’on ne corrige pas dans ce délai. L’information fausse et l’incomplétude de données encore susceptible d’être complétée ne doivent pas être conclues comme le même résultat d’infraction.

Le rappel ou la destruction (銷毀) n’est pas une mesure qui accompagne de façon automatique toute incomplétude de données du PIF. La sécurité du produit, le contenu de l’infraction, l’état de la correction et les conditions légales applicables à chaque mesure doivent être appréciés de façon distinguée. La mesure lorsqu’un problème de sécurité a été confirmé et la demande de compléter des documents doivent être examinées séparément, et la réponse suit la notification de l’autorité compétente et le précepte appliqué.

## 3. Régulation de l’étiquetage, de la promotion et de la publicité

La publicité s’apprécie non seulement d’après la phrase, mais d’après l’ensemble de la présentation, y compris le nom du produit, le texte, l’image, le symbole et le son. Sont interdites les expressions fausses ou exagérées et l’allégation d’efficacité médicale, et il faut prêter une attention particulière aux expressions médicales comme traiter l’acné, anti-inflammatoire ou bactéricide. L’amende administrative est de TWD 40.000 à TWD 200.000 pour une publicité fausse ou exagérée, et de TWD 600.000 à TWD 5.000.000 pour une allégation d’efficacité médicale. Les publications d’influenceurs et d’autres doivent aussi être examinées selon le même critère si, au fond, elles sont de la publicité.

### On apprécie d’après l’ensemble de la présentation, non d’après chaque mot

Si l’étiquetage, la promotion (宣傳) ou la publicité sont faux ou exagérés, ou s’ils allèguent une efficacité médicale (醫療效能), on ne juge pas seulement d’après un mot déterminé. On examine ensemble le nom de l’article, la phrase, l’image, le symbole, le son, le contexte antérieur et postérieur et l’impression d’ensemble que reçoit le consommateur. L’impression formée par la présentation publicitaire centrale ne se dissipe pas de façon automatique par la seule mention restrictive en petits caractères, de sorte qu’il faut revoir tant chaque texte que le produit final.
...
### Influenceurs, auteurs de recensions et partenaires de vente

Les publications d’influenceurs, d’auteurs de recensions ou de partenaires de vente peuvent aussi être appréciées, selon le contenu et le contexte commercial, comme publicité au fond. Le paiement d’une contrepartie, la remise de produit, le lien de vente, l’instruction de la marque de publier et la collaboration répétée sont des facteurs qui se considèrent dans cette appréciation. En revanche, toute publication personnelle ne devient pas de façon automatique une publicité de la marque, de sorte qu’il faut confirmer la relation entre qui publie et la marque, le contenu concret et le degré d’implication de la marque.
...
2. Confirmer le sujet qui assume la responsabilité juridique comme fabricant ou importateur de cosmétiques et le responsable du travail selon le contrat.
...
- [Loi de gestion de l’hygiène et de la sécurité des cosmétiques](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030013)
- [Règlement d’enregistrement des produits cosmétiques (化粧品產品登錄辦法)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030097)
- [Règlement de gestion du dossier d’information des produits cosmétiques](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030098)
- [TFDA — avis sur le champ objet de l’enregistrement des produits cosmétiques](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30612)
- [TFDA — avis sur l’application par étapes du PIF](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30614)
- [TFDA — lignes directrices d’établissement du PIF](https://www.fda.gov.tw/tc/includes/GetFile.ashx?id=f639179794512621908&iid=13384)
- [TFDA — zone spéciale d’enregistrement des produits cosmétiques](https://www.fda.gov.tw/TC/siteContent.aspx?sid=3435)
- [TFDA — zone spéciale du dossier d’information des produits cosmétiques](https://www.fda.gov.tw/TC/site.aspx?sid=12523)
- [Critères de détermination de l’étiquetage, de la promotion et de la publicité des cosmétiques (化粧品標示宣傳廣告認定準則)](https://law.moj.gov.tw/LawClass/LawAll.aspx?PCODE=L0030099)
- [Annexe officielle des critères de détermination de la publicité des cosmétiques](https://law.moj.gov.tw/LawClass/LawGetFile.ashx?FileId=0000249593&lan=C)
- [Ministère de la Santé et du Bien-être (衛生福利部) — avis sur la régulation de la publicité des cosmétiques](https://www.mohw.gov.tw/cp-4256-48110-1.html)
- [Invest Taiwan — explication sur l’investissement étranger](https://investtaiwan.nat.gov.tw/showPage?lang=jpn&search=InvestmentStatus01)
- [Département de l’examen des investissements du ministère de l’Économie — guide](https://mnscdn.moea.gov.tw/Mns/dir/content/Content.aspx?menu_id=42879)
