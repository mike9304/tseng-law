...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  ro: {
    ...
    discoveryNotice:
      'Fișierul llms.txt este doar o hartă pentru găsirea paginilor publice; nu promite poziționare în căutare, gir, recomandare din partea inteligenței artificiale și nici vizibilitate garantată.',
    confidentialNotice:
  ...
  uk: {
    ...
    discoveryNotice:
      'Файл llms.txt — це лише мапа для пошуку публічних сторінок; він не обіцяє місця в пошуку, схвалення, рекомендації штучного інтелекту чи показу.',
    confidentialNotice:
