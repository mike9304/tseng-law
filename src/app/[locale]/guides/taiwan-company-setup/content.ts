...
export const guideContent: Record<SiteLocale, GuideContent> = {
  ...
  en: {
    ...
    costRows: [
      ...
      { item: 'Korea–Taiwan tax treaty (Korean parents; other countries differ)', values: ['In force 2023-12-27 and effective from 2024-01-01 for qualifying Korean residents. Dividend cap rate 10% if treaty requirements are met; it does not apply automatically. Other countries have different treaties.'] },
    ],
  ...
  ja: {
    ...
    steps: [
      {
        name: '投資審議委員会（投審会）の投資承認',
        text: '外国人は台湾の投資審議委員会に投資計画書を提出して審査を受ける必要があります。投審会は資本金が実際の投資用途に使われるかを確認し、承認後1年以内に資本金を送金しなければなりません。',
      },
      {
        name: '社名予備審査と委任状の公証',
    ...
    comparisonHeading: '法人形態の比較（子会社・支店・連絡事務所）',
    comparisonIntro:
      '台湾進出の形態は大きく子会社（株式会社・有限公司）、支店、連絡事務所に分かれます。税金・法的責任・上場の可否が異なります。',
    comparisonColumns: ['項目', '子会社（株式会社・有限公司）', '支店', '連絡事務所'],
    comparisonRows: [
    ...
    costRows: [
      ...
      { item: '韓国・台湾租税条約（韓国親会社の例。他国は別条約）', values: ['適格な韓国居住者について2023.12.27発効、2024.1.1から適用。条約要件を満たせば配当の上限税率10%。自動適用ではない。他国は別条約。'] },
    ],
    faqHeading: 'よくある質問',
    faq: [
      {
        q: '台湾法人設立に最低資本金はありますか？',
        a: '会社設立自体に最低資本金の制限はなく、1台湾ドルでも可能です。ただし代表者の就労許可証と居留証が必要な場合は、単一株主基準で最低50万台湾ドル、台湾パートナーがいる場合はその3分の1（約17万台湾ドル）を投資する必要があり、会社の年間売上高が300万台湾ドルを超える必要があります。',
      },
      {
        q: '会社を設立すれば台湾のビザを取得できますか？',
        a: 'はい。投資家が台湾で会社を管理・運営する必要がある場合、台湾労働部に外国人就労許可証を申請し、取得後に移民署に居留証を申請できます。外国人就労許可証の許可期間は1〜3年で、居留証と有効期間が同じです。',
      },
      {
        q: '子会社と支店の税金の違いは？',
      ...
      },
      {
        ...
        a: '会社設立に約3ヶ月、設立後の就労許可証と居留証の取得に約1ヶ月かかるのが一般的です。店舗賃貸契約の開始日はできるだけ遅く設定するのが安全です。',
      },
      {
        q: '台湾法人設立の手続きはどのようになっていますか？',
        a: '投審会承認、社名予備審査・公証、設立・税務登記、正式口座開設の順で進みます。',
      },
    ],
    ...
    ctaText:
      '業種・資本金・ビザの必要性によって、子会社・支店・連絡事務所の選択が変わります。資料をお送りいただければ、曾雋崴台湾弁護士につながる相談の流れをご案内します。',
    ctaButton: '相談のお問い合わせ',
  },
};
