...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-fitabout-fac-1-title', { x: 20, y: 20, width: 200, height: 32 }, '프리웨이트 존', 3, '#14181f', 'left', 'tpl-fitabout-fac-1'),
  createTextNode({
  ...
  heading('tpl-fitabout-fac-2-title', { x: 20, y: 20, width: 200, height: 32 }, '머신 트레이닝', 3, '#14181f', 'left', 'tpl-fitabout-fac-2'),
  createTextNode({
  ...
  heading('tpl-fitabout-fac-3-title', { x: 20, y: 20, width: 200, height: 32 }, '그룹 스튜디오', 3, '#14181f', 'left', 'tpl-fitabout-fac-3'),
  createTextNode({
  ...
  heading('tpl-fitabout-fac-4-title', { x: 20, y: 20, width: 200, height: 32 }, '편의시설', 3, '#14181f', 'left', 'tpl-fitabout-fac-4'),
  createTextNode({
  ...
  ...buildCategoryProofSections('fitness', 'fitness-about', STAGE_H),
]);
