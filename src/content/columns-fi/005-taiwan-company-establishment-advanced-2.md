---
title: "Yhtiön perustaminen Taiwanissa – syventävä osa 2"
...
Seuraavat kysymykset ja vastaukset (Q&A) on tarkoitettu auttamaan henkilöitä, jotka harkitsevat yhtiön perustamista (公司設立) Taiwanissa.
...
Siirto verkkopankin kautta tai Korean läheisen kautta (匯款) ei ole mahdollinen.
...
Kysykää tietoja Korean pääpankistanne ennen pääomansiirtoa (資本金匯款).
...
Jos kyse on esimerkiksi Taiwanissa saadusta palkkatulosta, on esitettävä jäljennös kyseisen palkkatulon ennakonpidätystodistuksesta (薪資所得的扣繳憑單影本).
...
Jos siirto tehdään Koreassa olevalta pankkitililtä, varojen alkuperää koskevia asiakirjoja ei tarvitse liittää.

**​**

**3. Milloin valmistelutili voidaan pääoman saavuttua muuttaa varsinaiseksi yhtiötiliksi (正式公司帳戶)?**

Yleensä vastuuhenkilö (負責人) voi, kun oikeushenkilön rekisteröintiasiakirjat (法人登記文件) on vastaanotettu,

käydä pankissa ja muuttaa yhtiön valmistelutilin varsinaiseksi tiliksi.

Koska kunkin pankin (銀行) sisäiset säännöt kuitenkin eroavat, on suositeltavaa tiedustella pankilta ensin, jos pääomaa on käytettävä kiireellisesti.

**​**

**4. Voiko verkkopankin ottaa käyttöön heti, kun valmistelutili on muutettu varsinaiseksi tiliksi?**

Se vaihtelee pankista toiseen; yleensä vaaditaan vähintään matkapuhelinnumero.

Tietyt pankit voivat asettaa lisävaatimuksia, esimerkiksi tilin käyttöajan vähintään 6 kuukautta perustamisen jälkeen.

**​**

**5. Voiko yhtiö palkata Korean kansalaisuuden omaavia henkilöitä työntekijöiksi?**
...
Jos teillä on muita kysymyksiä, voitte ottaa meihin yhteyttä.
