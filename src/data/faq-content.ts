...
export const faqContent: Record<SiteLocale, FAQItem[]> = {
  ...
  ja: [
    // ── 会社設立 ──
    {
      ...
      answer:
        '一般的には、①投資許可の申請 → ②会社名の予備審査 → ③資本金の送金および監査報告書 → ④会社登記 → ⑤事業者登録 → ⑥銀行口座の開設、の順で進みます。業種、資本金の規模、株主構成によって手続きが異なることがあり、事前の設計が重要です。'
    },
    {
      question: '子会社と支社（分公司）のどちらが有利ですか？',
      answer:
        '子会社（有限会社）は台湾法人として独立した運営が可能です。一方、支社（分公司）は本社の延長として別途の運営資金が必要ですが、本社が直接責任を負います。税務処理、事業範囲、将来計画によって適した形態が異なるため、相談のうえで決定することをお勧めします。'
    },
    {
      question: '会社設立後、資本金はどのように回収できますか？',
      answer:
        '事業をこれ以上運営しない場合、解散および清算の手続きを通じて残余資産を本国へ送金できます。投資許可の取消、税務清算、銀行口座の解約など順序が定められているため、専門家とともに進めることが安全です。'
    },
    {
      question: '営業場所（オフィス）がなくても会社設立は可能ですか？',
      answer:
        '会社登記には営業住所が必要です。自社オフィスの賃貸以外にも、シェアオフィスや商業用登記住所などの方法があり、業種によって実際の営業所要件が異なる場合があります。'
    },
    // ── 労働法 ──
    {
      question: '台湾で従業員を解雇する際、退職金（資遣費）は必ず支払わなければなりませんか？',
      answer:
        '台湾の労働基準法により、解雇時には資遣費の支払いが原則です。ただし、自発的な退職であっても、雇用主に帰責事由（給与未払い、契約違反など）がある場合は退職金を請求できる例外があるため、事前の法的検討が必要です。'
    },
    {
      question: '義務在職約定（最低勤務期間）は有効ですか？',
      answer:
        '台湾の裁判所は、義務在職約定の有効性を判断する際、①教育訓練費用の合理性、②約定期間の妥当性、③違約金の比例性などを総合的に審査します。無条件に有効なものではないため、約定書の作成時には法的要件を満たすよう設計する必要があります。'
    },
    // ── 民事・交通事故 ──
    {
      question: '台湾で交通事故が起きた場合、どのように対応すべきですか？',
      answer:
        '事故現場で警察に通報し事故報告書を受け取り、医療機関で診断書を確保することが優先です。その後、過失割合の判定、保険請求、損害賠償の協議または訴訟の順で進みます。追い越し中の事故など過失判断が複雑な場合は、専門家の助言が重要です。'
    },
    {
      question: 'ジムや施設で負傷した場合、損害賠償を請求できますか？',
      answer:
        '施設管理者の安全管理義務違反が立証されれば、損害賠償を請求できます。消費者保護法、民法上の不法行為など複数の法的根拠が適用されることがあり、証拠の確保（CCTV、診断書、写真など）が核心です。'
    },
    // ── 家事・離婚 ──
    {
    ...
    },
    {
      ...
      answer:
        '台湾の裁判所は子の最善の利益を基準に判断し、養育環境、親の経済的能力、子の意思などを総合的に考慮します。国際事件の場合は、子の常居所地など国際私法の原則も併せて適用されます。'
    },
    // ── 刑事 ──
    {
      question: '台湾で刑事事件に関与した場合、どうすればよいですか？',
      answer:
        '捜査段階から弁護士の関与が可能です。警察の取調べにおける陳述権、黙秘権などの基本的権利を理解し、初期に法的戦略を立てることが結果に大きな影響を与えます。特に外国人の場合、出国禁止や勾留の有無など追加の争点が生じることがあります。'
    },
    // ── 相談・費用 ──
    {
      question: '相談はどのような方式で行われますか？',
      answer:
        '対面相談（台北事務所）またはオンライン相談（Zoom/Google Meet）が可能です。韓国語・中国語・日本語いずれも相談でき、事前予約のうえ1時間単位で行います。相談前に関連資料をお送りいただければ、より具体的な回答が可能です。'
    },
    {
      question: '物流業・化粧品など特殊な業種でも会社設立は可能ですか？',
      answer:
        '可能です。ただし、物流業は運送業許可、化粧品はPIF（製品情報ファイル）登録およびFDA届出など、業種別の追加許認可が必要です。業種別の規制を事前に把握し、設立手続きと並行して進めることで、時間と費用を節約できます。'
    }
  ]
};
