...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#9b8463', borderRadius: 6 },
  }),
  ...
  ...buildCategoryContactMethods('photography', 'photography-contact-dir', STAGE_H),
  ...buildCategoryProofSections('photography', 'photography-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
