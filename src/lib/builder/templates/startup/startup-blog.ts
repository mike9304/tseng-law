...
const cards: BuilderCanvasNode[] = articles.flatMap((a, i) => {
  ...
  return [
    ...
    heading(`${prefix}-t`, { x: 24, y: 52, width: 312, height: 72 }, a.title, 3, '#16191f', 'left', prefix),
    createTextNode({
      id: `${prefix}-d`,
      parentId: prefix,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-stupblog-grid-title', { x: 80, y: GRID_Y, width: 400, height: 50 }, '최신 글', 2, '#16191f', 'left'),
  ...cards,
  ...buildCategoryProofSections('startup', 'startup-blog', STAGE_H),
]);
