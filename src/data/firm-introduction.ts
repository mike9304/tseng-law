...
export const firmIntroductionContent: Record<Locale, FirmIntroductionContent> = {
  ...
  'zh-hant': {
    ...
    paragraphs: [
      ...
      '於2024年，王鼎翔律師、曾俊瑋律師正式加入本所團隊。王鼎翔律師除一般律師執業領域，更專精於刑事案件，曾擔任法官助理，熟悉法院內部運作方式及思考脈絡，對當事人具有耐心，能聆聽當事人需求，而給予適切的訴訟策略；曾俊瑋律師除有多年訴訟經驗，並致力為日、韓客戶提供包含公司設立、簽證申請、商標專利申請、法律風險評估、公司稅務諮詢等全方面法律服務。',
