      ...
      sections: [
        {
          heading: '在台湾的投资与公司设立',
          paragraphs: [
            '我们协助境外投资人与企业在台湾设立或运营公司：选择组织形式、准备并提交文件、资本缴入、银行事项、营业场所审查以及行业特定要求。我们也协助因在台湾设立与运营而产生的会计与税务。',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '刑事案件往往期限短、阶段固定。若您已收到检察机关、警方或法院的文书，请尽早告知文书上的日期，以便按正确顺序审阅内容。',
          ],
        },
        {
          heading: '知识产权',
    ...
    contact: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            '在联系表单中，您可以选择“沟通方式须待确认”。我们会回复，评估是否有可行的沟通安排；不以其他语言提供服务，也不承诺回复时限。',
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            '发送请求时请选择“沟通方式须待确认”。我们会回复，评估可行的沟通安排，但不以其他语言提供服务。这是评估步骤，不是能够以其他语言工作的承诺。',
        },
        {
          question: '我写下的原文如何处理？',
          answer:
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '因此请不要仅凭一篇文章在真实事项中采取行动。可用作概览，具体问题仍须就您的文件与律师讨论；本页不是咨询步骤。',
          ],
        },
      ],
    },
