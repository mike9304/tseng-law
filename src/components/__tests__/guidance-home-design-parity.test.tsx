 ...
 * English home — full-bleed hero, service cards, editorial image band, column
 * archive, closing contact band — instead of the page-header + card stack
...
const EXPECTED_SEQUENCE = ['hero', 'services', 'image-band', 'column-archive', 'contact-cta'];
