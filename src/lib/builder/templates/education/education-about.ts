...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-eduabout-fac-1-title', { x: 24, y: 20, width: 300, height: 32 }, '최신 강의실', 3, '#2a2418', 'left', 'tpl-eduabout-fac-1'),
  createTextNode({
  ...
  heading('tpl-eduabout-fac-2-title', { x: 24, y: 20, width: 300, height: 32 }, '도서관', 3, '#2a2418', 'left', 'tpl-eduabout-fac-2'),
  createTextNode({
  ...
  heading('tpl-eduabout-fac-3-title', { x: 24, y: 20, width: 300, height: 32 }, '실습실', 3, '#2a2418', 'left', 'tpl-eduabout-fac-3'),
  createTextNode({
  ...
  ...buildCategoryProofSections('education', 'education-about', STAGE_H),
]);
