...
Тайванското дъщерно дружество и клонът на чуждестранно дружество не са една и съща организация. Дъщерното дружество е отделно юридическо лице, учредено по правото на Тайван, докато клонът се вписва като част от главното седалище (本公司) на чуждестранното дружество. Правосубектността и отговорността на главното седалище, счетоводното и данъчното отчитане, преводът на печалбата, представителната власт и начинът на вътрешен контрол се различават, затова организационната форма не бива да се избира само по контрола върху продажбите.
...
Работата по PIF, включително оценката на безопасността, може да се подпомага от трето лице (第三人) с нужната квалификация и способност. Дори обаче да се ползва подкрепа при съставянето от трето лице или услуга за съхраняване на материали, правната отговорност на производителя или вносителя на козметика се запазва. Следва да се изгради система, която позволява на първоначалния производител, изпитвателната организация, оценителя на безопасността и предприятието на страната на Тайван взаимно да предават сведения за измененията и актуалните подписани материали.
...
Дори първоначалният производител да съхранява оригинала или да се ползва сигурно електронно или облачно хранилище, производителят или вносителят трябва да има достъп до пълните материали. Следва да се определят правата на достъп, резервното копиране, управлението на версиите, форматът на файловете и отговорното лице, за да могат при изискване на компетентния орган материалите бързо да се намерят и представят. Важно е също в договора да се уредят адресатът на предаването, начинът и дали се запазва правото на достъп, за да се съхраняват материалите през законния срок на съхраняване и след прекратяване на договора с партньора по продажбата или с доставчика на услугата.
...
1. Определят дали сами да учредят тайванско дъщерно дружество или клон, или да възложат вноса и продажбата на местен вносител.
2. Потвърждават субекта, който поема правната отговорност като производител или вносител на козметика, и договорния изпълнител на работата.
3. Завършват регистрацията на продукта преди доставка, продажба, дарение, публично излагане или предоставяне на потребителя за пробно ползване.
4. Съставят PIF по продукт, обновяват измененията и съхраняват съобразно законния срок и място.
5. Преглеждат етикета, страницата за продажба, рекламата и публикациите по сътрудничество по критерия на съвкупността на израза.
6. Водят процедура за отговор на проверки и изисквания за отстраняване, жалби, сведения за безопасност и нужни последващи мерки.
