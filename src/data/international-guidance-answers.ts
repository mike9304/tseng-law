...
> = {
  ...
  ur: {
    ...
    lawyers: {
      answer:
        'یہ صفحہ Hovering کے وکلا، عملی امور کی قیادت اور شراکت دار سرٹیفائیڈ پبلک اکاؤنٹنٹ کی پروفائلز دکھاتا ہے۔ وکیلہ Wei Tseng (曾雋崴) تائیوان میں مجاز ہیں اور دفتر کی منتظمہ وکیلہ ہیں؛ وہ کوریا، جاپان اور دیگر بین الاقوامی موکلوں کے ساتھ کام کرتی ہیں۔ مشورہ صرف انگریزی، چینی، جاپانی اور کوریائی میں ہوتا ہے۔',
