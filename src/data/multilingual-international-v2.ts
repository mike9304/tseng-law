...
export const GUIDANCE_HOME_PATHS: Record<GuidanceLocale, GuidanceHomePaths> = {
  ...
  bn: {
    setup: {
      label: 'তাইওয়ানে কোম্পানি গঠনের তথ্য',
      href: '/bn/services',
    },
    legal: {
      label: 'তাইওয়ানের আইনি তথ্য',
      href: '/bn/faq',
    },
    ariaLabel: 'তথ্যের দুই পথ',
  },
  ur: {
    setup: {
  ...
  ta: {
    setup: {
      label: 'தைவானில் நிறுவனம் அமைப்பதற்கான தகவல்',
      href: '/ta/services',
    },
    legal: {
      label: 'தைவான் சட்டத் தகவல்',
      href: '/ta/faq',
    },
  ...
  sr: {
    ...
    ariaLabel: 'Dva informativna puta',
  },
  sl: {
    setup: {
  ...
  lv: {
    setup: {
      label: 'Informācija par sabiedrību dibināšanu Taivānā',
      href: '/lv/services',
    },
    legal: {
      label: 'Juridiskā informācija par Taivānu',
      href: '/lv/faq',
    },
    ariaLabel: 'Divi informācijas ceļi',
  },
  et: {
    setup: {
      label: 'Teave ettevõtte asutamise kohta Taiwanis',
      href: '/et/services',
    },
    legal: {
      label: 'Õigusteave Taiwani kohta',
      href: '/et/faq',
    },
