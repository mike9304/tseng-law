...
export const russianGuidanceContent: GuidanceLocaleContent = {
  ...
  mega: {
    ...
    lawyers: {
      description: 'Кто ведёт дела и как с ними связаться.',
      viewAllLabel: 'Показать все',
    },
    pricing: {
  ...
  pages: {
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Hovering International Law Firm — адвокатская фирма, учреждённая на Тайване. Она работает по праву Тайваня и имеет офисы в городах Тайбэй (臺北), Гаосюн (高雄), Тайчжун (臺中) и Пиндун (屏東). Мы консультируем компании, ведём дела в суде и сопровождаем доверителей из-за рубежа на этапах, которые на Тайване действительно нужны.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Мы не обещаем переводчика, срок ответа и запись через эту страницу. Если Вы не говорите ни на одном из четырёх языков, страница «Контакты» объясняет, как мы рассматриваем способ связи.',
          ],
        },
        {
    ...
    about: {
      ...
      description:
        'Основные сведения об этой тайваньской адвокатской фирме, её офисах и работе с иностранными доверителями.',
      intro:
        'Hovering International Law Firm — адвокатская фирма на Тайване. Адвокаты ведут работу от консультирования компаний до судебных разбирательств. Этот раздел описывает возникновение фирмы, места и работу с иностранными доверителями.',
      sections: [
        {
          ...
          paragraphs: [
            ...
            'Помимо адвокатской работы с 2020 года существует также бухгалтерская фирма Hovering Accounting Office, которая предлагает бухгалтерию и налоговое планирование предпринимателям и состоятельным частным лицам.',
          ],
        },
        {
          heading: 'Работа с иностранными доверителями',
          paragraphs: [
            'Трансграничная работа включает учреждение компаний, визы, подачу заявок на товарные знаки и патенты, проверку правовых рисков и налоговое консультирование компаний. Офис в Тайчжуне в первую очередь ведёт строительные дела, интеллектуальную собственность и дела, связанные с Кореей и Японией. Адвокат Wei Tseng (曾雋崴) сопровождает доверителей из Кореи и Японии, а также иных иностранных доверителей в названных группах.',
        ...
        },
        {
          ...
          paragraphs: [
            'После поступления Вашего краткого изложения адвокат рассматривает содержание и затем обсуждает возможный объём работы, какие документы ещё нужны, и следующие шаги. При налоговых или бухгалтерских вопросах фирма может вести их вместе с бухгалтерским подразделением.',
            'Исход каждого дела зависит от фактов и имеющихся документов; мы не обещаем результата. Если Вам нужен ответ, на который можно опереться в Вашей ситуации, документы необходимо обсудить с адвокатом на одном из четырёх языков консультации.',
          ],
        },
      ],
    },
    ...
    pricing: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Консультация с адвокатом может быть возмездной услугой. Эта страница не говорит, что первая беседа проводится без оплаты, и так эту страницу понимать нельзя.',
    ...
    contact: {
      ...
      description:
        'Язык страницы, языки консультации, порядок, если Вы не говорите ни на одном из четырёх языков, и что эта страница не обещает.',
      intro:
        'Прежде чем писать нам, различайте следующие три пункта. Их часто смешивают, но они означают разное.',
      sections: [
        {
          heading: 'Три понятия, которые не следует смешивать',
          paragraphs: [
        ...
        {
          heading: 'Если Вы не говорите ни на одном из четырёх языков консультации',
          paragraphs: [
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Если Вы не находите ответа для Вашей ситуации, ответ обычно зависит от особых фактов. Тогда запишите эти факты в краткое изложение, вместо того чтобы самостоятельно выводить ответ из этой страницы.',
          ],
        },
      ],
      faqs: [
        ...
        {
          question: 'Что, если я не говорю ни на одном из четырёх языков?',
          answer:
        ...
        },
        {
          ...
          answer:
            'Назовите срок или дату на официальном письме в начале краткого изложения, чтобы эти даты были видны при рассмотрении. У этой страницы нет канала для неотложных случаев, и срок ответа не обеспечивается; если Ваш вопрос не может ждать, Вам следует параллельно искать другие пути там, где Вы находитесь.',
        },
      ],
    },
    privacy: {
      ...
      intro:
        'Этот раздел касается только контактной формы на этих информационных страницах. Он описывает обращение с данными, а не даёт абсолютной технической гарантии.',
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Если запрос успешно отправлен, система уведомляет фирму. Если доставка этого уведомления фирме ещё не подтверждена, Ваш текст остаётся сохранённым и не теряется.',
        ...
        },
        {
          ...
          paragraphs: [
            'Этот сайт размещён на платформе Vercel, и отправленные Вами данные хранятся в закрытом облачном хранилище этой службы. Письма отправляются через почтовую службу, которой пользуется фирма.',
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Содержание не является консультацией по праву иных стран, в том числе по праву страны Вашего проживания. Если часть Вашего дела затрагивает иную правовую систему, мы выясним с Вами, какой квалифицированный специалист нужен для этой части.',
          ],
        },
        {
    ...
    columns: {
      ...
      intro:
        'Фирма публикует материалы по частым вопросам права Тайваня. Материалы, имеющиеся на русском языке, находятся на этой странице; рядом есть четыре ссылки, каждая из которых открывает список материалов на языке оригинала.',
      sections: [
        {
          ...
          paragraphs: [
            ...
            'Эти четыре списка — списки материалов на языке оригинала, а не списки переводов. Материалы, имеющиеся на русском языке, приведены отдельно на этой странице.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Поэтому не опирайтесь на материал как на основание действий в реальном деле. Используйте его для обзора и отдельно обсудите Ваши документы с адвокатом; эта страница не заменяет консультацию.',
          ],
        },
      ],
    },
