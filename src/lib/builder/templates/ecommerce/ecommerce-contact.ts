...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('ecommerce', 'ecommerce-contact-dir', STAGE_H),
  ...buildCategoryProofSections('ecommerce', 'ecommerce-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
