...
faq:
  - q: "대만 지사는 다른 대만인 주주 참여가 가능한가요?"
    a: "아닙니다. 지사는 한국 기업이 100% 소유해야 하며 다른 대만인이나 대만 법인이 주주로 참여할 수 없습니다. 다른 사람과 합자하여 회사를 설립하려면 자회사를 설립해야 합니다."
  - q: "자회사와 지사의 세금 부담 차이는?"
    a: "둘 다 영업세 5%(2개월마다)와 법인세 20%(매년)는 같습니다. 차이는 자회사가 이익을 한국 모기업에 배당할 때 21% 외국인 소득세가 추가되고, 분배하지 않으면 5% 미처분이익잉여금 세금이 붙는다는 점입니다. 반면 지사는 이익을 모기업 계좌로 송금할 때 추가 세금과 미처분이익잉여금 세금이 없습니다."
  - q: "대만에서 세금 혜택과 상장은 어느 형태에서 가능한가요?"
    a: "모두 자회사에만 해당합니다. 자회사가 혁신적 연구개발 지출로 승인받으면 해당 연도 영리 사업 소득세에서 최대 30%까지 공제받을 수 있고, 주식회사 형태 자회사만 대만 상장 자격이 있습니다. 지사는 이런 혜택을 받을 수 없습니다."
---
