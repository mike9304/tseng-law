...
const teamCards: BuilderCanvasNode[] = team.flatMap((m, i) => {
  ...
  return [
    ...
    heading(`${prefix}-name`, { x: 24, y: 24, width: 212, height: 36 }, m.name, 3, '#16191f', 'left', prefix),
    createTextNode({
      id: `${prefix}-role`,
      parentId: prefix,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Founding story ─────────────────────────────────────── */
  heading('tpl-stupabt-story-title', { x: 80, y: STORY_Y, width: 400, height: 50 }, '창업 스토리', 2, '#16191f', 'left'),
  createTextNode({
  ...
  /* ── Team ────────────────────────────────────────────────── */
  heading('tpl-stupabt-team-title', { x: 80, y: TEAM_Y, width: 400, height: 50 }, '팀', 2, '#16191f', 'left'),
  ...teamCards,
  ...
  heading('tpl-stupabt-inv-title', { x: 80, y: 40, width: 400, height: 50 }, '투자자 & 미션', 2, '#16191f', 'left', 'tpl-stupabt-investors'),
  createTextNode({
  ...
  ...buildCategoryProofSections('startup', 'startup-about', STAGE_H),
]);
