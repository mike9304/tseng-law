...
| M158 | CMS | CMS collections/content manager v1 | F07~F16 | 24h | M157 | 🟡 editable CRUD + duplicate/search/sort + CSV + revisions + typed filters/saved views/stable pagination + permissions UI/gates are in; media-field asset integration and F07~F16 hardening remain |
