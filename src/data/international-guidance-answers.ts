...
> = {
  ...
  el: {
    ...
    lawyers: {
      answer:
        'Η σελίδα αυτή δείχνει τα προφίλ των δικηγόρων της Hovering, της λειτουργικής διεύθυνσης και του συνεργαζόμενου λογιστικού γραφείου. Η δικηγόρος Wei Tseng (曾雋崴) έχει άδεια στην Ταϊβάν και είναι η διευθύνουσα δικηγόρος του γραφείου· συνεργάζεται με εντολείς από την Κορέα και την Ιαπωνία και με άλλους διεθνείς εντολείς. Η συμβουλευτική διεξάγεται μόνο στα αγγλικά, κινεζικά, ιαπωνικά και κορεατικά.',
