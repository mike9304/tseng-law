...
목적: 동남아 사용자가 대만 법률 문제를 생성형 AI에 물을 때 `tseng-law.com`이 인용되는지를 **분모부터 고정**한다. 이 문서는 채점표다. 2026-09-14 브라우저 재실측: **Perplexity 31/31 완료(Y9·N22)**. Google AIO는 reCAPTCHA로 중단(§2.6). CG/GM/CL/GR은 아직 대기.
