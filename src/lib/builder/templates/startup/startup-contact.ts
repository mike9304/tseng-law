...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Demo request ───────────────────────────────────────── */
  heading('tpl-stupcon-demo-title', { x: 80, y: DEMO_Y, width: 400, height: 50 }, '데모 요청', 2, '#16191f', 'left'),
  createContainerNode({
  ...
  heading('tpl-stupcon-office-title', { x: 80, y: 40, width: 400, height: 50 }, '오피스', 2, '#16191f', 'left', 'tpl-stupcon-office'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('startup', 'startup-contact-dir', STAGE_H),
  ...buildCategoryProofSections('startup', 'startup-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
