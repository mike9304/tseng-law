...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Cafe story ─────────────────────────────────────────── */
  heading('tpl-cafeabt-story-title', { x: 80, y: STORY_Y, width: 400, height: 50 }, '카페 이야기', 2, '#1f2622', 'left'),
  createTextNode({
  ...
  heading('tpl-cafeabt-sourcing-title', { x: 80, y: 40, width: 400, height: 50 }, '원두 소싱', 2, '#1f2622', 'left', 'tpl-cafeabt-sourcing'),
  createTextNode({
  ...
  /* ── Roasting philosophy ────────────────────────────────── */
  heading('tpl-cafeabt-roast-title', { x: 80, y: PHILOSOPHY_Y, width: 400, height: 50 }, '로스팅 철학', 2, '#1f2622', 'left'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('cafe', 'cafe-about-dir', STAGE_H),
  ...buildCategoryProofSections('cafe', 'cafe-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
