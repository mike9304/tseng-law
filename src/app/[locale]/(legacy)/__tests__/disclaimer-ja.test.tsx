...
describe('Japanese disclaimer integration', () => {
  it('publishes exact Japanese metadata with four-language alternates', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      vi: `${SITE_URL}/vi/disclaimer`,
      id: `${SITE_URL}/id/disclaimer`,
      th: `${SITE_URL}/th/disclaimer`,
      fil: `${SITE_URL}/fil/disclaimer`,
      ar: `${SITE_URL}/ar/disclaimer`,
      de: `${SITE_URL}/de/disclaimer`,
      es: `${SITE_URL}/es/disclaimer`,
      fr: `${SITE_URL}/fr/disclaimer`,
      pt: `${SITE_URL}/pt/disclaimer`,
      'zh-Hans': `${SITE_URL}/zh-hans/disclaimer`,
      ms: `${SITE_URL}/ms/disclaimer`,
      ru: `${SITE_URL}/ru/disclaimer`,
      tr: `${SITE_URL}/tr/disclaimer`,
      ...
      cs: `${SITE_URL}/cs/disclaimer`,
      hu: `${SITE_URL}/hu/disclaimer`,
      ro: `${SITE_URL}/ro/disclaimer`,
      uk: `${SITE_URL}/uk/disclaimer`,
      el: `${SITE_URL}/el/disclaimer`,
      he: `${SITE_URL}/he/disclaimer`,
      bn: `${SITE_URL}/bn/disclaimer`,
      ur: `${SITE_URL}/ur/disclaimer`,
      fa: `${SITE_URL}/fa/disclaimer`,
      my: `${SITE_URL}/my/disclaimer`,
      ta: `${SITE_URL}/ta/disclaimer`,
      ne: `${SITE_URL}/ne/disclaimer`,
      km: `${SITE_URL}/km/disclaimer`,
      mn: `${SITE_URL}/mn/disclaimer`,
      sk: `${SITE_URL}/sk/disclaimer`,
      bg: `${SITE_URL}/bg/disclaimer`,
      hr: `${SITE_URL}/hr/disclaimer`,
      sr: `${SITE_URL}/sr/disclaimer`,
      sl: `${SITE_URL}/sl/disclaimer`,
      lt: `${SITE_URL}/lt/disclaimer`,
      lv: `${SITE_URL}/lv/disclaimer`,
      et: `${SITE_URL}/et/disclaimer`,
      ca: `${SITE_URL}/ca/disclaimer`,
      is: `${SITE_URL}/is/disclaimer`,
