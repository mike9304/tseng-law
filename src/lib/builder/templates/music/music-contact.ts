...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#8b5cf6', borderRadius: 6 },
  }),
  ...
  ...buildCategoryContactMethods('music', 'music-contact-dir', STAGE_H),
  ...buildCategoryProofSections('music', 'music-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
