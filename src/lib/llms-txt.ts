...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  ta: {
    ...
    discoveryNotice:
      'llms.txt கோப்பு பொதுப் பக்கங்களைக் கண்டறிய உதவும் வரைபடம் மட்டுமே; தேடல் வரிசை, பரிந்துரை, செயற்கை நுண்ணறிவுப் பரிந்துரை அல்லது காட்சியை வாக்குறுதி அளிக்காது.',
    confidentialNotice:
