...
const expectedInvestment = {
  ...
  keyPoints: [
    ...
    '工場登記を免除された製造場所で生産される固形手作り石けんを除き、一定規模の化粧品製造・輸入業者は、対象製品の供給・販売等の前に製品登録を完了し、PIF（化粧品製品情報ファイル）を作成・保存しなければなりません。PIF自体を登録する制度ではありません。虚偽・誇大な表示・宣伝・広告には4万～20万新台湾ドル、医療効能を標榜する場合には60万～500万新台湾ドルの過料が科され得ます。',
