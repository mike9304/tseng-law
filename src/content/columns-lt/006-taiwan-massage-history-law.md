...
# Masažo istorija ir teisinė informacija Taivane

![Pagrindinis vaizdas](../images/006-taiwan-massage-history-law/featured-01.jpg)
...
Be kirpimo buvo ir įvairių paslaugų, tokių kaip skutimas ir veido priežiūra.

O esmė buvo ta, kad sėdint buvo galima gauti plaukų plovimą kartu su galvos odos, pečių ir kaklo masažu.

Jau vienas kirpimas leisdavo naudotis šia aukštos klasės paslauga, todėl kainos ir kokybės santykis buvo puikus.

Tai labai priminė dabartinį vietnamietiško stiliaus plaukų plovimą.

O tokios taivanietiško stiliaus kirpyklos daugeliui Taivano žmonių išliko savitu kultūriniu prisiminimu.

Šiandien tokios formos kirpyklos beveik nebesutinkamos.
...
Ten rikiuojasi visokių rūšių masažo įstaigos.

Yra asmenų su regos negalia atliekamas masažas (視障按摩), pėdų masažas, aliejinis masažas, tajų masažas ir kitos formos.

Iš esmės kiekvienas gali pasirinkti savo skoniui tinkamą masažą įtampai sumažinti.

O priežastis, kodėl šiandien yra tiek daug masažo įstaigų, gali būti būtent tas prašymas dėl konstitucinio išaiškinimo (釋憲).

Kai Taivanas 1980 m. paskelbė ir įgyvendino neįgaliųjų gerovės įstatymą (殘障福利法),
...
asmenys su regos negalia susiduria su daugeliu kliūčių augime, veikloje, mokymesi ir švietime, be kita ko,

o profesijos, kuriomis jie gali verstis, yra labai ribotos.

Todėl tuometinis įstatymų leidėjas, siekdamas apsaugoti silpnesnėje padėtyje buvusius asmenis su regos negalia,

priėmė įstatymą, kuris saugojo asmenų su regos negalia darbą ir teisę į pragyvenimą (生存權).
...
Šiuo metu Korėja vis dar leidžia verstis masažuotojo veikla tik kvalifikaciją turintiems asmenims su regos negalia,

o jei kas nors be šios kvalifikacijos ima iš kito asmens atlygį už masažą,
...
Tai rodo, kad kiekviena valstybė taiko skirtingus požiūrius įvairių grupių teisėms ir interesams apsaugoti.

Kiekvienos grupės teisių ir interesų apsauga nuolat keičiasi laikui bėgant,

o įstatymų leidėjas stengiasi rasti santykinai subalansuotą interesų konflikto sprendimą.

​

Šiandien daugelis asmenų renkasi masažą įtampai sumažinti,

tačiau šiame procese vis dar pasitaiko seksualinio priekabiavimo (性騷擾) arba nepadorių veiksmų (猥褻) atvejų.

Tai, kas iš pradžių turėjo būti tik masažo priėmimas įtampai sumažinti,

gali tapti viso gyvenimo trauma, jei patiriamas seksualinis priekabiavimas.

Jei masažo metu Taivane pajuntate diskomfortą arba kažką neįprasto,

praneškite nedelsiant arba paprašykite nutraukti, kad apsisaugotumėte.
