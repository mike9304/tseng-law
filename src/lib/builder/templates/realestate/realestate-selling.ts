...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#8b745b', borderRadius: 6 },
  }),
  ...
  heading('tpl-reselling-strat-1-title', { x: 24, y: 16, width: 300, height: 28 }, '전문 사진 촬영', 3, '#26313d', 'left', 'tpl-reselling-strat-1'),
  createTextNode({
  ...
  heading('tpl-reselling-strat-2-title', { x: 24, y: 16, width: 300, height: 28 }, '온라인 마케팅', 3, '#26313d', 'left', 'tpl-reselling-strat-2'),
  createTextNode({
  ...
  heading('tpl-reselling-strat-3-title', { x: 24, y: 16, width: 300, height: 28 }, '가격 전략', 3, '#26313d', 'left', 'tpl-reselling-strat-3'),
  createTextNode({
  ...
  heading('tpl-reselling-strat-4-title', { x: 24, y: 16, width: 300, height: 28 }, '홈 스테이징', 3, '#26313d', 'left', 'tpl-reselling-strat-4'),
  createTextNode({
  ...
  ...buildCategoryProofSections('realestate', 'realestate-selling', STAGE_H),
]);
