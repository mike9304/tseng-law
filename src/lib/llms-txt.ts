...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  bn: {
    ...
    discoveryNotice:
      'llms.txt ফাইল কেবল সর্বজনীন পাতা খুঁজে পাওয়ার মানচিত্র; এটি অনুসন্ধানে স্থান, সুপারিশ, কৃত্রিম বুদ্ধিমত্তার সুপারিশ বা নিশ্চিত দৃশ্যমানতার প্রতিশ্রুতি দেয় না।',
    confidentialNotice:
  ...
  mn: {
    ...
    discoveryNotice:
      'llms.txt файл нь зөвхөн нээлттэй хуудсыг олоход зориулсан газрын зураг юм; энэ нь хайлтын байр, зөвлөмж, хиймэл оюуны зөвлөмж, баталгаатай харагдах байдлыг амлахгүй.',
    confidentialNotice:
  ...
  et: {
    ...
    discoveryNotice:
      'Fail llms.txt on üksnes ülevaade avalike lehtede leidmiseks; see ei anna lubadust otsingukoha, soovituse, tehisintellekti soovituse ega nähtavuse kohta.',
    confidentialNotice:
