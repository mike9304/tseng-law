...
export const firmIntroductionContent: Record<SiteLocale, FirmIntroductionContent> = {
  ko: {
    ...
    paragraphs: [
      ...
      '법무법인 호정 변호사들은 각기 다른 분야에서 수년 간의 실무 경험을 쌓아온 대만 최고의 법학과 출신입니다. 다양한 복잡한 분쟁을 처리할 수 있는 완벽한 팀을 구성하고 있습니다. 가오슝 사무소는 기업 지배 구조를 주로 다루며 일반적인 민사, 형사, 행정 분쟁에서도 풍부한 경험을 갖추고 있습니다. 타이중 사무소는 건설 사건, 지식 재산 및 한국과 일본 사업을 전문으로 하며, 지식 재산 신청과 법률 분쟁 해결 등 다양한 사건을 처리합니다.',
      ...
      '2020년에, 소윤평 회계사가 법무법인 호정에 정식으로 합류하며, 호정 회계사무소를 설립하였습니다. 이는 기업주와 고자산 개인에게 종합적인 회계 및 세무 계획 서비스를 제공합니다.',
  ...
  en: {
    ...
    paragraphs: [
      ...
      'In 2020, CPA Shao Yun-Ping (邵允平) officially joined the firm and established the Hovering Accounting Office to provide integrated accounting and tax planning services for business owners and high-net-worth individuals.',
      'In 2024, to provide integrated support across legal, accounting, tax, and HR matters for business owners, Attorney Shao Yun-Liang established SHAW & ASSOCIATES, LAW FIRM (昊鼎維仁法律事務所) for one-stop, all-around business support.',
