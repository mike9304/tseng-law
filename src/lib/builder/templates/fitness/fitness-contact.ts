...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-fitcontact-addr-label', { x: 80, y: 210, width: 200, height: 32 }, '위치', 3, '#14181f', 'left', 'tpl-fitcontact-left'),
  createTextNode({
  ...
  heading('tpl-fitcontact-phone-label', { x: 80, y: 310, width: 200, height: 32 }, '전화번호', 3, '#14181f', 'left', 'tpl-fitcontact-left'),
  createTextNode({
  ...
  heading('tpl-fitcontact-hours-label', { x: 80, y: 410, width: 200, height: 32 }, '영업 시간', 3, '#14181f', 'left', 'tpl-fitcontact-left'),
  createTextNode({
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#e0532b', borderRadius: 6 },
  }),
  ...
  ...buildCategoryContactMethods('fitness', 'fitness-contact-dir', STAGE_H),
  ...buildCategoryProofSections('fitness', 'fitness-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
