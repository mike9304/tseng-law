...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  sr: {
    ...
    discoveryNotice:
      'Datoteka llms.txt samo je mapa za pronalaženje javnih stranica; ne obećava plasman u pretrazi, preporuku, preporuku veštačke inteligencije niti prikazivanje.',
    confidentialNotice:
