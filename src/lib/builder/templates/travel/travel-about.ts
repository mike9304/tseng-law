...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-travelabout-cert-1-title', { x: 24, y: 20, width: 302, height: 36 }, '전문 플래너팀', 3, '#101827', 'left', 'tpl-travelabout-cert-1'),
  createTextNode({
  ...
  heading('tpl-travelabout-cert-2-title', { x: 24, y: 20, width: 302, height: 36 }, '공인 인증', 3, '#101827', 'left', 'tpl-travelabout-cert-2'),
  createTextNode({
  ...
  heading('tpl-travelabout-cert-3-title', { x: 24, y: 20, width: 302, height: 36 }, '현지 파트너', 3, '#101827', 'left', 'tpl-travelabout-cert-3'),
  createTextNode({
  ...
  ...buildCategoryProofSections('travel', 'travel-about', STAGE_H),
]);
