...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  heading('tpl-creativeabout-title', { x: MARGIN, y: 50, width: 500, height: 56 }, '에이전시 소개', 1, '#0f0f12'),
  createTextNode({
  ...
  heading('tpl-creativeabout-story-title', { x: 580, y: 40, width: 400, height: 44 }, '우리의 이야기', 2, '#0f0f12', 'left', 'tpl-creativeabout-story'),
  createTextNode({
  ...
  /* ── Awards ──────────────────────────────────────────────── */
  heading('tpl-creativeabout-awards-title', { x: MARGIN, y: AWARDS_Y, width: 400, height: 50 }, '수상 및 인정', 2, '#0f0f12'),
  createContainerNode({
  ...
  ...buildCategoryContactMethods('creative', 'creative-about-dir', STAGE_H),
  ...buildCategoryProofSections('creative', 'creative-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
