...
Taiwanin työsopimuksen (勞動契約) vähimmäispalvelusaikaa koskevalla ehdolla (最低服務年限約定) vahvistetaan työntekijän lupaus pysyä sovittu jakso, se, onko varhaisessa irtisanoutumisessa palautettava koulutuskustannuksia, allekirjoitusbonus (簽約金) tai sitoutumisbonus (留任獎金), ja voidaanko erikseen vaatia sopimussakkoa (違約金). Pelkkä allekirjoitettu teksti ei kuitenkaan vahvista sopimuksen pätevyyttä eikä palautettavaa määrää. Sopimuksen nimestä riippumatta lakisääteiset vaatimukset sekä maksujen, koulutuksen ja päättymisen tosiasiallinen kulku on tutkittava vaiheittain.
...
Se, että työntekijä on allekirjoittanut sopimuksen, voi osoittaa sopimuksen olemassaolon, mutta se ei korvaa lakisääteisiä vaatimuksia. Päinvastoin, sen sijaan että heti pääteltäisiin pelkästään siksi, että sovittu jakso on pitkä, on tutkittava, mikä sijoitus tai mikä korvaus oli ja miksi tämä jakso on asetettu (最低服務年限約定).

## 2. Ensimmäinen lakisääteinen vaatimus: erikoistunut tekninen koulutus ja kustannuksen kantaminen

Perustaakseen sopimuksen koulutukseen työnantajan on tosiasiallisesti pitänyt antaa työntekijälle erikoistunut tekninen koulutus (專業技術培訓) ja kantaa kustannus. Ei riitä koulutussuunnitelmassa kirjoittaa, että kyse on ammatillisesta kurssista, tai sopimuksessa merkitä arvioitu kustannus (專業技術培訓). Näytön on voitava yhdistää koulutuksen aihe, tehtävälle tarpeellinen ammatillinen ja tekninen luonne, konkreettinen kesto, onko se suoritettu, ja tosiasiallinen meno.

Tutkimuskohde ei käsitä vain suoraan todennettavia kustannuksia, kuten palkkioita ulkoisille opettajille, kurssimaksuja koulutuskeskuksessa ja taksoja materiaaleista tai laitteista, vaan myös sisäisten kustannusten laskentaperustan, johon työnantaja vetoaa. Jos sisäistä henkilöstöä on opettanut, on katsottava, kenen aikaa koulutukseen on käytetty ja miten se eroaa tavanomaisesta valvonnasta tai tehtävän luovutuksesta, ja onko perustetta lukea se kustannus kyseiselle työntekijälle (專業技術培訓). Arvioitu määrä tai tasaisesti jaettu erä ei itsessään todista tosiasiallista kustannusta.

Ohjelma, koulutuskalenteri, läsnäololista, arviointitulos, suoritustodistus, laskut ja kuitit ovat perusnäyttöä koulutuksen todellisuuden ja kustannuksen vahvistamiseen. Sopimus työnantajan ja koulutuskeskuksen välillä, maksutositteet ja palautusehdot yhdessä tarkasteltuina täsmentävät tosiasiallisesti kannettua määrää. Jos osan kustannuksesta on maksanut työntekijä itse tai kolmas osapuoli, täytyy myös erottaa, kuka vastasi loppukustannuksesta.
...
Ensimmäisessä tekijässä katsotaan, kuinka kauan koulutus tosiasiallisesti on kestänyt ja kuinka paljon työnantaja on kantanut. Ei riitä esittää kokonaissummaa; olisi yhdessä vahvistettava näyttö erä erältä, kullekin työntekijälle luettu määrä, taito, jonka koulutus on antanut, ja jo ansaittu sijoitusosa.

Toinen tekijä, korvaamismahdollisuus (人力替補可能性), ei vahvistu pelkästään työnantajan väitteellä palkkaamisvaikeudesta. Tutkitaan, onko mahdollista hankkia henkilöstöä samassa tehtävässä tai vastaavassa tehtävässä, mitä pätevyyttä ja taitotasoa vaaditaan, mikä tavanomainen täyttöjakso on ja täsmääkö työnantajan vetoama toiminnallinen tarve objektiiviseen näyttöön (人力替補可能性).
...
Työministeriön ohje 勞動關2字第1150141814號 erottaa ja käsittelee koulutuksen, joka annetaan määräajoin, tavanomaisen tehtäväkoulutuksen, koulutuksen, jotta uusi työntekijä tutustuu työympäristöön ja menettelyihin, ja koulutuksen, jonka työnantajan on lain mukaan annettava. Koska tämä koulutus seuraa yrityksen toimintaa tai lakisääteisen velvoitteen täyttämistä, sen kustannusta ei voida muuttaa perustaksi sitoutumisvelvoitteelle tai seuraamukselle varhaisesta päättymisestä (勞動部).

Kurssit, jotka uusi työntekijä tavallisesti vastaanottaa, kuten työsääntöjen (工作規則) selitys, organisaation ja järjestelmien esittely, tavanomainen tehtävän luovutus ja turvallisuuden perusmenettelyt, on vahvistettava olemukseltaan. Tavanomaista palkkaamis- ja johtamiskustannusta tai luovutuskustannusta, jonka työnantaja normaalisti kantaisi, ei voida vahvistaa palautuskohteeksi pelkästään merkitsemällä ne erilliseksi sijoitukseksi.

Kuitenkaan ei aina suljeta pois koulutusta pelkästään siksi, että se on annettu yrityksen sisällä. Yhdessä ja samassa ohjelmassa tavanomainen sopeutumisosa ja erikoistunut tekninen osa voivat olla sekoitettuina, joten aihe, aika, kustannus ja onko lakisääteinen velvoite, on vahvistettava kurssittain (專業技術培訓). Sen, joka vetoaa erikoistuneeseen tekniseen osaan, on näytöllä selitettävä, mikä sisältö eroaa tavanomaisesta koulutuksesta ja kuka on tosiasiallisesti kantanut kustannuksen.
...
Suhteellinen palautus täyttämättömän jakson mukaan (預付性給付) edellyttää ensin sopimuksen alku- ja loppupäivän, tosiasiallisesti suoritettujen päivien ja palautuslaskennan perusmäärän vahvistamista. Esimerkiksi kiinteä määrä, joka ei lainkaan heijasta jo täytettyä jaksoa, on tutkittava ohjeen suhteellisuuskriteeriä vasten. Jos rakenne on hajautettu maksu tai kohdentaminen vaiheittain, on myös erikseen laskettava, mitä jaksoa kukin erä vastaa (預付性給付).
...
Näyttö voi käsittää irtisanomisilmoituksen, irtisanoutumiskirjeen, asiakirjan päättymisestä yhteisymmärryksessä, sähköpostin ja ilmoitusrekisterin, näytön työehtojen muutoksesta sekä läsnäolo- ja työrekisterin. Vaikka terveyttä tai työoloja mainitaan, tulosta ei päätellä pelkästään ilmaisun mukaan, vaan katsotaan yhdessä tosiasiallinen kulku, lakisääteinen päättymisperusta ja liittyvät todisteet.

Irtisanominen, päättyminen yhteisymmärryksessä ja väite työehtojen rikkomisesta ovat vain esimerkkejä olosuhteista, jotka on tutkittava, ei suljettu luettelo syistä, joita ei voida lukea työntekijän syyksi. Samanniminen päättyminen voi erota osapuolten tahdossa ja kulussa, eikä asiakirjaan kirjoitettu nimike välttämättä vastaa tosiasioita (勞動契約).

Päättymissyyn arviointi vaikuttaa myös suoraan palautuksen laajuuteen. Jos 4 kohta tulee sovellettavaksi, ei voida vaatia työntekijältä vastuuta vähimmäispalvelusaikaa koskevan sopimuksen rikkomisesta eikä koulutuskustannusten palautusta, joten kohdentaminen on vahvistettava ennen kaavan soveltamista. Jos on myös ennakkomaksu ja muita erillisiä vaatimuksia, tutkitaan kunkin vaatimuksen oikeudellinen luonne ja perusta.

## 8. Irtisanoutumisen ennakkoilmoitus on erillinen kysymys

Sopimus vähimmäispalvelusajasta ei estä työntekijää irtisanoutumasta sen enempää käytännössä kuin oikeudellisestikaan. Irtisanoutumistahdonilmaisu ja ennakkoilmoitusaika (預告期間) ovat kysymys siitä, milloin työsuhde päättyy; vähimmäispalvelusaikaa koskevan sopimuksen pätevyys ja vastuu kustannusten palautuksesta ovat kysymys siitä, syntyykö päättymisestä varallisuusoikeudellinen vastuu.

Kun työntekijä irtisanoo toistaiseksi voimassa olevan työsopimuksen (不定期契約), sovelletaan Taiwanin työelämän normeja koskevan lain 15 artiklan mukaan analogisesti 16 artiklan 1 kohdan ennakkoilmoitusaikaa. 16 artikla on säännös työnantajan suorittamasta irtisanomisesta, ja työntekijän irtisanoutumiseen tätä ennakkoilmoitusaikaa sovelletaan 15 artiklan kautta.
...
Käytännössä irtisanoutumistahdonilmaisun sisältö ja lähetyspäivä, päivä, jona työnantaja on sen tosiasiallisesti vastaanottanut, ja osapuolten ilmoitukset viimeisestä työpäivästä on säilytettävä. Jos 4 kysymyksessä erotetaan ajankohta, jona irtisanoutuminen pätevästi saa vaikutuksen, vähimmäispalvelusaikaa koskevan sopimuksen pätevyys, koulutuskustannusten tai ennakkomaksun palautus ja vahinko, johon vedotaan erikseen, pienennetään riskiä, että yhdestä sopimuslausekkeesta vedetään kaikki johtopäätökset.

## 9. Tarkistuslista työnantajalle ja työntekijälle

Riidan ehkäisemiseksi tai jo esitetyn vaatimuksen tutkimiseksi ei saa lukea vain sopimusta, vaan on yhdessä järjestettävä näyttö koulutuksesta, maksusta, työstä ja päättymisestä aikajärjestyksessä. Erityisesti auttaa, jos taulukkoon järjestetään, kuinka paljon sovitusta jaksosta on täytetty ja kuinka paljon jää, ja mitä näyttöä vedottu kustannus ja korvaus vastaavat, riitakohteiden erottamiseksi (勞動契約).
...
3. Säilytetään kurssiohjelma, kalenteri, suoritusrekisteri, laskut, kuitit ja näyttö siitä, kuka on kantanut kustannuksen, ja kirjataan erikseen perusta ulkoisille ja sisäisille kustannuksille.
...
8. Ennen vähennystä palkasta tai palautusvaatimusta tutkitaan sopimus, maksutositteet, palkkalaskelma, osapuolten ilmoitukset, vaatimus ja vähennysrekisteri oikeudellisen perustan ja menettelyn todentamiseksi.
...
3. Varmistetaan maksutositteet allekirjoitusbonuksesta, sitoutumisbonuksesta ja muista ennakkomaksuista (預付性給付), ilmoitus korvauksen tarkoituksesta, maksupäivä, ansaintaehdot ja palautuskaava.
...
7. Tutkitaan erikseen vähimmäispalvelusaikaa koskevan sopimuksen pätevyys, irtisanoutumistahdonilmaisu ja ennakkoilmoitus, koulutuskustannusten ja ennakkomaksun palautus sekä vahinko, johon vedotaan erikseen.
...
Näyttöä aikajärjestykseen järjestettäessä sopimuksen tekemisen päivä, koulutuksen alku- ja loppupäivät, kukin maksupäivä, työn alku- ja loppupäivät ja ilmoituksen lähetyspäivä olisi merkittävä samaan luetteloon. Jos osa aineistosta on vain työnantajan hallussa, järjestetään ensin oma näyttö ja vaaditun määrän laskentaperusta, ja lisäaineisto vahvistetaan tarvittavan menettelyn jälkeen.
