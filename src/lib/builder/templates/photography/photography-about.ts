...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('photography', 'photography-about-dir', STAGE_H),
  ...buildCategoryProofSections('photography', 'photography-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
