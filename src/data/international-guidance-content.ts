      ...
      services: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'กลุ่มนี้ครอบคลุมการเลิกจ้าง ค่าชดเชยตามกฎหมายไต้หวัน (資遣費) ซึ่งไม่ควรถือว่าเหมือนกับค่าชดเชยเมื่อออกจากงาน หรือหลักเกณฑ์คุ้มครองลูกจ้างเมื่อถูกเลิกจ้างของประเทศอื่น ค่าจ้าง และข้อพิพาทที่เกิดจากข้อกำหนดในสัญญาจ้างแรงงาน (勞動契約) ทั้งในฝ่ายลูกจ้างและฝ่ายนายจ้าง ในการตรวจสอบ เราจะแยกเหตุแห่งการเลิกจ้างออกจากประเด็นเรื่องการบอกกล่าว เงินที่ต้องจ่าย และกำหนดเวลา',
      ...
      services: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'يشمل هذا المجال منازعات العقود، ودعاوى التعويض عن الضرر خارج نطاق العقد، ومنازعات المستهلك. ويبدأ العمل عادةً بترتيب مجريات الواقعة، وتحديد المستندات والأدلة المتوفرة، ثم بحث الخيارات المتاحة.',
