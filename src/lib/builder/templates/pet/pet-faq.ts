...
const faqNodes: BuilderCanvasNode[] = faqs.flatMap((f, i) => {
  ...
  return [
    createContainerNode({
      ...
      background: i % 2 === 0 ? '#f3e7da' : '#ffffff',
      borderRadius: 8,
      padding: 16,
    }),
    createTextNode({
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-petfaq-list-title', { x: 80, y: FAQ_Y, width: 400, height: 50 }, 'FAQ', 2, '#2b2018', 'left'),
  ...faqNodes,
  ...buildCategoryProofSections('pet', 'pet-faq', STAGE_H),
]);
