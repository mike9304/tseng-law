...
describe('Japanese lawyers-list integration', () => {
  ...
  it('publishes Japanese metadata with four-language alternates', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      ar: `${SITE_URL}/ar/lawyers`,
      de: `${SITE_URL}/de/lawyers`,
      ...
      it: `${SITE_URL}/it/lawyers`,
      nl: `${SITE_URL}/nl/lawyers`,
      pl: `${SITE_URL}/pl/lawyers`,
      hi: `${SITE_URL}/hi/lawyers`,
      sv: `${SITE_URL}/sv/lawyers`,
      da: `${SITE_URL}/da/lawyers`,
      nb: `${SITE_URL}/nb/lawyers`,
      fi: `${SITE_URL}/fi/lawyers`,
      cs: `${SITE_URL}/cs/lawyers`,
      hu: `${SITE_URL}/hu/lawyers`,
      ro: `${SITE_URL}/ro/lawyers`,
      uk: `${SITE_URL}/uk/lawyers`,
      el: `${SITE_URL}/el/lawyers`,
      he: `${SITE_URL}/he/lawyers`,
      bn: `${SITE_URL}/bn/lawyers`,
      ur: `${SITE_URL}/ur/lawyers`,
      fa: `${SITE_URL}/fa/lawyers`,
      my: `${SITE_URL}/my/lawyers`,
      ta: `${SITE_URL}/ta/lawyers`,
      ne: `${SITE_URL}/ne/lawyers`,
      km: `${SITE_URL}/km/lawyers`,
      mn: `${SITE_URL}/mn/lawyers`,
      sk: `${SITE_URL}/sk/lawyers`,
      bg: `${SITE_URL}/bg/lawyers`,
      hr: `${SITE_URL}/hr/lawyers`,
      sr: `${SITE_URL}/sr/lawyers`,
      sl: `${SITE_URL}/sl/lawyers`,
      lt: `${SITE_URL}/lt/lawyers`,
      lv: `${SITE_URL}/lv/lawyers`,
      et: `${SITE_URL}/et/lawyers`,
      ca: `${SITE_URL}/ca/lawyers`,
      is: `${SITE_URL}/is/lawyers`,
