...
| M159 | CMS | Dataset/repeater/dynamic page binding | F17~F26 | 32h | M158 | 🟡 home insights + services runtime datasets, generic repeater preview contract, selected-record dynamic URL + per-item SEO preview, service dataset inspector/E2E green / visual repeater editing + full dynamic template editor remain |
