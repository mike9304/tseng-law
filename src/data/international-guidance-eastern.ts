    ...
    services: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'אנו מטפלים בגירושין (離婚), בחלוקת רכוש, במשמורת ובאחריות ההורית כלפי ילדים קטינים (未成年子女權利義務之行使或負擔), בקשר עם הילד (會面交往) ובירושה (繼承), גם כאשר הצדדים או הנכסים מצויים במדינות שונות. עניינים משפחתיים חוצי גבולות מצריכים לעיתים קרובות בדיקה נוספת של מרשם התושבים (戶籍), של צורת המסמכים ושל כוחם הראייתי בטאיוואן.',
        ...
        },
        {
          ...
          paragraphs: [
            'תחום זה כולל סיום יחסי עבודה, פיצוי לפי דין טאיוואן (資遣費; אין להשוותו למוסדות דומים במדינות אחרות), שכר וסכסוכים מחוזה העבודה (勞動契約), הן מצד העובד והן מצד המעסיק. בבדיקה אנו מבחינים בין עילת הסיום לבין שאלות של הודעה מוקדמת, תשלום ומועדים.',
    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'לאחר קבלת התקציר שלכם עורכת דין או עורך דין בודקים את התוכן, ולאחר מכן משוחחים על היקף העבודה האפשרי, על המסמכים הנדרשים עדיין ועל הצעדים הבאים. בעניינים של מס או הנהלת חשבונות יכול המשרד לעבוד עם מחלקת הנהלת החשבונות ברצף אחד.',
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'עמוד זה אינו נוקב בתקופת שמירה קבועה, משום שהמשך הזמן בפועל תלוי בהתפתחות העניין ובחובות הכרוכות בו. אם ברצונכם לבקש מחיקה מוקדמת יותר, ציינו זאת בפנייה.',
          ],
        },
        {
