---
title: "Constitució de societats a Taiwan — part avançada 1"
...
# Constitució de societats a Taiwan — part avançada 1
...
Això es deu al fet que el Departament de Revisió d’Inversions ha de confirmar si aquest capital s’utilitza realment amb finalitats d’inversió.

També ha de confirmar que no es tracta d’una entrada de fons des de l’exterior amb un altre pretext.

En redactar el pla d’inversió no cal escriure l’adreça exacta de la societat; n’hi ha prou d’indicar la zona (per exemple, la ciutat de Taipei). ​

Tanmateix, quan més endavant s’obre al banc el compte preparatori de la societat (公司籌備處帳戶), molts bancs revisen el contracte d’arrendament (租賃契約) i inspeccionen in situ l’adreça de la societat.

Un empleat d’un banc taiwanès m’ho va dir en persona.

Recentment hi ha molts casos d’estrangers que, després d’obrir el compte, desapareixen, de manera que l’obertura de comptes s’ha tornat cada vegada més estricta.

A la part bàsica anterior un lector va esmentar que l’obertura del compte és el tràmit més difícil, i hi estic d’acord.
...
Si no té certificat de residència, pot sol·licitar a l’Administració d’Immigració de Taiwan el «formulari de dades bàsiques del número d’identificació unificat» (統一證號基本資料表).

Es pot expedir el mateix dia.

L’Administració d’Immigració, però, està molt concorreguda, de manera que convé anar-hi d’hora i agafar número.
...
L’examen, però, no és excessivament estricte: cada sol·licitud es valora a partir dels seus documents.
...
Si la negociació amb el propietari no avança amb fluïdesa, hi ha marge per reforçar l’oferta.
...
Si es tracta d’un local d’oficines ordinari, el registre de la societat no és possible.
...
*Si necessita ajuda o assessorament sobre el dret de Taiwan, escrigui a través de la pàgina Contacte; no es promet cap termini de resposta.*
