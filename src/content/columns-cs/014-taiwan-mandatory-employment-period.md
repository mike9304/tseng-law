---
title: "Ujednání o minimální době trvání pracovního poměru na Tchaj-wanu: kritéria platnosti, náklady na školení a smluvní pokuta"
...
faq:
  - q: "Je ujednání o minimální době trvání pracovního poměru (最低服務年限約定) v pracovní smlouvě na Tchaj-wanu automaticky neplatné?"
    a: "Ujednání není automaticky neplatné. Podle čl. 15-1 tchajwanského zákona o pracovních normách (勞動基準法) může splnit zákonné předpoklady, pokud zaměstnavatel poskytne specializované technické školení (專業技術培訓) a nese jeho náklady, nebo poskytne přiměřenou náhradu (合理補償), aby pracovník dodržel minimální dobu trvání pracovního poměru. Není nutné splnit oba předpoklady zároveň, avšak i když existuje jeden, ujednání nesmí překročit přiměřený rozsah ve světle všech okolností, jako jsou doba a náklady školení, možnost nahradit personál (人力替補可能性) a výše a rozsah náhrady."
...
# Ujednání o minimální době trvání pracovního poměru na Tchaj-wanu: kritéria platnosti, náklady na školení a smluvní pokuta

![Snímek vysvětlující minimální dobu trvání pracovního poměru v pracovní smlouvě a otázku vrácení nákladů](../images/014-taiwan-mandatory-employment-period/featured-01.jpg)

Ujednání o minimální době trvání pracovního poměru (最低服務年限約定) pracovní smlouvy (勞動契約) na Tchaj-wanu se používá spolu se slibem pracovat po určitou dobu k určení, zda při předčasném odchodu existuje povinnost vrátit náklady na školení, podpisovou prémii (簽約金) nebo prémii za setrvání (留任獎金) a zda lze zvlášť žádat smluvní pokutu (違約金). Samotná skutečnost, že existuje podepsaný text, však neurčuje platnost ujednání ani částku k vrácení. Více než název smlouvy je třeba po krocích ověřit zákonné předpoklady a skutečný průběh výplat, školení a skončení.
...
I když tyto čtyři otázky figurují společně v téže smlouvě, použitelné ustanovení a potřebný důkaz jsou odlišné. Proto je třeba zvlášť posoudit, zda je ujednání platné, kdy nabývá účinků projev odchodu, zda existuje odpovědnost vrátit plnění poskytnuté předem (預付性給付) nebo náklady na školení a zda skutečně vznikla zvlášť uplatňovaná škoda.

## 1. Kdy nabývá ujednání o minimální době trvání pracovního poměru účinků?

Ujednání není automaticky neplatné. Podle čl. 15-1 tchajwanského zákona o pracovních normách (勞動基準法) může splnit zákonné předpoklady, pokud zaměstnavatel poskytne specializované technické školení (專業技術培訓) a nese jeho náklady, nebo poskytne přiměřenou náhradu (合理補償), aby pracovník dodržel minimální dobu trvání pracovního poměru. Není nutné splnit oba předpoklady zároveň, avšak i když existuje jeden, ujednání nesmí překročit přiměřený rozsah ve světle všech okolností, jako jsou doba a náklady školení, možnost nahradit personál (人力替補可能性) a výše a rozsah náhrady.

Čl. 15-1 odst. 1 upravuje alternativně dva zákonné předpoklady. První je, že zaměstnavatel poskytl pracovníkovi specializované technické školení a nesl jeho náklady; druhý, že poskytl přiměřenou náhradu výměnou za dodržení minimální doby trvání pracovního poměru. Je třeba ověřit nikoli, jaké jméno bylo ve smlouvě dáno, ale jaký základ skutečně existuje.
...
Program, kalendář školení, prezenční listina, výsledek hodnocení, osvědčení o dokončení, faktury a stvrzenky jsou základními podklady k potvrzení skutečnosti školení a nákladů. Smlouva mezi zaměstnavatelem a vzdělávacím zařízením, doklady o platbě a podmínky vrácení, viděny společně, umožňují přesněji zachytit skutečné břemeno. Pokud pracovník zaplatil část nákladů přímo nebo je nesla třetí osoba, je třeba také rozlišit, kdo nesl konečné náklady.
...
Je třeba také rozlišit vrácení nákladů na školení a vrácení plnění poskytnutého předem. První se posuzuje se středem na skutečné specializované technické školení a nesení nákladů; druhé na účel výplaty, sdělení, podmínky přiřazení a poměr k nesplněné době. Žádají-li se obě položky společně, je třeba zvlášť porovnat, zda náklad nebyl vypočten dvakrát, a doklady každé položky.

## 7. Když smlouva skončí z důvodu nepřičitatelného pracovníkovi

Čl. 15-1 odst. 4 tchajwanského zákona o pracovních normách stanoví, že pokud pracovní smlouva skončí před koncem minimální doby trvání pracovního poměru z důvodu nepřičitatelného pracovníkovi, pracovník nenese odpovědnost za porušení ujednání o minimální době trvání pracovního poměru ani za vrácení nákladů na školení. Důvod skončení a přičtení odpovědnosti se však musí posoudit z konkrétních důkazů, jako je oznámení o propuštění, projev odchodu a podklady o porušení pracovních podmínek.
...
Posouzení důvodu skončení ovlivňuje přímo i rozsah vrácení. Pokud se uplatní odst. 4, nelze po pracovníkovi žádat odpovědnost za porušení ujednání o minimální době trvání pracovního poměru ani vrácení nákladů na školení, proto je třeba přičtení ověřit před použitím vzorce. Existuje-li také plnění poskytnuté předem a jiné zvlášť uplatňované nároky, posuzuje se právní povaha a základ každého nároku.

## 8. Výpovědní doba odchodu je odlišná otázka

Ujednání o minimální době trvání pracovního poměru není institutem, který by fyzicky nebo právně bránil odchodu pracovníka. Projev odchodu a výpovědní doba (預告期間) jsou otázkou, kdy končí pracovní vztah; platnost ujednání o minimální době trvání pracovního poměru a odpovědnost za vrácení nákladů jsou otázkou, zda existuje majetková odpovědnost odvozená ze skončení.
...
7. Zvlášť se posoudí platnost ujednání o minimální době trvání pracovního poměru, projev odchodu a výpovědní doba, vrácení nákladů na školení a plnění poskytnutého předem a zvlášť uplatňovaná škoda.
