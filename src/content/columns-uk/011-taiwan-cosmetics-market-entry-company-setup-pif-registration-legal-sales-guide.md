...
2. Підтвердити суб’єкта, який бере правову відповідальність як виробник або імпортер косметики, і особу, відповідальну за роботу за договором.
...
Базову структуру товариства та філії можна побачити в [Основах заснування товариства на Тайвані](/uk/columns/taiwan-company-establishment-basics), обсяг пов’язаної підтримки — у [Які справи ми ведемо](/uk/services), а інформацію про адвокатку, яка веде такі справи, — у [Міжнародна команда Hovering](/uk/lawyers).
