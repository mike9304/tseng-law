...
Регистрация косметического изделия проводится на платформе регистрации косметических изделий TFDA. Изготовитель или импортёр косметики должен завершить регистрацию изделия до поставки, продажи, дарения, публичной выставки (公開陳列) или предоставления потребителю для пробного использования. Подготовку нельзя строить лишь исходя из возмездной продажи; график рекламных дарений или предоставления потребителю для пробы также следует вести вместе с моментом регистрации.

Срок действия регистрации изделия составляет 3 года. Чтобы продолжать поставку, заявление о продлении (展延) следует подать в течение 3 месяцев до истечения срока действия. Если изменяются зарегистрированные сведения, такие как наименование изделия, назначение, лекарственная форма (劑型), состав, место изготовления, следует также подтвердить, необходима ли процедура, соответствующая содержанию изменения.
...
Работы PIF, включая оценку безопасности, может поддерживать 3 лицо, обладающее необходимой квалификацией и способностью. Однако даже при использовании поддержки составления со стороны 3 лица или услуги хранения материалов юридическая ответственность изготовителя или импортёра косметики сохраняется. Следует выстроить систему, позволяющую изготовителю происхождения, испытательной организации, оценщику безопасности и предприятию на стороне Тайваня взаимно передавать сведения об изменениях и актуальные подписанные материалы.
...
Заявление ложных сведений при регистрации изделия или внесение ложных сведений в PIF может стать объектом административного штрафа (罰鍰) в размере TWD 10.000–1.000.000. Напротив, если материалы PIF неполны, компетентный орган обычно назначает срок для исправления (限期改正), и штраф ставится, когда в этот срок исправление не произведено. Ложные сведения и восполнимую неполноту материалов нельзя заключать как одинаковый результат нарушения.
...
Подготовку к продаже на Тайване, если проверять в следующем порядке, можно снизить риск смешения различных режимов.
...
3. Завершают регистрацию изделия до поставки, продажи, дарения, публичной выставки или предоставления потребителю для пробного использования.
...
Основную структуру компании и филиала можно увидеть в [Основах создания компании на Тайване](/ru/columns/taiwan-company-establishment-basics), связанный круг поддержки — в [услугах по инвестициям и созданию компании на Тайване](/ko/services/investment), сведения о ведущем адвокате — в [профиле адвоката Wei Tseng](/ko/lawyers/wei-tseng).
...
- [Invest Taiwan — обзор иностранной инвестиции](https://investtaiwan.nat.gov.tw/showPage?lang=jpn&search=InvestmentStatus01)
