...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-beautycontact-addr-label', { x: 80, y: 210, width: 200, height: 32 }, '위치', 3, '#2b1c18', 'left', 'tpl-beautycontact-left'),
  createTextNode({
  ...
  heading('tpl-beautycontact-phone-label', { x: 80, y: 310, width: 200, height: 32 }, '전화번호', 3, '#2b1c18', 'left', 'tpl-beautycontact-left'),
  createTextNode({
  ...
  heading('tpl-beautycontact-hours-label', { x: 80, y: 410, width: 200, height: 32 }, '영업 시간', 3, '#2b1c18', 'left', 'tpl-beautycontact-left'),
  createTextNode({
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#b07d3f', borderRadius: 6 },
  }),
  ...
  ...buildCategoryContactMethods('beauty', 'beauty-contact-dir', STAGE_H),
  ...buildCategoryProofSections('beauty', 'beauty-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
