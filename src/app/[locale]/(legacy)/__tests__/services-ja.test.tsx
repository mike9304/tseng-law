...
describe('Japanese services-list integration', () => {
  ...
  it('publishes Japanese metadata with four-language alternates', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      it: `${SITE_URL}/it/services`,
      nl: `${SITE_URL}/nl/services`,
      pl: `${SITE_URL}/pl/services`,
      hi: `${SITE_URL}/hi/services`,
      sv: `${SITE_URL}/sv/services`,
      da: `${SITE_URL}/da/services`,
      nb: `${SITE_URL}/nb/services`,
      fi: `${SITE_URL}/fi/services`,
      cs: `${SITE_URL}/cs/services`,
      hu: `${SITE_URL}/hu/services`,
      ro: `${SITE_URL}/ro/services`,
      uk: `${SITE_URL}/uk/services`,
      el: `${SITE_URL}/el/services`,
      he: `${SITE_URL}/he/services`,
      bn: `${SITE_URL}/bn/services`,
      ur: `${SITE_URL}/ur/services`,
      fa: `${SITE_URL}/fa/services`,
      my: `${SITE_URL}/my/services`,
      ta: `${SITE_URL}/ta/services`,
      ne: `${SITE_URL}/ne/services`,
      km: `${SITE_URL}/km/services`,
      mn: `${SITE_URL}/mn/services`,
      sk: `${SITE_URL}/sk/services`,
      bg: `${SITE_URL}/bg/services`,
      hr: `${SITE_URL}/hr/services`,
      sr: `${SITE_URL}/sr/services`,
      sl: `${SITE_URL}/sl/services`,
      lt: `${SITE_URL}/lt/services`,
      lv: `${SITE_URL}/lv/services`,
      et: `${SITE_URL}/et/services`,
      ca: `${SITE_URL}/ca/services`,
      is: `${SITE_URL}/is/services`,
