# EN/SEA 노출 — 사용자(손빗) 액션 런북 2026-09

코드·문서 측은 Fable goal 세션이 처리(SEO-EN-SEA-GOAL.md). 아래는 **콘솔·계정 권한이 필요해 사용자만 할 수 있는 것**. 우선순위순.

## A. 콘솔 라운드 (1회 30분 — 분모 고정, EN-SEA-MEASUREMENT §2와 동일)
1. GSC Performance → 페이지 필터 `/en/`: 쿼리·국가·노출·클릭(28일) 캡처
2. GSC 국가 필터 SG·MY·PH·US·AU·GB 상위 쿼리 캡처
3. GSC URL 검사: /en 랜딩4+가이드+칼럼 표본5 색인 상태 → **미색인 목록을 Fable에 전달**(아웃리치 앵커 타깃)
4. GSC Settings → "Search generative AI" = Include 확인
5. Bing WMT AI Performance → Citation Share 기준선 캡처
6. GBP 현황 캡처

## B. GBP 영어화 (P3 — 반나절, 효과 근거: 구글 공식 지오신호+AI Mode 인용 1위원)
1. Services 섹션: 사전정의 서비스 채우기(Company registration / Litigation / Employment / Immigration 등 — 24~72h 내 반영)
2. 비즈니스 설명에 영어 문단 추가(승소율·결과보장 문구 금지)
3. 영어권 실의뢰인 리뷰 요청 — **대가·인센티브 절대 금지**(정책 위반 + 기존 리뷰이벤트 게이트 미해소 상태)
4. 상호명에 다중언어 병기 금지(현행 유지)

## C. 아웃리치 (P1 — 주 1건 페이스, 문안·게이트는 EN-OUTREACH-PACK-2026-09.md)
