...
export const guideContent: Record<Locale, GuideContent> = {
  ko: {
    title: '대만 회사설립 종합 가이드',
    metaTitle: '대만 회사설립 절차·비용 총정리 (2026) | 법무법인 호정',
    description:
      '대만 회사설립 절차(투심회 승인→사명 예심→설립 등기→세적 등기→계좌 개설), 법인 형태 비교(자회사·지사·연락사무소), 비용·기간, 자주 묻는 질문까지 한국어로 정리한 종합 가이드입니다.',
    keywords: [
      '대만 회사설립',
      '대만 법인설립',
      '대만 회사설립 비용',
    ...
    procedureHeading: '대만 회사설립 절차 (5단계)',
    procedureIntro:
      '아래 5단계는 대만 회사설립의 핵심 흐름을 정리한 것입니다. 각 단계의 세부 서류와 일정은 사안에 따라 달라질 수 있습니다.',
    steps: [
      {
