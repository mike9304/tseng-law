...
| Dynamic content | F17-F26 | Datasets, repeaters, dynamic pages | Partial: home insights/services runtime datasets + page templates | Generic repeater binding, dynamic URLs, SEO per item |
