...
faq:
  - q: "A tajvani munkaszerződés minimális munkavégzési időszakra vonatkozó megállapodása (最低服務年限約定) automatikusan semmis?"
    a: "Nem. A tajvani munkaügyi törvény (勞動基準法) 15-1. cikke szerint, ha a munkáltató szakképzett műszaki képzést (專業技術培訓) tart és viseli a költséget, vagy észszerű ellentételezést (合理補償) nyújt, hogy a munkavállaló tartsa a minimális munkavégzési időszakot, a megállapodás teljesítheti a törvényi feltételeket. Nem kell a két feltételt egyszerre teljesíteni, de ha bármelyik fennáll is, a megállapodás a körülmények összessége, például a képzés időtartama és költsége, a helyettesítési lehetőség (人力替補可能性), valamint az ellentételezés összege és köre alapján nem lépheti túl az észszerű kört."
  - q: "Az újonnan belépők képzése vagy a törvényileg kötelező képzés szakképzett műszaki képzésnek minősül?"
    a: "A tajvani Munkaügyi Minisztérium (勞動部) 2026-06-05-i iránymutatása szerint a rendszeres képzés, az általános munkaköri képzés, az újonnan belépők munkahelyi beilleszkedési képzése és a törvény által elrendelt kötelező képzés költsége nem alapja a minimális munkavégzési időszakra vonatkozó megállapodásnak, sem kötbér (違約金) vagy költség-visszatérítés iránti igénynek. Nemcsak a képzés megnevezését kell nézni, hanem a konkrét tanmenetet, a szakmai-műszaki tartalmat, az időtartamot, a munkáltató által ténylegesen viselt költséget és a bizonylatokat."
  - q: "Korai kilépéskor a szerződéskötési díjat (簽約金) vagy a bentmaradási bónuszt (留任獎金) teljes egészében vissza kell adni?"
    a: "Nem mindig a teljes összeget kell visszaadni. Ha a szerződéskötési díj, a bentmaradási bónusz vagy más előzetes juttatás (預付性給付) a minimális munkavégzési időszakra vonatkozó megállapodás észszerű ellentételezéseként került kifizetésre, a célt egyértelműen közölni kell a munkavállalóval. A tajvani Munkaügyi Minisztérium 2026-06-05-i iránymutatása szerint az időszak lejárta előtti kilépéskor a visszatérítendő összeget a még nem teljesített időszakra arányosan kell számítani, és nem szabad a teljes összeg visszatérítését követelni. A tényleges következtetés a kifizetés célját, a megállapodás tartalmát, a már ledolgozott időszakot és a megszűnés okát együtt vizsgálja."
  - q: "Ha a szerződés a munkavállalónak nem felróható okból korán szűnik meg, vissza kell téríteni a képzési költséget?"
    a: "A tajvani munkaügyi törvény 15-1. cikk 4. bekezdése úgy rendelkezik, hogy ha a munkaszerződés a minimális munkavégzési időszak vége előtt a munkavállalónak nem felróható okból szűnik meg, a munkavállaló nem visel felelősséget a minimális munkavégzési időszakra vonatkozó megállapodás megsértéséért, sem a képzési költség visszatérítéséért. A megszűnés okát és a felelősség hovatartozását azonban konkrét bizonyítékok, például felmondási értesítés, kilépési nyilatkozat és a munkafeltételek megsértésére vonatkozó iratok alapján kell megítélni."
---
...
![A munkaszerződés minimális munkavégzési időszakát és a költség-visszatérítés kérdését ismertető kép](../images/014-taiwan-mandatory-employment-period/featured-01.jpg)

A tajvani munkaszerződés (勞動契約) minimális munkavégzési időszakra vonatkozó megállapodása (最低服務年限約定) meghatározott ideig tartó munkavégzés ígéretével együtt azt rögzíti, hogy korai kilépéskor van-e kötelezettség a képzési költség, a szerződéskötési díj (簽約金) vagy a bentmaradási bónusz (留任獎金) visszatérítésére, és kérhető-e külön kötbér (違約金). Az aláírt szöveg megléte önmagában azonban nem rögzíti a megállapodás érvényességét, sem a visszatérítendő összeget. A szerződés megnevezésénél fontosabb lépésenként ellenőrizni a törvényi feltételeket, valamint a kifizetés, a képzés és a megszűnés tényleges lefolyását.
...
## 1. Mikor hatályosul a minimális munkavégzési időszakra vonatkozó megállapodás?

Nem. A tajvani munkaügyi törvény (勞動基準法) 15-1. cikke szerint, ha a munkáltató szakképzett műszaki képzést (專業技術培訓) tart és viseli a költséget, vagy észszerű ellentételezést (合理補償) nyújt, hogy a munkavállaló tartsa a minimális munkavégzési időszakot, a megállapodás teljesítheti a törvényi feltételeket. Nem kell a két feltételt egyszerre teljesíteni, de ha bármelyik fennáll is, a megállapodás a körülmények összessége, például a képzés időtartama és költsége, a helyettesítési lehetőség (人力替補可能性), valamint az ellentételezés összege és köre alapján nem lépheti túl az észszerű kört.

A 15-1. cikk 1. bekezdése két törvényi feltételt választólagosan szabályoz. Az első, hogy a munkáltató a munkavállalónak szakképzett műszaki képzést nyújtott és viselte a költséget; a második, hogy a minimális munkavégzési időszak betartásáért észszerű ellentételezést nyújtott. Nem azt kell ellenőrizni, milyen nevet adtak a szerződésben, hanem hogy melyik alap ténylegesen fennáll.

A 15-1. cikk a két törvényi feltétel egyikét és emellett külön észszerűségi vizsgálatot követel. Ez nem jelenti azt, hogy mindig egyszerre kell szakképzett műszaki képzést és észszerű ellentételezést nyújtani, sem azt, hogy a megállapodás egésze automatikusan érvényes pusztán attól, hogy a kettő egyikét formálisan feljegyezték.

A törvényi feltétel megerősítése után a 2. bekezdés szerint külön vizsgálják, hogy a kikötött időszak és a felelősség köre észszerű-e. Az 1. bekezdés törvényi feltételét vagy a 2. bekezdés észszerűségi mércéjét sértő megállapodás a 3. bekezdés szerint semmis. Ez a szabály azonban az egyes megállapodások tartalmának és tényeinek vizsgálati mércéje, nem olyan szabály, amely minden minimális munkavégzési időszakra vonatkozó megállapodást eleve érvényesnek vagy semmisnek nyilvánítana.
...
## 2. Első törvényi feltétel: szakképzett műszaki képzés és a költség viselése

Hogy a megállapodást a képzésre alapítsák, a munkáltatónak ténylegesen szakképzett műszaki képzést kellett nyújtania az adott munkavállalónak, és viselnie kellett a költséget. Nem elég a képzési tervben szakképzett tanfolyamot írni, vagy a szerződésben becsült költséget feltüntetni. Irattal kell összekapcsolni a képzés témáját, a munkakörhöz szükséges szakmai-műszaki jelleget, a konkrét időtartamot, az elvégzést és a tényleges kiadást.

A vizsgálat tárgya nemcsak a közvetlenül ellenőrizhető költségek, például külső oktatói díj, képzőintézeti tandíj, tananyag- vagy eszközhasználati díj, hanem a munkáltató által állított belső költségek számítási alapja is. Ha belső személyzet képzett, látni kell, kinek milyen ideje került a képzésbe, miben különbözik ez a szokásos felügyelettől vagy a munkakör átadásától, és van-e alap e költségnek az adott munkavállalóhoz rendelésére. Becsült összeg vagy átalány-felosztás önmagában nem bizonyítja a tényleges viselést.

A tanmenet, a képzési ütemezés, a jelenléti ív, az értékelés eredménye, a tanúsítvány, a számlák és a nyugták a képzés valóságának és a költségnek az alapiratai. A munkáltató és a képzőintézet közötti szerződés, a kifizetési bizonylatok és a visszatérítési feltételek együtt pontosabban mutatják a tényleges terhet. Ha a munkavállaló a költség egy részét közvetlenül fizette, vagy 3. fél viselte, azt is meg kell különböztetni, ki viselte a végső költséget.

Az általános munkahelyi beilleszkedés és a szakképzett műszaki képzés határa nem oszlik meg pusztán a képzés helye vagy a szervező szerint. Belső tanfolyam is igazolhat konkrét szakmai-műszaki tartalmat és jelentős beruházást, külső intézet hosszú tanfolyama pedig valójában általános bevezető képzés lehet. Ezért nem szabad minden belső képzést egységesen kizárni, sem pusztán a magas összeg vagy a hosszú időtartam miatt elismerni a törvényi feltételt.
...
A második törvényi feltétel az, hogy a munkáltató észszerű ellentételezést nyújt a munkavállaló azon ígéretéért, hogy tartja a minimális munkavégzési időszakot. Itt az ellentételezésnek a szokásos bértől vagy a már járó munkavégzés ellenértékétől elkülönülő céllal és szerkezettel kell rendelkeznie. A jogi jelleg nem dől el pusztán attól, hogy a kifizetési részletezőn szerződéskötési díjnak, bentmaradási bónusznak vagy előzetes juttatásnak címkézték.
...
A tajvani Munkaügyi Minisztérium (勞動部) 2026-06-05-i iránymutatása (函釋) szerint, ha bentmaradási bónuszt, szerződéskötési díjat vagy más előzetes juttatást a minimális munkavégzési időszakra vonatkozó megállapodás észszerű ellentételezéseként vesznek, e szerepet egyértelműen közölni kell. Az, hogy a munkáltató utólag újraértelmezi a kifizetés célját, vagy a bér egy részét ellentételezésként újraosztályozza, nehezen helyettesíti a szerződéskori közlést.
...
## 4. Észszerű kör és négy vizsgálati tényező

Ha a törvényi feltételek egyike fennáll is, a kikötött időszaknak és a felelősségnek észszerű körben kell lennie. A 15-1. cikk 2. bekezdése nem ad a megnevezés vagy a foglalkozás szerinti rögzített választ, hanem úgy rendelkezik, hogy a konkrét szerződést és a beruházás–ellentételezés szerkezetét a következő négy tényezővel kell vizsgálni.

1. A szakképzett műszaki képzés időtartama és költsége
2. Azonos vagy hasonló munkakörű munkavállaló helyettesítési lehetősége
...
A negyedik tényezőbe beletartozhatnak az észszerűséget befolyásoló különféle körülmények, például a megállapodás megkötésének lefolyása, a munka jellege, a feleknek ismertetett tartalom, a ténylegesen ledolgozott időszak és a megszűnés oka. Az egyes tényezők jelentősége ügyenként változhat, és a figyelembe veendő körülmények nem korlátozódnak a fenti példákra. Ezért a dossziéban megjelenő releváns tényeket nem szabad kihagyni.

Végül érthető arányossági viszony szükséges a kikötött időszak, a munkáltató tényleges beruházása, a helyettesítés nehézsége, a munkavállaló által kapott ellentételezés és a visszatérítési teher között. Nem szabad előre rögzíteni az érvényességet pusztán egy meghatározott foglalkozás miatt, sem más ügy következtetését változatlanul alkalmazni. Együtt kell nézni a szerződéskötéskori tervezést és a megszűnéskori tényleges teljesítés fokát.

## 5. Olyan képzés, amely nem alapozhatja a megállapodást

A tajvani Munkaügyi Minisztérium 2026-06-05-i iránymutatása szerint a rendszeres képzés, az általános munkaköri képzés, az újonnan belépők munkahelyi beilleszkedési képzése és a törvény által elrendelt kötelező képzés költsége nem alapja a minimális munkavégzési időszakra vonatkozó megállapodásnak, sem kötbér vagy költség-visszatérítés iránti igénynek. Nemcsak a képzés megnevezését kell nézni, hanem a konkrét tanmenetet, a szakmai-műszaki tartalmat, az időtartamot, a munkáltató által ténylegesen viselt költséget és a bizonylatokat.
...
A képzés azonban nem mindig zárható ki pusztán azért, mert a vállalaton belül tartották. Ugyanazon programban keveredhet általános beilleszkedési és szakképzett műszaki rész, ezért a témát, az időt, a költséget és a törvényi kötelezettség meglétét tanfolyamonként kell megerősíteni. Aki a szakképzett műszaki részt állítja, irattal kell ismertetnie, milyen tartalom különbözik a szokásos képzéstől, és ki viselte ténylegesen a költséget.
...
Nem mindig a teljes összeget kell visszaadni. Ha a szerződéskötési díj, a bentmaradási bónusz vagy más előzetes juttatás a minimális munkavégzési időszakra vonatkozó megállapodás észszerű ellentételezéseként került kifizetésre, a célt egyértelműen közölni kell a munkavállalóval. A tajvani Munkaügyi Minisztérium 2026-06-05-i iránymutatása szerint az időszak lejárta előtti kilépéskor a visszatérítendő összeget a még nem teljesített időszakra arányosan kell számítani, és nem szabad a teljes összeg visszatérítését követelni. A tényleges következtetés a kifizetés célját, a megállapodás tartalmát, a már ledolgozott időszakot és a megszűnés okát együtt vizsgálja.

A közlés nem jelenhet meg először akkor, amikor a kifizetés után vita keletkezik. A munkavállalónak a szerződéskötéskor és a kifizetéskor tudnia kell, mely összeg a minimális munkavégzési időszakra vonatkozó ígéret ellentételezése, mennyi a kikötött időszak egésze, mikor rendelődik hozzá, és milyen képlet szerint számolnak el, ha a megszűnés közben következik be.
...
A képzési költség visszatérítését és az előzetes juttatás visszatérítését is meg kell különböztetni. Az előbbi a tényleges szakképzett műszaki képzésre és a költség viselésére összpontosít; az utóbbi a kifizetés céljára, a közlésre, a keletkezési feltételekre és a nem teljesített időszak arányára. Ha a két tételt együtt követelik, külön kell összevetni, nem számolták-e kétszer a költséget, és az egyes tételek bizonylatait.

## 7. Amikor a szerződés a munkavállalónak nem felróható okból szűnik meg

A tajvani munkaügyi törvény 15-1. cikk 4. bekezdése úgy rendelkezik, hogy ha a munkaszerződés a minimális munkavégzési időszak vége előtt a munkavállalónak nem felróható okból szűnik meg, a munkavállaló nem visel felelősséget a minimális munkavégzési időszakra vonatkozó megállapodás megsértéséért, sem a képzési költség visszatérítéséért. A megszűnés okát és a felelősség hovatartozását azonban konkrét bizonyítékok, például felmondási értesítés, kilépési nyilatkozat és a munkafeltételek megsértésére vonatkozó iratok alapján kell megítélni.

Ezért a munkavállaló megsértését nem lehet elismerni pusztán attól, hogy a munkaviszony a kikötött időszak előtt ért véget. Ellenőrizni kell, ki milyen akaratnyilatkozatot tett, mi a szerződés megszűnésének jogalapja, és a megszűnést előidéző tényleges körülmények melyik félnek róhatók fel.

A vizsgálati iratok közé tartozhat a felmondási értesítés, a kilépési levél, a közös megegyezéssel történő megszűnés irata, az elektronikus levél és az üzenetváltási nyilvántartás, a munkafeltételek változásának iratai, valamint a jelenléti és munkanyilvántartás. Még ha az egészséget vagy a munka körülményeit említik is, az eredményt nem e kifejezés alapján zárják le, hanem együtt nézik a tényleges lefolyást, a megszűnés törvényi alapját és a kapcsolódó bizonyítékokat.
...
Ha a folyamatos munkaviszony 3 hónapnál rövidebb, más típusú határozott idejű szerződésről van szó, vagy azonnali megszűnés törvényi okát állítják, az alkalmazandó rendelkezést és a tényeket egyedileg kell vizsgálni. Pusztán attól, hogy a szerződés hosszabb előzetes bejelentést ír, vagy azonnali munkakör-átadást követel, a jogi következtetés nem rögzíthető előre.

A gyakorlatban meg kell őrizni a kilépési nyilatkozat tartalmát és továbbításának napját, a napot, amikor a munkáltató ténylegesen átvette, valamint a feleknek az utolsó munkanapra vonatkozó közléseit. Ha négy kérdésre bontják, mikor hatályosul érvényesen a kilépés, érvényes-e a minimális munkavégzési időszakra vonatkozó megállapodás, a képzési költség vagy az előzetes juttatás visszatérítése, és a külön állított kár, csökken annak a hibája, hogy minden következtetést egyetlen szerződési záradékból vonjanak le.
...
1. Először a törvényi feltételt pontosítják: nyújtottak-e szakképzett műszaki képzést és viselték-e a költséget, vagy nyújtottak-e észszerű ellentételezést a bentmaradási ígéretért.
2. Az általános, a rendszeres és a törvényileg kötelező képzést a szakképzett műszaki képzéstől a tanfolyam tényleges tartalma, időtartama és célja szerint megkülönböztetik.
3. Megőrzik a tanmenetet, az ütemezést, az elvégzési nyilvántartást, a számlákat, a nyugtákat és a költségviselő iratait, és külön rögzítik a külső és a belső költségek alapját.
...
7. Külön vizsgálják a minimális munkavégzési időszakra vonatkozó megállapodás érvényességét, a kilépési nyilatkozatot és az előzetes bejelentést, a képzési költség és az előzetes juttatás visszatérítését, valamint a külön állított kárt.
...
- [Tajvan országos jogszabályi adatbázisa: a munkaügyi törvény 15-1. cikke](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=15-1&pcode=N0030001)
- [Tajvan országos jogszabályi adatbázisa: a munkaügyi törvény 15. cikke](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=15&pcode=N0030001)
- [Tajvan országos jogszabályi adatbázisa: a munkaügyi törvény 16. cikke](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=16&pcode=N0030001)
- [Tajvani Munkaügyi Minisztérium: 2026-06-05-i iránymutatás a minimális munkavégzési időszakról és a kötbér visszatérítéséről](https://laws.mol.gov.tw/FLAW/FLAWDOC03.aspx?cnt=926&datatype=etype&edate=99991231&lnabndn=1&now=1&recordno=10&sdate=20180000)
