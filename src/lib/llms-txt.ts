...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  bg: {
    ...
    discoveryNotice:
      'Файлът llms.txt е само карта за намиране на публичните страници; той не обещава място в търсенето, препоръка, препоръка от изкуствен интелект или показване.',
    confidentialNotice:
