...
export const simplifiedChineseGuidanceContent: GuidanceLocaleContent = {
  ...
  home: {
    ...
    columnsOriginalLanguageNote:
      '下列文章尚无简体中文版本。列表仍以原文语言显示，点开后进入相应语言的页面；内容不会被自动翻译。',
    imageBandAlt: '日光下的台湾传统三合院与现代亭阁',
    videoPauseLabel: '暂停视频',
    videoPlayLabel: '播放视频',
    videoReplayLabel: '重新播放视频',
  },
  pages: {
    home: {
      eyebrow: '说明',
      ...
      intro:
        'Hovering International Law Firm 协助境外委托人（包括与台湾有关的当事人）处理台湾法律事项：投资与公司设立、民事争议、婚姻家庭与继承、劳动、刑事与知识产权（智慧財產權）。本简体中文部分协助您判断哪些工作属于本所范围、需要准备什么、以及如何联系我们。此处为一般说明，不是针对您本人案件的法律意见。',
      sections: [
        {
          heading: '我们做什么',
          paragraphs: [
            'Hovering International Law Firm 是在台湾执业的律师事务所。本所依台湾法律工作，并在台北、高雄、台中与屏东设有办公室。我们为企业提供咨询、代理诉讼，并协助境外委托人完成在台湾所需的步骤。',
            '此处全部内容均为一般说明。个案结果取决于事实、适用规定与时间点。这些说明不能取代律师结合您本人文件所作的讨论。',
          ],
        },
        {
          heading: '页面语言与咨询语言',
          paragraphs: [
            '本页面以简体中文撰写。律师咨询以英语、中文、日语和韩语进行。咨询使用的中文，指普通话与书面中文。阅读本简体中文页面，并不表示咨询会以简体中文书面方式进行。',
      ...
      sections: [
        {
          heading: '在台湾的投资与公司设立',
          paragraphs: [
            '我们协助境外投资人与企业在台湾设立或运营公司：选择组织形式、准备并提交文件、缴纳出资、银行事项、营业场所审查以及行业特定要求。我们也协助因在台湾设立与运营而产生的会计与税务。',
            '流程与所需时间因组织形式、投资人、行业、银行与既有文件而异。公司设立本身并不会带来居留证（外僑居留證，ARC）或工作许可（工作許可）：那是另案程序，须依当事人情况另行判断。',
          ],
        },
        {
          heading: '民事与损害赔偿',
          paragraphs: [
            ...
            '期限（包括诉讼时效，台湾法称消灭时效／消滅時效）与证据是否齐备会影响进程。因此请尽早告知已知日期。请保存合同、往来信息、付款凭证或现场照片，并在第一次信息中提及。',
          ],
        },
        {
          heading: '婚姻、家庭与继承',
          paragraphs: [
            '我们处理离婚、财产分配、未成年子女权利义务之行使或负担（未成年子女權利義務之行使或負擔，即亲权）、会面交往（會面交往，即探望）与继承，即使当事人或财产位于不同国家。跨境家事案件往往需要额外审查户籍资料、文书形式及其在台湾的证明力。',
        ...
        },
        {
          heading: '劳动争议',
          paragraphs: [
            '本组包括劳动关系终止、依台湾法律的资遣费（資遣費；不可与其他法域的经济补偿或离职金制度等同）、工资以及劳动合同（勞動契約）争议，劳资双方都可能成为当事人。审查时，我们把终止原因与预告、给付及期限问题分开看待。',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '刑事案件往往期限短、阶段固定。若您已收到检察署（檢察署）、警方或法院的文书，请尽早告知文书上的日期，以便按正确顺序审阅内容。',
          ],
        },
        {
          heading: '知识产权',
          paragraphs: [
            '我们协助在台湾办理商标与专利的申请、登记、著作权以及这些权利的争议。',
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            '我们在台北、高雄、台中与屏东设有办公室。高雄办公室侧重公司治理，并处理民事、刑事与行政争议。台中办公室处理营建、知识产权以及与韩国、日本有关的事项。屏东办公室于2017年开设，以应对当地需求。',
    ...
    pricing: {
      ...
      sections: [
        ...
        },
        {
          heading: '咨询可以是有偿服务',
          paragraphs: [
            '与律师的咨询可以是有偿服务。本页没有把第一次谈话说成免费，任何表述都不应作此理解。',
        ...
        },
        {
          heading: '本页为何不列出费率',
          paragraphs: [
            '费用取决于案件本身：工作量、当事人人数、文件、期限，以及程序是否已经进行。预先给出的数字，反映不了您这一事项的费用。因此我们先确定工作范围，再在开始工作前告知费用。',
            '除律师酬金外，还可能产生法院、行政机关或第三方费用。这些与酬金分开，并视相应程序而定。',
          ],
        },
      ],
    },
    contact: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            '在联系表单中，您可以选择“沟通方式待确认”。我们会回复，评估是否有可行的沟通安排；不以其他语言提供服务，也不承诺回复时限。',
            '这只是评估步骤，不是承诺。我们不承诺口译、不以四种语言之外的语言提供服务，也不承诺受理每一件事项。',
          ],
        },
        {
          heading: '首次来信应写什么',
          paragraphs: [
            ...
            '初期不必发送护照号码、身份证号、银行账户信息、病历或全部证据。请等待律师指示，再以安全方式发送敏感文件。',
          ],
        },
        {
          heading: '本页不承诺的事项',
          paragraphs: [
            '我们不承诺回复时限，不通过本页确认预约，不指定特定律师，也不提供口译。书面翻译是另外的安排：您写下的原文不会被自动翻译。',
      ...
      faqs: [
        {
          question: '事务所处理哪些事项？',
          answer:
            '我们处理六组：在台湾的投资与公司设立、民事与损害赔偿、婚姻家庭与继承、劳动争议、刑事与知识产权。是否受理，须在审阅内容后决定。',
        },
        {
          question: '联系前应准备什么？',
          answer:
        ...
        },
        {
          question: '可以用中文咨询吗？',
          answer:
            '可以。律师咨询以英语、中文、日语和韩语进行。咨询使用的中文，指普通话与书面中文。阅读本简体中文页面，并不表示咨询会以简体中文书面方式进行。本页不承诺口译。书面翻译是另外的安排：您写下的原文会按原样保存，不会被自动翻译。',
        },
        {
          question: '若我无法使用这四种语言怎么办？',
          answer:
            '发送请求时请选择“沟通方式待确认”。我们会回复，评估可行的沟通安排，但不以其他语言提供服务。这是评估步骤，不是能够以其他语言工作的承诺。',
        },
        {
          question: '我写下的原文如何处理？',
          answer:
        ...
        },
        {
          question: '费用如何计算？',
          answer:
            '首先确定工作范围，然后在开始工作前与您确认费用金额与计算方式。本页不列出数字，也没有把第一次谈话说成免费。',
        },
        {
          question: '若我的事项非常紧急怎么办？',
          answer:
            '请在摘要开头写明期限或公文上的日期，以便审阅时看见这些日期。本页不设紧急联系方式，也不承诺回复时限；若事项不能等待，您应同时在所在地寻找其他途径。',
        },
      ],
    },
    privacy: {
      ...
      title: '通过联系表单收集的个人信息',
      description:
        '本简体中文部分的联系表单收集哪些个人信息、原文如何处理，以及您如何就这些信息联系我们。',
      intro:
        '本部分仅涉及这些说明页面上的联系表单。它描述个人信息的处理方式，而不是技术上的绝对安全。',
      sections: [
        {
          heading: '收集哪些个人信息',
          paragraphs: [
            '当您通过本部分的表单发送请求时，会记录下列个人信息：',
          ],
          items: [
            '您填写的姓名',
            '用于回复的电子邮件地址',
        ...
        },
        {
          heading: '存放地点与访问',
          paragraphs: [
            '您发送的内容存放在不对外公开的存储空间。仅事务所内获授权的人员可为处理该请求而访问。',
        ...
        },
        {
          heading: '使用目的',
          paragraphs: [
            '所发送的信息用于审阅请求、回复您、厘清沟通方式，以及开始工作后的案件处理。',
            '未经另行同意，这些信息不会用于营销。',
          ],
        },
        {
          heading: '通知与收件编号',
          paragraphs: [
            '请求成功发送后，系统会通知事务所。若事务所尚未确认已收到该通知，您的文本仍会保存，不会丢失。',
        ...
        },
        {
          heading: '您的权利与联系途径',
          paragraphs: [
            '您可以通过联系页所列电子邮件地址，要求查阅、更正或删除您的个人信息，或撤回同意。若存在法定或程序上的保存义务，我们会说明限制。',
        ...
        },
        {
          heading: '存放地点与服务提供者',
          paragraphs: [
            '本网站托管于 Vercel，您发送的内容存放在该服务不对外公开的存储空间中。电子邮件通过事务所使用的电子邮件服务发送。',
            '个别服务提供者的服务器可能位于台湾以外，您的个人信息可能在那里存放与处理。存放目的达成后，相关信息会立即删除；依法须保存的则在该期间内保留。个人信息相关询问请寄至 wei@hoveringlaw.com.tw。',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '因此请不要仅凭一篇文章就采取行动。文章只可作概览，具体问题仍须就您的文件与律师讨论；本页不能代替咨询。',
          ],
        },
      ],
    },
...
export const hindiGuidanceContent: GuidanceLocaleContent = {
  ...
  pages: {
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'यहाँ की सारी सामग्री सामान्य है। किसी मामले का परिणाम तथ्यों, लागू नियमों और समय पर निर्भर करता है। यह जानकारी आपके कागजात दिखाकर अधिवक्ता से सलाह लेने का स्थान नहीं लेती।',
          ],
        },
        {
    ...
    services: {
      ...
      intro:
        'नीचे वे समूह हैं जिन पर हम वास्तव में काम करते हैं, और वे प्रश्न जो आरंभिक चरण में प्रायः पूछे जाते हैं। यह विवरण आपको यह आँकने में सहायता करता है कि आपका मामला हमारे दायरे में आता है या नहीं; यह सामान्य है और किसी एक फ़ाइल का कानूनी विश्लेषण नहीं है।',
      sections: [
        {
          heading: 'ताइवान में निवेश और कंपनी स्थापना',
          paragraphs: [
            'हम विदेशी निवेशकों और उद्यमों को ताइवान में कंपनी स्थापित करने या चलाने में साथ देते हैं: कानूनी रूप का चयन, कागजात तैयार करना और जमा करना, पूँजी लगाना, बैंक संबंधी प्रश्न, कारोबार-स्थल की जाँच तथा उद्योग-विशेष की अपेक्षाएँ। हम ताइवान में स्थापना और संचालन से उत्पन्न लेखांकन और कर में भी सहायता करते हैं।',
            'प्रक्रिया और समय, कानूनी रूप, निवेशक, उद्योग, बैंक और उपलब्ध कागजात के अनुसार भिन्न होते हैं। कंपनी स्थापना अपने आप निवास अनुमति (居留) या कार्य अनुमति (工作許可) नहीं देती: ये अलग प्रक्रियाएँ हैं, जिन्हें व्यक्ति की स्थिति के अनुसार देखा जाता है।',
          ],
        },
        {
          heading: 'दीवानी विवाद और क्षतिपूर्ति',
          paragraphs: [
            'इस समूह में संविदा विवाद, अपकृत्य से क्षतिपूर्ति और उपभोक्ता विवाद आते हैं। कार्य सामान्यतः कालक्रम, विद्यमान कागजात और प्रमाण की जाँच से आरंभ होता है और उसके बाद ही अगले चरण आते हैं।',
        ...
        },
        {
          ...
          paragraphs: [
            'इस समूह में सेवा समाप्ति, ताइवान के कानून के अनुसार वैधानिक विच्छेद वेतन (資遣費; अन्य देशों की छंटनी-मुआवज़ा या बर्खास्तगी-संरक्षण व्यवस्था के समान नहीं मानी जाती), वेतन और श्रम संविदा (勞動契約) से विवाद आते हैं, कर्मचारी और नियोक्ता दोनों पक्षों पर। जाँच में हम समाप्ति के कारण को सूचना, भुगतान और समयसीमा के प्रश्नों से अलग रखते हैं।',
        ...
        },
        {
          ...
          paragraphs: [
            'हम अन्वेषण और न्यायालय में साथ देते हैं, अन्वेषण में संदिग्ध और न्यायालय में अभियुक्त के लिए, तथा पीड़ित के लिए भी, और उद्यम गतिविधि के आपराधिक जोखिमों का आकलन करते हैं।',
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'अधिवक्ता कार्य के अतिरिक्त 2020 से Hovering Accounting Office भी है, जो उद्यमियों और संपन्न व्यक्तियों के लिए लेखांकन और कर योजना देता है।',
          ],
        },
        {
          heading: 'विदेशी पक्षों के साथ कार्य',
          paragraphs: [
            'सीमा-पार कार्य में कंपनी स्थापना, वीज़ा, व्यापार चिह्न और पेटेंट आवेदन, कानूनी जोखिम जाँच और उद्यमों की कर सलाह शामिल है। ताइचुंग कार्यालय विशेष रूप से निर्माण, बौद्धिक संपदा तथा कोरिया और जापान से जुड़े मामलों का कार्य करता है। अधिवक्ता Wei Tseng (曾雋崴) उपर्युक्त समूहों में कोरिया, जापान और अन्य देशों के मुवक्किलों का साथ देती हैं।',
        ...
        },
        {
          ...
          paragraphs: [
            'आपका सार आने के बाद कोई अधिवक्ता सामग्री जाँचता है और फिर संभावित कार्य-दायरे, अभी आवश्यक कागजात और अगले चरणों पर बात करता है। कर या लेखांकन प्रश्नों में कार्यालय लेखांकन विभाग के साथ एक ही प्रक्रिया में कार्य कर सकता है।',
      ...
      sections: [
        {
          ...
          paragraphs: [
            'एक ही प्रकार के मामलों में काम की मात्रा बहुत भिन्न हो सकती है, पक्षों की संख्या, उपलब्ध कागजात, पालन की जाने वाली समयसीमाओं और इस पर निर्भर कि प्रक्रिया पहले ही आरंभ हो चुकी है या नहीं। इसलिए पहला चरण सदा यह तय करना है कि कार्य में क्या आता है और क्या नहीं।',
            'आरंभ में आपका भेजा हुआ सार इसी दायरे का आधार है। जितना स्पष्ट वह क्रम, आपकी माँग और समयसीमाएँ बताए, उतना ही सटीक दायरा निर्धारित हो सकता है।',
          ],
        },
        {
          ...
          paragraphs: [
            ...
            'यह पृष्ठ शुल्क का उद्धरण नहीं है और भुगतान का दायित्व नहीं बनाता।',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'लागत मामले पर ही निर्भर करती है: काम की मात्रा, पक्षों की संख्या, कागजात, समयसीमाएँ और इस पर कि प्रक्रिया पहले से चल रही है या नहीं। पहले से तय संख्या आपके मामले की लागत नहीं दिखाएगी। इसलिए हम पहले कार्य-दायरा तय करते हैं और फिर कार्य आरंभ होने से पहले आपको लागत बताते हैं।',
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            'समयसीमा या आधिकारिक पत्र की तिथि अपने सार के आरंभ में बताएँ, ताकि जाँच में ये तिथियाँ दिखें। इस पृष्ठ पर आपात मार्ग नहीं है और उत्तर की समयसीमा नहीं कही जाती; यदि आपका मामला प्रतीक्षा नहीं कर सकता, तो आपको अपने देश में अन्य सहायता भी साथ-साथ देखनी चाहिए।',
        },
      ],
    },
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'यह पृष्ठ पूर्ण सुरक्षा का वादा नहीं करता। कोई भी संचरण मार्ग और कोई भी भंडारण स्थान पूरी तरह सुरक्षित नहीं; अतः संवेदनशील कागजात अधिवक्ता के विशेष संकेत के बाद ही भेजने चाहिए।',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'प्राप्ति संख्या हमारे अभिलेखों में आपका अनुरोध खोजने के लिए है। भंडारण के बाद यह दिखाई जाती है; नए संपर्क में आप इसे बता सकते हैं।',
          ],
        },
        {
          heading: 'आपके अधिकार और संपर्क मार्ग',
          paragraphs: [
            'आप संपर्क पृष्ठ पर बताए गए ई-मेल पते से अपने व्यक्तिगत डेटा की जानकारी, सुधार या विलोपन माँग सकते हैं या सहमति वापस ले सकते हैं। यदि कानूनी या प्रक्रियात्मक प्रतिधारण कर्तव्य हो, तो हम सीमा समझाते हैं।',
            'यह पृष्ठ निश्चित प्रतिधारण अवधि नहीं बताता, क्योंकि वास्तविक अवधि इस पर निर्भर करती है कि मामला आगे बढ़ता है या नहीं, और उससे जुड़े कर्तव्यों पर। यदि आप पहले विलोपन चाहते हैं, तो संपर्क में बताएँ।',
          ],
        },
        {
          heading: 'भंडारण स्थान और सेवा प्रदाता',
          paragraphs: [
            ...
            'कुछ सेवा प्रदाताओं के सर्वर ताइवान के बाहर हो सकते हैं, जिससे आपका डेटा वहाँ रखा और संसाधित हो सकता है। जब भंडारण का उद्देश्य पूरा हो जाता है, तो डेटा विलंब किए बिना मिटा दिया जाता है; लागू नियमों के अनुसार जो रखना आवश्यक हो, वह उस अवधि तक रहता है। व्यक्तिगत डेटा से जुड़े अनुरोध wei@hoveringlaw.com.tw पर लिए जाते हैं।',
          ],
        },
      ],
    },
    disclaimer: {
      ...
      description:
        'जानकारी का सामान्य स्वरूप, लागू होने का दायरा और अधिवक्ता-मुवक्किल संबंध की शर्तें।',
      intro:
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'किसी मामले का परिणाम तथ्यों, लागू नियमों और समय पर निर्भर करता है; दो एक जैसी दिखने वाली स्थितियों का अंत अलग-अलग हो सकता है।',
          ],
        },
        {
          heading: 'लागू होने का दायरा',
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'बाहरी कड़ियाँ दिशा के लिए हैं; हम तीसरे पक्ष की सामग्री के सही या अद्यतन होने की बात नहीं कहते।',
          ],
        },
      ],
    },
