...
const CLIENT_COUNTRY_TERMS: Record<GuidanceLocale, Record<string, string[]>> = {
  ...
  de: { Korea: ['Korea'], Japan: ['Japan'] },
  es: { Korea: ['Corea'], Japan: ['Japón'] },
  fr: { Korea: ['Corée'], Japan: ['Japon'] },
  pt: { Korea: ['Coreia'], Japan: ['Japão'] },
  'zh-hans': { Korea: ['韩国'], Japan: ['日本'] },
  ...
  hi: { Korea: ['कोरिया'], Japan: ['जापान'] },
  sv: { Korea: ['Korea'], Japan: ['Japan'] },
  ...
  km: { Korea: ['កូរ៉េ'], Japan: ['ជប៉ុន'] },
  mn: { Korea: ['Солонгос'], Japan: ['Япон'] },
  sk: { Korea: ['Kórey'], Japan: ['Japonska'] },
  bg: { Korea: ['Корея'], Japan: ['Япония'] },
  hr: { Korea: ['Koreje', 'Korejom'], Japan: ['Japana', 'Japanom'] },
  sr: { Korea: ['Korej'], Japan: ['Japan'] },
  sl: { Korea: ['Korej'], Japan: ['Japonsk'] },
  lt: { Korea: ['Korėj'], Japan: ['Japon'] },
