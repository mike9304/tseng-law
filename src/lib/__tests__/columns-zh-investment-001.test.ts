...
describe('Traditional Chinese investment column 001 — company-establishment basics', () => {
  ...
  it('keeps the approved native-Taiwanese legal phrasing from final review', () => {
    const approvedPhrases = [
      ...
      '商品進口、醫療器材、酒類、旅行業、建築相關業務或其他專業服務，可能另有許可、登錄、專任人員或產品審查要求。',
      '簽訂租約前，應依預定地址及實際營業內容，確認土地使用分區、建築管理、租賃條件及稅籍登記等事項是否符合需求與相關規定，並確認出租人是否同意將該址作為公司及稅籍登記地址，以及能否提供必要的房屋文件。',
      ...
      '投資審查著重資金投入與投資架構，公司登記確認組織是否依法成立，工作許可審查外國人能否從事特定工作，居留程序則審查其在台灣居留的法律依據；這些程序不應混為一談。',
      ...
      '此外，特定交易仍可能適用零稅率、免稅或其他特別規定。',
      '依自2024年起適用的台韓所得稅協定，符合條件的股利、利息及權利金，來源地課稅上限均為10%；但不會僅因交易雙方分屬台灣與韓國，即當然適用限制稅率。',
  ...
  it('derives read_time from the exact visible Han-character count at 400 per minute', () => {
    ...
    expect(visibleHanCount).toBe(5_034);
