...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-beautyabout-val-1-title', { x: 24, y: 20, width: 302, height: 36 }, '고객 맞춤 케어', 3, '#2b1c18', 'left', 'tpl-beautyabout-val-1'),
  createTextNode({
  ...
  heading('tpl-beautyabout-val-2-title', { x: 24, y: 20, width: 302, height: 36 }, '지속적인 교육', 3, '#2b1c18', 'left', 'tpl-beautyabout-val-2'),
  createTextNode({
  ...
  heading('tpl-beautyabout-val-3-title', { x: 24, y: 20, width: 302, height: 36 }, '프리미엄 제품', 3, '#2b1c18', 'left', 'tpl-beautyabout-val-3'),
  createTextNode({
  ...
  ...buildCategoryProofSections('beauty', 'beauty-about', STAGE_H),
]);
