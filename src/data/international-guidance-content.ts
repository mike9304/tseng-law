  ...
  ar: {
    ...
    pages: {
      home: {
        ...
        intro:
          'يساعد Hovering International Law Firm الموكّلين الأجانب، بمن فيهم المقيمون في تايوان، في القضايا الخاضعة للقانون التايواني: الاستثمار وتأسيس الشركات، والمنازعات المدنية، وشؤون الزواج والأسرة، والعمل، والقضايا الجزائية، والملكية الفكرية. ويساعدك هذا القسم العربي على معرفة الأعمال التي تدخل في نطاق المساعدة، وما يلزم تحضيره، وكيفية التواصل. وهذه معلومات عامة، وليست رأيًا قانونيًا في قضيتك الخاصة.',
        sections: [
          {
      ...
      columns: {
        ...
        description:
          'مقالات بالعربية تشرح موضوعات شائعة في القانون التايواني. وهي معلومات عامة وقت النشر، وليست رأيًا قانونيًا في قضيتك.',
        intro:
          'ينشر المكتب مقالات تشرح موضوعات شائعة في القانون التايواني. والمقالات المتاحة بالعربية مدرجة في هذه الصفحة مباشرة؛ وإلى جانبها أربعة روابط، يفتح كل رابط منها فهرس المقالات بإحدى اللغات الأصلية.',
        sections: [
          {
            ...
            paragraphs: [
              ...
              'وهذه الفهارس الأربعة فهارس باللغة الأصلية، لا قوائم ترجمات. أما المقالات المتاحة بالعربية فمدرجة على حدة في هذه الصفحة.',
            ],
          },
          {
