...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('restaurant', 'restaurant-about-dir', STAGE_H),
  ...buildCategoryProofSections('restaurant', 'restaurant-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
