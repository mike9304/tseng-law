...
describe('applyTranslationToLocaleDraft compact colon rich text mark boundaries', () => {
  ...
  it('keeps compact colon separators outside adjacent link and underline marks', async () => {
    ...
    if (node?.kind !== 'text') throw new Error('translated compact colon text node was not written');
