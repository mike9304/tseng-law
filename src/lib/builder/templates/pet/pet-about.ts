...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Clinic story ───────────────────────────────────────── */
  heading('tpl-petabt-story-title', { x: 80, y: STORY_Y, width: 400, height: 50 }, '병원 이야기', 2, '#2b2018', 'left'),
  createTextNode({
  ...
  heading('tpl-petabt-fac-title', { x: 80, y: 40, width: 400, height: 50 }, '시설 안내', 2, '#2b2018', 'left', 'tpl-petabt-facility'),
  createImageNode({
  ...
  /* ── Mission ────────────────────────────────────────────── */
  heading('tpl-petabt-mission-title', { x: 80, y: MISSION_Y, width: 400, height: 50 }, '우리의 사명', 2, '#2b2018', 'left'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('pet', 'pet-about-dir', STAGE_H),
  ...buildCategoryProofSections('pet', 'pet-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
