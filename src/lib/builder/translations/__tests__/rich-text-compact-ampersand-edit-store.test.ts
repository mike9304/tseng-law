...
describe('applyTranslationToLocaleDraft compact ampersand rich text mark boundaries', () => {
  ...
  it('keeps compact ampersand separators outside adjacent link and underline marks', async () => {
    ...
    if (node?.kind !== 'text') throw new Error('translated compact ampersand text node was not written');
