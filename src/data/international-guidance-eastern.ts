...
export const greekGuidanceContent: GuidanceLocaleContent = {
  ...
  pages: {
    ...
    services: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Εκπροσωπούμε υπόπτους, κατηγορουμένους και παθόντες στην προκαταρκτική εξέταση και ενώπιον του δικαστηρίου, και αξιολογούμε τους ποινικούς κινδύνους της επιχειρηματικής δραστηριότητας.',
    ...
    privacy: {
      ...
      description:
        'Τι συλλέγει η φόρμα επικοινωνίας σε αυτές τις ελληνικές σελίδες, πώς αντιμετωπίζεται το πρωτότυπο κείμενο και πώς να μας προσεγγίσετε για τα δεδομένα σας.',
      intro:
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Η γλώσσα συμβουλευτικής που επιθυμείτε',
    ...
    columns: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Τα άρθρα είναι γενικές πληροφορίες κατά το χρόνο της δημοσίευσης. Οι κανόνες και η εφαρμογή τους μπορεί να μεταβληθούν, και ένα άρθρο δεν περιέχει όλες τις περιστάσεις της υπόθεσής σας.',
