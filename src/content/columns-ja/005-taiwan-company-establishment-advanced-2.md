...
可能です。ただし、台湾で取得した新台湾ドルの資金源を証明する書類を提出する必要があります。
...
A. 1人目の従業員：一般僑外投資事業主管業務（一般僑外投資事業主管工作）。下記Bの「専門性または技術性を要する業務」の基準は適用されませんが、僑外出資が3分の1を超える会社の経理人等の対象要件と、雇用主の資本金・売上高等の実績要件（審査基準第38条・第39条）は適用されます。
