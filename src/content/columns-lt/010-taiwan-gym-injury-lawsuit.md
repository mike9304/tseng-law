...
# Žalos atlyginimas dėl sužalojimo sporto salėje Taivane: 1-osios instancijos byla, terminai, įrodymai ir žalos rūšys
...
![PTT įrašas: korėjiečių studentas, tarpslankstelinio disko plyšimas 90 kg mirties traukos metu… 1-oji instancija nurodė sporto salei sumokėti 1.570.000 TWD](../images/010-taiwan-gym-injury-lawsuit/img-06.jpg)
...
![Sprendimo apžvalga: ūmaus tarpslankstelinio disko plyšimo byla po to, kai pradedantysis sporto salėje gavo nurodymą atlikti 90 kg mirties trauką](../images/010-taiwan-gym-injury-lawsuit/img-09.jpg)

[Sprendimo apžvalga: ūmaus tarpslankstelinio disko plyšimo byla po to, kai pradedantysis sporto salėje gavo nurodymą atlikti 90 kg mirties trauką](https://www.instagram.com/p/Crp4vJag7v3/)
...
Jei tenkinami įstatyminiai kūno sužalojimo dėl neatsargumo (過失傷害) požymiai, galima įvertinti baudžiamąjį skundą (告訴). Taip pat galima įvertinti civilinį reikalavimą atlyginti žalą, tačiau kuris pagrindas taikomas — sutartinė atsakomybė, deliktas (侵權行為) ar atsakomybė pagal vartotojų apsaugą — ir atsakomybės apimtis skiriasi pagal konkrečias faktines aplinkybes. Tai, kad dėl vieno įvykio galima įvertinti kelias procedūras, nereiškia, kad visos jos privalomos, ir nereiškia, kad kurios nors iš jų sėkmė iš anksto užtikrinta.
...
Teisė reikalauti atlyginti deliktu padarytą žalą pagal [Taivano Civilinio kodekso (民法) 197 straipsnį](https://law.moj.gov.tw/LawClass/LawSingle.aspx?flno=197&pcode=B0000001) iš esmės išnyksta, jei per 2 metus nuo momento, kai nukentėjusysis sužinojo ir apie žalą, ir apie asmenį, privalantį ją atlyginti, ji neįgyvendinama, ir išnyksta taip pat tada, kai nuo delikto praėjo 10 metų.
...
Kad būtų galima paaiškinti atsakomybę, priežastinį ryšį ir žalą, tikslinga kartu surinkti ne tik įvykio metu darytus vaizdo įrašus (監視器影像), bet ir medicinos dokumentaciją (病歷) bei gydytojo pažymą (診斷證明書), gydymo išlaidų (醫療費用), kelionės gydytis išlaidų (就醫交通費) ir slaugos (看護費用) kvitus, su sporto sale ir treneriu susirašinėjimą, liudytojų parodymus, užsiėmimų rezervaciją ir lankomumo įrašus, pratimų planą ir treniruočių žurnalą. Tikslinga nufotografuoti sužeistą kūno vietą ir, kiek įmanoma, įvykio vietos būklę ir chronologiškai sutvarkyti eigą prieš įvykį ir po jo bei susirašinėjimo turinį, kad vėliau dokumentus būtų lengviau palyginti.
...
3. **Kelionės išlaidos**: Išlaidos, būtinos vykti į gydymo įstaigą gydymo tikslu, įrodomos kelionės dokumentais, kvitais ir panašiais dokumentais.
...
Taip. Tai, kad draudimas yra, gali būti svarbu kaip galimas lėšų žalai atlyginti šaltinis, bet savaime nepripažįsta sporto salės ar trenerio teisinės atsakomybės ir nenustato mokėtinos sumos. Tarp draudiko (保險人) ir šalių gali kilti ginčų dėl draudimo limito ir išimčių sąlygų, priežastinio ryšio tarp įvykio ir sužalojimo bei kiekvienos žalos rūšies būtinybės ir dydžio.
...
Kritimas komercinėse patalpose, žala sveikatai dėl maisto ir sužalojimas naudojantis profesine paslauga taip pat gali kelti saugumo pareigos, priežastinio ryšio, žalos ir įrodymų klausimus. Tačiau sporto salės bylos išvados negalima be pakeitimų taikyti kitam įvykiui, todėl kiekvieno atvejo sutartį, elgesį ir atitinkamas normas reikia vertinti atskirai.
