...
const section1Paragraphs = [
  ...
  '韓国関連の事実関係に限る。台湾・韓国所得税協定は2023年12月27日に発効し、2024年1月1日から適用されています。協定の適用要件を満たす場合、配当・利子・使用料に関する源泉地国の上限税率はそれぞれ10％です。事業利得は、相手方の地域に協定上の恒久的施設（PE）がある場合等を除き、原則として居住地側で課税されますが、事業の実際の遂行形態をまず確認する必要があります。',
...
const section4Paragraphs = [
  ...
  '会社設立自体について一律の法定最低資本金があるわけではありません。ただし、業種別の最低資本額、事業計画の合理性、銀行審査および就業許可上の雇用主要件は別途確認が必要です。外国人投資事業の外国籍経営責任者に関する就業許可は、華僑または外国人が保有する当該事業の株式または出資額の合計が、発行済株式総数または資本総額の3分の1を超える会社の経営責任者（經理人）、外国会社の台湾支店の経営責任者、代表者事務所の代表者等を対象とします。このうち、会社または支店の雇用主が設立1年未満の場合は、払込資本金または台湾における運転資金50万新台湾ドル（NT$）以上、売上高NT$300万以上、輸出入実績50万米ドル以上、または代理手数料20万米ドル以上のいずれかが原則です。設立1年以上の場合は、台湾における直近1年または直近3年平均について、売上高NT$300万以上、輸出入実績50万米ドル以上、または代理手数料20万米ドル以上のいずれかが原則です。代表者事務所は、設立1年以上であれば台湾における業務実績が必要です（設立1年未満は免除）。台湾経済の発展に実質的に貢献する場合や、事情が特殊な場合には、特別認定の余地もあります。',
...
const section5Paragraphs = [
  '台湾の営業税は、一般税率が5％で、通常は2か月ごとに申告します。営利事業所得税の一般税率は20％ですが、実際の課税は課税所得と適用規定により異なります。非居住者に支払う配当の台湾国内法上の源泉徴収率は21％です。韓国関連の事実関係に限る。台湾・韓国所得税協定の適用要件と手続を満たす配当については、上限税率10％が適用されます。具体的な申告・源泉徴収は、居住者区分、受益所有者、所得の種類および協定適用書類を確認して処理する必要があります。',
  ...
  '韓国関連の事実関係に限る。台湾・韓国所得税協定は2023年12月27日に発効し、2024年1月1日から適用されており、要件を満たす利子と使用料についても源泉地国の上限税率10％が適用されます。事業利得の課税権を検討する際には、前述した恒久的施設の四つの類型をすべて確認する必要があります。役務提供日数だけでなく、固定的施設、工事期間、代理人の契約締結権限および実際の活動も併せて確認しなければなりません。',
...
describe('Japanese investment column 001 — company-setup basics', () => {
  it('publishes the contracted frontmatter and exactly three safe FAQs', () => {
    ...
    expect(visibleJapaneseCount).toBe(5_877);
