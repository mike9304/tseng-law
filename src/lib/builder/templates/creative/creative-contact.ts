...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  heading('tpl-creativecontact-title', { x: MARGIN, y: 50, width: 500, height: 56 }, '프로젝트 문의', 1, '#0f0f12'),
  createTextNode({
  ...
  heading('tpl-creativecontact-form-title', { x: 32, y: 24, width: 400, height: 40 }, '프로젝트 의뢰', 2, '#0f0f12', 'left', 'tpl-creativecontact-form'),
  createTextNode({
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#e0457a', borderRadius: 6 },
  }),
  ...
  heading('tpl-creativecontact-social-title', { x: MARGIN, y: 40, width: 300, height: 40 }, 'SNS', 2, '#0f0f12', 'left', 'tpl-creativecontact-social'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('creative', 'creative-contact-dir', STAGE_H),
  ...buildCategoryProofSections('creative', 'creative-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
