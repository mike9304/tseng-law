...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  ...
  fr: {
    ...
    discoveryNotice:
      'Le fichier llms.txt n’est qu’une carte pour trouver les pages publiques ; il ne promet ni classement dans les moteurs de recherche, ni approbation, ni recommandation par une intelligence artificielle, ni visibilité promise.',
    confidentialNotice:
  ...
  'zh-hans': {
    consultationNotice:
      '律师咨询以英语、中文、日语和韩语进行。咨询使用的中文，指普通话与书面中文。阅读本简体中文页面，并不表示某次咨询会以简体中文这一书面形式进行。',
    discoveryNotice:
