---
title: "Bolagsbildning i Taiwan – fördjupning del 3: sökning av driftställe"
...
# Bolagsbildning i Taiwan – fördjupning del 3: sökning av driftställe

![Huvudbild](../images/015-taiwan-company-setup-pitch-location/featured-01.jpg)

(Kraven från Taiwans olika lokala förvaltningar skiljer sig; följande text är ett exempel på öppning av restaurangverksamhet i staden Taipei.)

![](../images/015-taiwan-company-setup-pitch-location/img-01.jpg)

När ni inleder restaurangverksamhet är det första problemet att hitta driftställets adress (營業地址).

Utöver marknadsläget

är en annan viktig punkt

om adressen ligger i ett område där drift av «restaurangverksamhet» är möjlig.

​

Om ni inleder verksamheten i staden Taipei

kan ni använda systemet för «förhandsfråga om driftställe» (營業場所預先查詢) vid handelskontoret i staden Taipei (臺北市商業處).

<https://www.businesslocationinfo.gov.taipei/BLBQS/Home/Notice>

​

Ni kan utan avgift kontrollera om «restaurangverksamhet» kan öppnas på den önskade adressen.

För kontrollen måste ni dock ladda upp «utdrag ur byggnadsregistrering av typ 2» (建物登記第二類謄本, som innehåller detaljerade uppgifter om byggnaden) för driftställets adress.

Vem som helst kan hos lantmäterikontoret (地政事務所) begära «utdrag ur byggnadsregistrering av typ 2» för en valfri adress.

Om ni har svårt att personligen besöka lantmäterikontoret (地政事務所)

kan ni be en bekant i Taiwan, hyresvärden, en fastighetsmäklare eller en advokat om hjälp.
...
Uppmärksamma därför denna punkt.

​

**Q. Måste alla branscher via systemet för «förhandsfråga om driftställe» kontrollera om driften är möjlig?**

Det rekommenderas att alla branscher via systemet för «förhandsfråga om driftställe» (營業場所預先查詢) bekräftar om driften är möjlig.
...
Om man öppnar på en plats där restaurangverksamhet inte är möjlig kan senare en administrativ böter (罰鍰) från den behöriga myndigheten följa.
...
Detta är huvudsaken; vid ytterligare frågor kan ni vända er till en taiwanesisk advokat.

Förvaltningsmyndigheternas regler kan ändras ofta; före registrering av den juridiska personen bör ni bekräfta den senaste regleringen.
