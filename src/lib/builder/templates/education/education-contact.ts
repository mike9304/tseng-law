...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  heading('tpl-educontact-title', { x: MARGIN, y: 50, width: 500, height: 56 }, '입학 문의', 1, '#2a2418'),
  createTextNode({
  ...
  heading('tpl-educontact-form-title', { x: 32, y: 24, width: 400, height: 40 }, '입학 상담 신청', 2, '#2a2418', 'left', 'tpl-educontact-form'),
  createTextNode({
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#c08a3a', borderRadius: 6 },
  }),
  ...
  heading('tpl-educontact-hours-title', { x: MARGIN, y: 40, width: 300, height: 44 }, '사무실 운영시간', 2, '#2a2418', 'left', 'tpl-educontact-hours'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('education', 'education-contact-dir', STAGE_H),
  ...buildCategoryProofSections('education', 'education-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
