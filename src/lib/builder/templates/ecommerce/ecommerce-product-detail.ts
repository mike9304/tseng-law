...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('ecommerce', 'ecommerce-product-detail-dir', STAGE_H),
  ...buildCategoryProofSections('ecommerce', 'ecommerce-product-detail', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
