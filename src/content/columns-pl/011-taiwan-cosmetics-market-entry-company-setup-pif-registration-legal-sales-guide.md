---
title: "Wejście na rynek kosmetyków na Tajwanie: wybór podmiotu importującego, rejestracja produktu, sporządzenie i przechowywanie PIF oraz regulacja reklamy"
url: "https://www.wei-wei-lawyer.com/post/taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide"
lastmod: "2026-07-25"
date_display: "4 lutego 2026"
...
faq:
  ...
  - q: "Jakich sformułowań trzeba pilnować w reklamie kosmetyków na Tajwanie?"
    a: "Reklamę ocenia się nie tylko według zdania, lecz według całości przekazu, w tym nazwy produktu, tekstu, obrazu, symbolu i dźwięku. Zakazane są sformułowania fałszywe lub przesadne oraz twierdzenie o skuteczności medycznej, i trzeba zwracać szczególną uwagę na sformułowania medyczne, jak leczenie trądziku, przeciwzapalne lub bakteriobójcze. Kara administracyjna wynosi od 40.000 do 200.000 dolarów tajwańskich (新臺幣, TWD) za reklamę fałszywą lub przesadną oraz od TWD 600.000 do TWD 5.000.000 za twierdzenie o skuteczności medycznej. Publikacje influencerów i innych też należy badać według tego samego kryterium, jeśli w istocie są reklamą."
---
...
![Dane produktu i przegląd normatywny potrzebne do wejścia na rynek kosmetyków na Tajwanie](../images/011-taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide/featured-01.jpg)
...
To nie jest ta sama procedura. Rejestracja produktu jest odrębną formalnością, która odbywa się na platformie rejestracji produktów kosmetycznych TFDA (衛生福利部食品藥物管理署). PIF jest teczką, która zbiera dane o jakości, bezpieczeństwie, składzie, deklarowanej funkcji, sposobie wytwarzania, wynikach badań i ocenie bezpieczeństwa, między innymi, i którą wytwórca lub importer kosmetyków sporządza, aktualizuje i przechowuje; sam PIF nie jest dokumentem, który trzeba z góry przedstawić TFDA. Od 1 lipca 2026 r. co do zasady wszystkie kosmetyki podlegają reżimowi PIF, z wyjątkiem stałego mydła ręcznego (固態手工香皂) wytwarzanego w miejscu produkcji zwolnionym z rejestracji fabryki (工廠登記).
...
PIF jest zbiorem danych ustrukturyzowanym tak, by można było nadal wyjaśniać jakość i bezpieczeństwo produktu. Oprócz jakości, bezpieczeństwa, składu, deklarowanej funkcji (宣稱功能), sposobu wytwarzania, wyników badań i oceny bezpieczeństwa, trzeba uporządkować według produktu informacje podstawowe o produkcie i wytwórcy oraz dane podpierające, jak etykieta. Rozporządzenie o zarządzaniu teczką informacji o produktach kosmetycznych (化粧品產品資訊檔案管理辦法) porządkuje potrzebne dane w 16 kategoriach, więc dane każdej kategorii oraz wymagania podpisu i kwalifikacji trzeba potwierdzić według rodzaju produktu.
...
Jeśli zmieniają się surowiec lub receptura, sposób i miejsce wytwarzania, oznakowanie w tym etykieta, deklarowana funkcja lub informacja o bezpieczeństwie, trzeba ponownie zbadać i zaktualizować dane PIF, których to dotyczy. Trzeba też zbadać, czy reklamacje konsumentów, zdarzenia działań niepożądanych i nowe wyniki badań wpływają na istniejącą ocenę, więc procedura zarządzania zmianami pozostaje potrzebna po pierwszym sporządzeniu.

Według art. 7 rozporządzenia o zarządzaniu teczką informacji o produktach kosmetycznych okres przechowywania wynosi co najmniej 5 lat, liczonych od dnia następującego po ostatnim zaopatrzeniu produktu na rynku. Według art. 8 tego samego rozporządzenia miejscem przechowywania jest adres oznakowania wytwórcy lub importera kosmetyków ustalony w art. 7 ust. 1 pkt 7 ustawy o zarządzaniu higieną i bezpieczeństwem kosmetyków (化粧品衛生安全管理法). Przepis, który ustala okres, i ten, który ustala miejsce, muszą być prowadzone osobno.
...
Reklamę ocenia się nie tylko według zdania, lecz według całości przekazu, w tym nazwy produktu, tekstu, obrazu, symbolu i dźwięku. Zakazane są sformułowania fałszywe lub przesadne oraz twierdzenie o skuteczności medycznej, i trzeba zwracać szczególną uwagę na sformułowania medyczne, jak leczenie trądziku, przeciwzapalne lub bakteriobójcze. Kara administracyjna wynosi od TWD 40.000 do TWD 200.000 za reklamę fałszywą lub przesadną oraz od TWD 600.000 do TWD 5.000.000 za twierdzenie o skuteczności medycznej. Publikacje influencerów i innych też należy badać według tego samego kryterium, jeśli w istocie są reklamą.

### Ocenia się według całości przekazu, nie według każdego słowa

Czy oznakowanie, promocja (宣傳) lub reklama są fałszywe lub przesadne, albo czy twierdzą o skuteczności medycznej (醫療效能), nie ocenia się tylko według jednego określonego słowa. Bada się razem nazwę artykułu, zdanie, obraz, symbol, dźwięk, kontekst wcześniejszy i późniejszy oraz wrażenie całości, jakie otrzymuje konsument. Wrażenie ukształtowane przez centralny przekaz reklamowy nie rozprasza się automatycznie samym zastrzeżeniem drobnym drukiem, więc trzeba przejrzeć zarówno każdy tekst, jak i produkt końcowy.

Na przykład twierdzenie, że kosmetyk leczy trądzik, ma działanie przeciwzapalne lub bakteriobójcze, może stanowić twierdzenie o skuteczności medycznej. Trzeba też razem potwierdzić sposób łączenia nazwy choroby z produktem, obrazy przed i po użyciu, przekaz kojcy pracownika ochrony zdrowia oraz kontekst, który wiąże wyjaśnienie składnika z efektem leczniczym produktu.

Kara administracyjna za reklamę fałszywą lub przesadną (虛偽誇大廣告) wynosi od TWD 40.000 do TWD 200.000, a kara administracyjna za twierdzenie o skuteczności medycznej wynosi od TWD 600.000 do TWD 5.000.000. Ponieważ przedział różni się według rodzaju naruszenia, przed publikacją trzeba zestawić całość przekazu reklamowego z danymi podpierającymi.
...
- [Ustawa o zarządzaniu higieną i bezpieczeństwem kosmetyków](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030013)
- [Rozporządzenie o rejestracji produktów kosmetycznych (化粧品產品登錄辦法)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030097)
- [Rozporządzenie o zarządzaniu teczką informacji o produktach kosmetycznych](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030098)
