...
Ja ir izpildītas noziedzīga nodarījuma — aiz neuzmanības nodarīta miesas bojājuma (過失傷害) — likumā noteiktās pazīmes, var izvērtēt kriminālo sūdzību (告訴). Var izvērtēt arī civiltiesisku prasījumu par zaudējumu atlīdzību, tomēr kurš pamats piemērojams — līgumiskā atbildība, delikts (侵權行為) vai patērētāju aizsardzība — un atbildības apjoms atšķiras pēc konkrētajiem lietas apstākļiem. Tas, ka vienā negadījumā var izvērtēt vairākas gaitas, nenozīmē ne to, ka tās visas jāveic, ne to, ka kādā no tām panākums būtu garantēts.
