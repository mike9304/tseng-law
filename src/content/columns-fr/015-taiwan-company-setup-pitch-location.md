---
title: "Création de société à Taïwan – partie approfondie 3 : recherche du local"
...
# Création de société à Taïwan – partie approfondie 3 : recherche du local

![Image à la une](../images/015-taiwan-company-setup-pitch-location/featured-01.jpg)

(Les exigences des collectivités locales de Taïwan diffèrent ; le texte suivant est un exemple d’ouverture d’un établissement de restauration dans la ville de Taipei.)
...
Si vous commencez l’activité dans la ville de Taipei,

vous pouvez utiliser le système de « consultation préalable du local » (營業場所預先查詢) du bureau du commerce de la ville de Taipei (臺北市商業處).

<https://www.businesslocationinfo.gov.taipei/BLBQS/Home/Notice>

​

Vous pouvez vérifier sans frais si, à l’adresse souhaitée, l’ouverture d’un « établissement de restauration » est possible.

Toutefois, pour cette vérification, vous devez téléverser l’« extrait d’inscription immobilière de type II » (建物登記第二類謄本, qui contient les informations détaillées du bâtiment) de l’adresse du local.

Toute personne peut demander auprès du bureau de l’administration foncière (地政事務所) l’« extrait d’inscription immobilière de type II » d’une adresse quelconque.
...
Si l’on ouvre dans un lieu où l’établissement de restauration n’est pas possible, une amende administrative (罰鍰) de l’autorité compétente peut plus tard être infligée.

![« branches faisant l’objet d’une vérification d’office » (主動查詢之營業項目)](../images/015-taiwan-company-setup-pitch-location/img-02.jpg)
