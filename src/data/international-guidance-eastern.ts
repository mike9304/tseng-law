...
export const ukrainianGuidanceContent: GuidanceLocaleContent = {
  ...
  mega: {
    ...
    lawyers: {
      description: 'Представлення адвокатів і способів звернення.',
      viewAllLabel: 'Показати все',
    },
    pricing: {
  ...
  home: {
    ...
    columnsReviewLabel: 'Перевірила адвокат Wei Tseng',
  ...
  pages: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Ми не обіцяємо перекладача, строку відповіді та зустрічі через цю сторінку. Якщо Ви не можете скористатися жодною з чотирьох мов, сторінка «Контакти» пояснює, як ми розглядаємо спосіб спілкування.',
          ],
        },
        {
          heading: 'Групи справ',
        ...
        },
        {
          ...
          paragraphs: [
            'Прочитайте сторінку «Послуги», щоб перевірити, чи належить Ваша справа до нашого обсягу, потім «Витрати» і «Контакти», щоб дізнатися, як визначається обсяг і як витрати підтверджуються до початку роботи.',
            'Надсилаючи повідомлення, виклад Ви можете написати своєю мовою. Первинний текст зберігається саме таким, яким Ви його написали, і не перекладається автоматично. Надіслане повідомлення — це запит, що очікує розгляду: це ще не консультація і не підтверджена зустріч.',
          ],
        },
      ],
    },
    services: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Ця група охоплює спори з договорів, відшкодування шкоди з деліктів і споживчі спори. Робота зазвичай починається з хронології, перевірки документів і наявних доказів, і лише потім настають подальші кроки.',
            'Перебіг визначають строки, зокрема позовна давність, і повнота доказів. Тому зазначайте відомі дати якнайраніше. Збережіть договори, повідомлення, підтвердження платежів або світлини стану на місці та згадайте про них у першому повідомленні.',
          ],
        },
        {
          heading: 'Шлюб, сім’я та спадкування',
          paragraphs: [
            'Ми ведемо розірвання шлюбу (離婚), поділ майна, здійснення та виконання прав і обов’язків щодо неповнолітніх дітей (未成年子女權利義務之行使或負擔), спілкування з дитиною (會面交往) і спадкування (繼承), зокрема й тоді, коли сторони або майно перебувають у різних державах. Транскордонні сімейні справи часто потребують додаткової перевірки записів обліку населення (戶籍), форми документів і їхньої доказової сили на Тайвані.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Вирішальними документами зазвичай є трудовий договір, правила внутрішнього трудового розпорядку (工作規則), розрахункові листки та листування сторін. Якщо вони у Вас збереглися, згадайте про це у викладі.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Ми підтримуємо реєстрацію торговельних марок (商標) і патентів (專利), авторське право та спори про ці права на Тайвані.',
            'У цій групі вирішує послідовність кроків: обсяг охорони, момент подання та фактичне використання впливають на вибір. Подання заявки саме по собі не означає, що її буде задоволено.',
          ],
        },
        {
    ...
    about: {
      ...
      intro:
        'Hovering International Law Firm — адвокатська фірма на Тайвані. Її адвокати працюють від консультування підприємств до ведення судових справ. Ця частина описує виникнення фірми, її осідки та роботу з іноземними сторонами.',
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Після надходження Вашого викладу адвокат розглядає зміст, а потім говорить про можливий обсяг роботи, про ще потрібні документи та про подальші кроки. У податкових або бухгалтерських питаннях фірма може працювати разом із бухгалтерським відділом одним потоком.',
            'Результат кожної справи залежить від обставин і наявних документів; результату ми не обіцяємо. Якщо Вам потрібна обов’язкова відповідь для Вашого становища, документи слід обговорити однією з чотирьох мов консультації з адвокатом.',
          ],
        },
      ],
    },
    lawyers: {
      ...
      description: 'Профілі адвокатів, операційного керівництва та партнерської бухгалтерії Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Коли обсяг роботи зрозумілий, розмір і спосіб обчислення витрат обговорюють і підтверджують із Вами до того, як робота почнеться. Якщо обсяг змінюється в перебігу, це треба підтвердити знову.',
            'Ця сторінка не є ціновою пропозицією і не створює обов’язку платити.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Витрати залежать від самої справи: від зусиль, кількості сторін, документів, строків і від того, чи вже триває провадження. Наперед визначене число не показало б витрат Вашої справи. Тому ми спершу визначаємо обсяг роботи, а витрати повідомляємо потім, до початку роботи.',
    ...
    contact: {
      ...
      description:
        'Мова сторінки, мови консультації, що робити, якщо Ви не можете скористатися жодною з чотирьох мов, і чого ця сторінка не обіцяє.',
      intro:
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Ваша мова письма: виклад Ви можете написати своєю мовою; первинний текст зберігається без змін.',
          ],
        },
        {
          heading: 'Якщо Ви не можете скористатися жодною з чотирьох мов консультації',
          paragraphs: [
            ...
            'Це лише крок розгляду, а не обіцянка. Ми не обіцяємо перекладача, послуги українською чи іншою мовою поза чотирма зазначеними, і не обіцяємо, що візьмемо кожну справу.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Ми не обіцяємо строку відповіді, не підтверджуємо зустріч через цю сторінку, не обіцяємо певного адвоката і не надаємо перекладача. Письмовий переклад — це інше: Ваше повідомлення не перекладається автоматично.',
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Якщо Ви не знайдете відповіді для свого становища, відповідь зазвичай залежить від особливих обставин. Тоді напишіть їх у викладі, замість того щоб виводити їх із цієї сторінки.',
          ],
        },
      ],
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Ні. Ці відомості написано українською, але консультація з адвокатом відбувається лише англійською, китайською (中文), японською та корейською. Перекладача ми теж не обіцяємо. Письмовий переклад — це інше: первинний текст, який Ви пишете, зберігається таким, як є, і не перекладається автоматично.',
        },
        {
          question: 'Що робити, якщо я не можу скористатися жодною з чотирьох мов?',
          answer:
            'Надсилаючи запит, оберіть «Спосіб спілкування потребує підтвердження». Ми відповідаємо, щоб розглянути спосіб спілкування, але послуги іншою мовою не гарантовано. Це крок розгляду, а не обіцянка, що ми зможемо працювати іншою мовою.',
        },
        {
          question: 'Як опрацьовують мій текст українською?',
          answer:
            'Первинний текст, який Ви пишете, зберігається таким, як є, і не перекладається автоматично. За потреби мову подальшого спілкування підтверджують із Вами.',
        },
        {
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Мову, якою Ви писали',
            'Мову консультації, якої Ви бажаєте',
            'Первинний текст, який Ви написали',
            'Вашу згоду на надсилання запиту',
            'Реєстраційний номер для віднайдення запиту',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Зміст Вашого надсилання зберігають у місці, що не є загальнодоступним. Доступ до нього мають лише уповноважені особи у фірмі — для опрацювання запиту.',
        ...
        },
        {
          ...
          paragraphs: [
            'Цей сайт розміщено у Vercel, і Ваше надсилання зберігається в непублічному об’єктному сховищі цієї служби. Листи надсилають через поштову службу, якою користується фірма.',
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'Результат справи залежить від обставин, від застосовних приписів і від моменту; дві на вигляд подібні ситуації можуть скінчитися по-різному.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Ці відносини виникають лише після того, як справу розглянуто й обидві сторони підтвердили взяття роботи.',
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Тому не засновуйте дій у справжній справі лише на статті. Користуйтеся нею для загального огляду та обговоріть свої документи окремо з адвокатом; ця сторінка не є кроком консультації.',
          ],
        },
      ],
    },
...
export const greekGuidanceContent: GuidanceLocaleContent = {
  ...
  home: {
    ...
    servicesAssistanceBefore: 'Αν δεν είναι σαφές σε ποια ομάδα ανήκει η υπόθεσή σας, η σελίδα ',
    ...
    imageBandAlt: 'Παραδοσιακή ταϊβανέζικη αυλή sanheyuan (三合院) και ένα σύγχρονο περίπτερο στο φως της ημέρας',
    videoPauseLabel: 'Παύση του βίντεο',
    videoPlayLabel: 'Αναπαραγωγή του βίντεο',
    videoReplayLabel: 'Νέα αναπαραγωγή του βίντεο',
  },
  pages: {
    home: {
      eyebrow: 'ΠΛΗΡΟΦΟΡΙΕΣ',
      ...
      description:
        'Γενικές εξηγήσεις στα ελληνικά για το εύρος εργασίας της Hovering International Law Firm στην Ταϊβάν, για τις γλώσσες της συμβουλευτικής και για την πρώτη επικοινωνία.',
      intro:
        'Η Hovering International Law Firm συνοδεύει εντολείς από το εξωτερικό, και όσους έχουν δεσμό με την Ταϊβάν, σε ζητήματα του δικαίου της Ταϊβάν: επενδύσεις και σύσταση εταιρειών, αστικές διαφορές, γάμος, οικογένεια και κληρονομικά, εργατικό δίκαιο, ποινικές υποθέσεις και διανοητική ιδιοκτησία. Αυτό το ελληνικό μέρος σας βοηθά να αναγνωρίσετε ποια εργασία εμπίπτει στο εύρος μας, τι να ετοιμάσετε και πώς να μας προσεγγίσετε. Πρόκειται για γενικές πληροφορίες, όχι για νομική συμβουλή στη δική σας υπόθεση.',
      sections: [
        {
          heading: 'Με τι ασχολούμαστε',
          paragraphs: [
            'Η Hovering International Law Firm είναι δικηγορικό γραφείο εγκατεστημένο στην Ταϊβάν. Εργάζεται κατά το δίκαιο της Ταϊβάν και διατηρεί γραφεία στην Ταϊπέι (臺北), στο Καοσιούνγκ (高雄), στο Ταϊτσούνγκ (臺中) και στο Πινγκτούνγκ (屏東). Συμβουλεύουμε επιχειρήσεις, διεξάγουμε δίκες και συνοδεύουμε εντολείς από το εξωτερικό στα βήματα που απαιτούνται στην Ταϊβάν.',
            'Όλο το περιεχόμενο εδώ είναι γενικό. Η έκβαση μιας υπόθεσης εξαρτάται από τα πραγματικά περιστατικά, από τους εφαρμοστέους κανόνες και από τη χρονική στιγμή. Οι πληροφορίες αυτές δεν υποκαθιστούν τη συζήτηση με δικηγόρο πάνω στα έγγραφά σας.',
          ],
        },
        {
          heading: 'Η γλώσσα της σελίδας και η γλώσσα της συμβουλευτικής δεν ταυτίζονται',
          paragraphs: [
            'Η σελίδα αυτή είναι γραμμένη στα ελληνικά, αλλά η συμβουλευτική με δικηγόρο διεξάγεται μόνο στις τέσσερις γλώσσες συμβουλευτικής: αγγλικά, κινεζικά (中文), ιαπωνικά και κορεατικά. Η ανάγνωση των πληροφοριών στα ελληνικά δεν σημαίνει ότι η συζήτηση με τη δικηγόρο ή τον δικηγόρο θα γίνει στα ελληνικά.',
            'Δεν υποσχόμαστε διερμηνέα, προθεσμία απάντησης ούτε ραντεβού μέσω αυτής της σελίδας. Αν δεν μπορείτε να χρησιμοποιήσετε καμία από τις τέσσερις γλώσσες, η σελίδα «Επικοινωνία» εξηγεί πώς εξετάζουμε έναν τρόπο επικοινωνίας.',
          ],
        },
        {
          heading: 'Ομάδες εργασιών',
          paragraphs: [
            'Το εύρος της εργασίας περιλαμβάνει τις ακόλουθες έξι ομάδες. Η σελίδα «Υπηρεσίες» περιγράφει κάθε ομάδα ακριβέστερα και αναφέρει τι δεν υπόσχεται.',
          ],
          items: [
        ...
        },
        {
          ...
          paragraphs: [
            'Διαβάστε τη σελίδα «Υπηρεσίες» για να ελέγξετε αν η υπόθεσή σας εμπίπτει στο εύρος μας, έπειτα τις σελίδες «Κόστος» και «Επικοινωνία», για να μάθετε πώς καθορίζεται το εύρος και πώς επιβεβαιώνεται το κόστος πριν αρχίσει η εργασία.',
    ...
    services: {
      ...
      description:
        'Οι έξι ομάδες εργασιών του γραφείου στην Ταϊβάν και τα όρια που αξίζει να γνωρίζετε πρώτα.',
      intro:
        'Ακολουθούν οι ομάδες που πράγματι χειριζόμαστε και τα ερωτήματα που τίθενται συχνά στο αρχικό στάδιο. Η παρουσίαση σας βοηθά να κρίνετε αν η υπόθεσή σας εμπίπτει στο εύρος μας· είναι γενική και δεν αποτελεί νομική ανάλυση συγκεκριμένου φακέλου.',
      sections: [
        {
          heading: 'Επενδύσεις και σύσταση εταιρειών στην Ταϊβάν',
          paragraphs: [
            'Συνοδεύουμε ξένους επενδυτές και επιχειρήσεις στη σύσταση ή τη λειτουργία εταιρείας στην Ταϊβάν: επιλογή νομικής μορφής, προετοιμασία και κατάθεση εγγράφων, καταβολή κεφαλαίου, τραπεζικά ζητήματα, έλεγχος της έδρας και κλαδικές απαιτήσεις. Υποστηρίζουμε επίσης τη λογιστική και τη φορολογία που προκύπτουν από τη σύσταση και τη λειτουργία στην Ταϊβάν.',
        ...
        },
        {
          ...
          paragraphs: [
            'Η ομάδα αυτή περιλαμβάνει διαφορές από συμβάσεις, αποζημίωση από αδικοπραξία και καταναλωτικές διαφορές. Η εργασία αρχίζει κατά κανόνα με χρονολόγιο, με εξέταση των εγγράφων και των υπαρχόντων αποδεικτικών στοιχείων, και μόνο κατόπιν ακολουθούν τα επόμενα βήματα.',
            'Οι προθεσμίες, μεταξύ αυτών και η παραγραφή, καθώς και η πληρότητα των αποδείξεων καθορίζουν την πορεία. Αναφέρετε επομένως τις γνωστές ημερομηνίες όσο το δυνατόν νωρίτερα. Φυλάξτε συμβάσεις, μηνύματα, αποδείξεις πληρωμών ή φωτογραφίες της κατάστασης επί τόπου και μνημονεύστε τα στο πρώτο μήνυμα.',
          ],
        },
        {
          heading: 'Γάμος, οικογένεια και κληρονομικά',
          paragraphs: [
            'Χειριζόμαστε το διαζύγιο (離婚), τη διανομή περιουσίας, την άσκηση και ανάληψη των δικαιωμάτων και υποχρεώσεων έναντι ανήλικων τέκνων (未成年子女權利義務之行使或負擔), την επικοινωνία με το τέκνο (會面交往) και τα κληρονομικά (繼承), ακόμη και όταν τα μέρη ή τα περιουσιακά στοιχεία βρίσκονται σε διαφορετικά κράτη. Οι διασυνοριακές οικογενειακές υποθέσεις απαιτούν συχνά πρόσθετο έλεγχο των μητρώων κατοίκων (戶籍), του τύπου των εγγράφων και της αποδεικτικής τους ισχύος στην Ταϊβάν.',
        ...
        },
        {
          ...
          paragraphs: [
            'Η ομάδα αυτή περιλαμβάνει τη λύση της εργασιακής σχέσης, την αποζημίωση κατά το δίκαιο της Ταϊβάν (資遣費· δεν εξομοιώνεται με αντίστοιχους θεσμούς άλλων κρατών), τις αποδοχές και τις διαφορές από τη σύμβαση εργασίας (勞動契約), τόσο από την πλευρά του εργαζομένου όσο και από την πλευρά του εργοδότη. Κατά την εξέταση διακρίνουμε τον λόγο της λύσης από τα ζητήματα προειδοποίησης, καταβολής και προθεσμιών.',
        ...
        },
        {
          ...
          paragraphs: [
            'Συνοδεύουμε στην προκαταρκτική διαδικασία και ενώπιον του δικαστηρίου, τόσο υπόπτους και κατηγορουμένους όσο και παθόντες, και αξιολογούμε τους ποινικούς κινδύνους της επιχειρηματικής δραστηριότητας.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Στην ομάδα αυτή κρίνει η σειρά των βημάτων: το εύρος της προστασίας, ο χρόνος της κατάθεσης και η πραγματική χρήση επηρεάζουν την επιλογή. Η κατάθεση αίτησης δεν σημαίνει από μόνη της ότι θα γίνει δεκτή.',
          ],
        },
        {
          heading: 'Το εύρος και η επιβεβαίωσή του',
          paragraphs: [
            'Το γραφείο εργάζεται κατά το δίκαιο της Ταϊβάν και χειρίζεται υποθέσεις των ομάδων που αναφέρθηκαν. Το εύρος κάθε υπόθεσης επιβεβαιώνεται χωριστά, αφού δικηγόρος εξετάσει το μήνυμά σας.',
    ...
    about: {
      ...
      intro:
        'Η Hovering International Law Firm είναι δικηγορικό γραφείο στην Ταϊβάν. Οι δικηγόροι εργάζονται από τη συμβουλευτική επιχειρήσεων έως τη δίκη. Το μέρος αυτό περιγράφει τη δημιουργία του γραφείου, τις έδρες και την εργασία με αλλοδαπά μέρη.',
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Η διασυνοριακή εργασία περιλαμβάνει σύσταση εταιρειών, θεωρήσεις, καταθέσεις σημάτων και διπλωμάτων ευρεσιτεχνίας, έλεγχο νομικού κινδύνου και φορολογική συμβουλευτική επιχειρήσεων. Το γραφείο στο Ταϊτσούνγκ χειρίζεται ιδίως υποθέσεις κατασκευών, διανοητικής ιδιοκτησίας και υποθέσεις με δεσμό προς την Κορέα και την Ιαπωνία. Η δικηγόρος Wei Tseng (曾雋崴) συνοδεύει εντολείς από την Κορέα, την Ιαπωνία και άλλους διεθνείς εντολείς στις ομάδες που αναφέρθηκαν.',
            'Το αν μπορούμε να αναλάβουμε μια υπόθεση εξαρτάται από το περιεχόμενο και από τη γλώσσα της επικοινωνίας. Αν η υπόθεσή σας εμπίπτει στις ομάδες που αναφέρθηκαν και μπορεί να συζητηθεί σε μία από τις τέσσερις γλώσσες συμβουλευτικής, μπορείτε να στείλετε περίληψη προς εξέταση.',
          ],
        },
        {
          heading: 'Όταν επικοινωνείτε μαζί μας',
          paragraphs: [
            'Μετά την άφιξη της περίληψής σας, δικηγόρος εξετάζει το περιεχόμενο και μιλά κατόπιν για το πιθανό εύρος της εργασίας, για τα έγγραφα που χρειάζονται ακόμη και για τα επόμενα βήματα. Σε φορολογικά ή λογιστικά ζητήματα το γραφείο μπορεί να εργαστεί μαζί με το λογιστικό τμήμα σε μία ροή.',
    ...
    lawyers: {
      ...
      description: 'Προφίλ των δικηγόρων, της λειτουργικής διεύθυνσης και του συνεργαζόμενου λογιστικού ελέγχου της Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
      eyebrow: 'ΚΟΣΤΟΣ',
      title: 'Πώς καθορίζονται το εύρος της εργασίας και το κόστος',
      description:
        'Εξήγηση της σειράς: πρώτα το εύρος της εργασίας, έπειτα η επιβεβαίωση του κόστους, και γιατί η σελίδα αυτή δεν περιέχει τιμοκατάλογο.',
      intro:
        'Η σελίδα αυτή εξηγεί πώς καθορίζεται το κόστος, όχι το ύψος του. Το ύψος εξαρτάται από το εύρος της εργασίας στη συγκεκριμένη υπόθεση και έχει νόημα μόνο όταν το εύρος αυτό είναι σαφές.',
      sections: [
        {
          heading: 'Πρώτα καθορίζεται το εύρος της εργασίας',
          paragraphs: [
            ...
            'Η περίληψη που στέλνετε στην αρχή είναι η βάση αυτού του εύρους. Όσο σαφέστερα περιγράφει την εξέλιξη, το αίτημά σας και τις προθεσμίες, τόσο ακριβέστερα μπορεί να προσδιοριστεί το εύρος.',
          ],
        },
        {
          heading: 'Το κόστος επιβεβαιώνεται πριν αρχίσει η εργασία',
          paragraphs: [
            'Όταν το εύρος της εργασίας είναι σαφές, το ύψος και ο τρόπος υπολογισμού του κόστους συζητούνται και επιβεβαιώνονται μαζί σας πριν αρχίσει η εργασία. Αν το εύρος μεταβληθεί στην πορεία, πρέπει να επιβεβαιωθεί εκ νέου.',
        ...
        },
        {
          ...
          paragraphs: [
            'Η συμβουλευτική με δικηγόρο μπορεί να είναι υπηρεσία με αμοιβή. Η σελίδα αυτή δεν λέει ότι η πρώτη συζήτηση είναι δωρεάν, και κανένα μέρος της δεν μπορεί να διαβαστεί με αυτή την έννοια.',
    ...
    contact: {
      eyebrow: 'ΕΠΙΚΟΙΝΩΝΙΑ',
      title: 'Πώς να προσεγγίσετε το γραφείο',
      description:
        'Η γλώσσα της σελίδας, οι γλώσσες της συμβουλευτικής, τι ισχύει αν δεν μπορείτε να χρησιμοποιήσετε καμία από τις τέσσερις γλώσσες, και τι δεν υπόσχεται η σελίδα αυτή.',
      intro:
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Η γλώσσα εμφάνισης της σελίδας, η γλώσσα της συμβουλευτικής με τη δικηγόρο ή τον δικηγόρο και η γλώσσα στην οποία γράφετε είναι τρία διαφορετικά πράγματα.',
          ],
          items: [
            ...
            'Η δική σας γλώσσα γραφής: μπορείτε να γράψετε την περίληψη στη γλώσσα σας· το πρωτότυπο κείμενο διατηρείται αμετάβλητο.',
          ],
        },
        {
          heading: 'Αν δεν μπορείτε να χρησιμοποιήσετε καμία από τις τέσσερις γλώσσες συμβουλευτικής',
          paragraphs: [
            'Στη φόρμα επικοινωνίας μπορείτε να επιλέξετε «Ο τρόπος επικοινωνίας χρειάζεται επιβεβαίωση». Απαντούμε για να εξετάσουμε έναν εφικτό τρόπο επικοινωνίας, αν υπάρχει τέτοιος· υπηρεσία σε άλλη γλώσσα δεν είναι εγγυημένη και προθεσμία απάντησης δεν υπόσχεται.',
            'Αυτό είναι μόνο ένα βήμα εξέτασης, όχι υπόσχεση. Δεν υποσχόμαστε διερμηνέα, υπηρεσία στα ελληνικά ή σε άλλη γλώσσα εκτός των τεσσάρων που αναφέρθηκαν, ούτε ότι αναλαμβάνουμε κάθε υπόθεση.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Δεν υποσχόμαστε προθεσμία απάντησης, δεν επιβεβαιώνουμε ραντεβού μέσω αυτής της σελίδας, δεν υποσχόμαστε συγκεκριμένη δικηγόρο ή δικηγόρο και δεν παρέχουμε διερμηνέα. Η γραπτή μετάφραση είναι άλλο ζήτημα: το μήνυμά σας δεν μεταφράζεται αυτόματα.',
    ...
    faq: {
      ...
      description:
        'Εξηγήσεις για το εύρος της εργασίας, την προετοιμασία, τις γλώσσες, το κόστος και για το τι σημαίνει ένα αίτημα που έχει σταλεί.',
      intro:
      ...
      sections: [
        {
          heading: 'Πώς να χρησιμοποιήσετε αυτό το μέρος',
          paragraphs: [
            'Αν δεν βρείτε απάντηση για την κατάστασή σας, η απάντηση εξαρτάται κατά κανόνα από ιδιαίτερα πραγματικά περιστατικά. Γράψτε τα τότε στην περίληψη, αντί να τα συναγάγετε από αυτή τη σελίδα.',
          ],
        },
      ],
      faqs: [
        {
          ...
          answer:
            'Χειριζόμαστε έξι ομάδες: επενδύσεις και σύσταση εταιρειών στην Ταϊβάν, αστικές διαφορές και αποζημίωση, γάμο, οικογένεια και κληρονομικά, εργατικές διαφορές, ποινικές υποθέσεις και διανοητική ιδιοκτησία. Το αν μια υπόθεση γίνεται δεκτή κρίνεται μετά την εξέταση του περιεχομένου.',
        },
        {
        ...
        {
          question: 'Είναι δυνατή συμβουλευτική στα ελληνικά;',
          answer:
        ...
        {
          question: 'Τι κάνω αν δεν μπορώ να χρησιμοποιήσω καμία από τις τέσσερις γλώσσες;',
          answer:
        ...
        },
        {
          ...
          answer:
            'Πρώτα καθορίζεται το εύρος της εργασίας, έπειτα το ύψος και ο τρόπος υπολογισμού του κόστους επιβεβαιώνονται μαζί σας πριν αρχίσει η εργασία. Η σελίδα αυτή δεν αναφέρει ποσά και δεν λέει ότι η πρώτη συζήτηση είναι δωρεάν.',
        },
        {
          question: 'Τι κάνω αν η υπόθεσή μου είναι πολύ επείγουσα;',
          answer:
            'Αναφέρετε την προθεσμία ή την ημερομηνία επίσημου εγγράφου στην αρχή της περίληψης, ώστε οι ημερομηνίες αυτές να φαίνονται κατά την εξέταση. Η σελίδα αυτή δεν έχει δίαυλο έκτακτης ανάγκης και δεν εξασφαλίζει προθεσμία απάντησης· αν η υπόθεσή σας δεν αντέχει αναμονή, θα πρέπει να αναζητήσετε παράλληλα και άλλους δρόμους στον τόπο σας.',
        },
      ],
    },
    privacy: {
      ...
      description:
        'Τι συλλέγει η φόρμα επικοινωνίας σε αυτό το ελληνικό μέρος, πώς αντιμετωπίζεται το πρωτότυπο κείμενο και πώς να μας προσεγγίσετε για τα δεδομένα σας.',
      intro:
        'Το μέρος αυτό αφορά μόνο τη φόρμα επικοινωνίας σε αυτές τις σελίδες πληροφοριών. Περιγράφει τη μεταχείριση των δεδομένων, όχι τεχνική εγγύηση.',
      sections: [
        {
          heading: 'Ποια δεδομένα συλλέγονται',
          paragraphs: [
            'Όταν στέλνετε αίτημα μέσω της φόρμας σε αυτό το μέρος, καταγράφονται τα ακόλουθα δεδομένα:',
          ],
          items: [
            'Το όνομα που δηλώνετε',
            'Τη διεύθυνση ηλεκτρονικού ταχυδρομείου για την απάντηση',
            'Τη γλώσσα εμφάνισης της σελίδας κατά τη στιγμή της αποστολής',
            'Τη γλώσσα στην οποία γράψατε',
            'Τη γλώσσα συμβουλευτικής που επιθυμείτε',
            'Το πρωτότυπο κείμενο που γράψατε',
            'Τη συγκατάθεσή σας για την αποστολή του αιτήματος',
            'Έναν αριθμό πρωτοκόλλου για την ανεύρεση του αιτήματος',
          ],
        },
        {
        ...
        {
          heading: 'Τόπος φύλαξης και πρόσβαση',
          paragraphs: [
            'Το περιεχόμενο της αποστολής σας φυλάσσεται σε τόπο που δεν είναι προσβάσιμος στο κοινό. Πρόσβαση έχουν μόνο εξουσιοδοτημένα πρόσωπα του γραφείου, για τον χειρισμό του αιτήματος.',
            'Η σελίδα αυτή δεν δίνει απόλυτη εγγύηση ασφάλειας. Κανένας δρόμος μετάδοσης και κανένας τόπος φύλαξης δεν είναι απολύτως ασφαλής· τα ευαίσθητα έγγραφα θα πρέπει επομένως να αποστέλλονται μόνο μετά από ειδική οδηγία της δικηγόρου ή του δικηγόρου.',
          ],
        },
        {
        ...
        {
          heading: 'Τα δικαιώματά σας και ο δρόμος επικοινωνίας',
          paragraphs: [
            ...
            'Η σελίδα αυτή δεν αναφέρει σταθερή διάρκεια φύλαξης, επειδή η πραγματική διάρκεια εξαρτάται από την περαιτέρω πορεία της υπόθεσης και από τις συναφείς υποχρεώσεις. Αν επιθυμείτε πρωιμότερη διαγραφή, αναφέρετέ το κατά την επικοινωνία.',
          ],
        },
        {
          heading: 'Τόπος φύλαξης και πάροχοι',
          paragraphs: [
            'Ο ιστότοπος αυτός φιλοξενείται στη Vercel, και η αποστολή σας φυλάσσεται σε μη δημόσιο αποθετήριο αντικειμένων αυτής της υπηρεσίας. Τα μηνύματα ηλεκτρονικού ταχυδρομείου αποστέλλονται μέσω της ταχυδρομικής υπηρεσίας που χρησιμοποιεί το γραφείο.',
            'Οι διακομιστές ορισμένων παρόχων μπορεί να βρίσκονται εκτός Ταϊβάν, οπότε τα δεδομένα σας μπορεί να φυλάσσονται και να υποβάλλονται σε επεξεργασία εκεί. Όταν ο σκοπός της φύλαξης εκπληρωθεί, τα δεδομένα διαγράφονται χωρίς καθυστέρηση· τα δεδομένα που πρέπει να φυλάσσονται κατά τους εφαρμοστέους κανόνες παραμένουν για το διάστημα αυτό. Τα αιτήματα για δεδομένα προσωπικού χαρακτήρα γίνονται δεκτά στο wei@hoveringlaw.com.tw.',
          ],
        },
      ],
    },
    disclaimer: {
      ...
      intro:
        'Το μέρος αυτό αποσαφηνίζει τι μπορούν να κάνουν για εσάς αυτές οι ελληνικές σελίδες πληροφοριών και τι όχι.',
      sections: [
        {
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Το μέρος αυτό περιέχει τέσσερις συνδέσμους: τον κατάλογο άρθρων στα κορεατικά, στα κινεζικά, στα αγγλικά και στα ιαπωνικά. Κάθε σύνδεσμος αναφέρει τη γλώσσα του καταλόγου, ώστε να γνωρίζετε εκ των προτέρων σε ποια γλώσσα ανοίγει το περιεχόμενο.',
        ...
        },
        {
          ...
          paragraphs: [
            'Τα άρθρα είναι γενικές πληροφορίες κατά τον χρόνο της δημοσίευσης. Οι κανόνες και η εφαρμογή τους μπορεί να μεταβληθούν, και ένα άρθρο δεν περιέχει όλες τις περιστάσεις της υπόθεσής σας.',
            'Γι᾿ αυτό μη θεμελιώνετε ενέργειες σε πραγματική υπόθεση μόνο σε ένα άρθρο. Χρησιμοποιήστε το για τη γενική εικόνα και συζητήστε τα έγγραφά σας χωριστά με δικηγόρο· η σελίδα αυτή δεν είναι το βήμα της συμβουλευτικής.',
          ],
        },
      ],
    },
...
export const hebrewGuidanceContent: GuidanceLocaleContent = {
  ...
  mega: {
    services: {
      description: 'המשרד מטפל בקבוצות העבודה המרכזיות לפי דין טאיוואן.',
  ...
  home: {
    ...
    servicesAssistanceBefore: 'אם אין זה ברור לאיזו קבוצה שייך העניין שלכם, העמוד ',
    ...
    imageBandAlt: 'חצר טאיוואנית מסורתית מסוג סאנהֶייוּאָן (三合院) וביתן מודרני באור יום',
  ...
  pages: {
    home: {
      ...
      description:
        'הסברים כלליים בעברית על היקף עבודתה של Hovering International Law Firm בטאיוואן, על שפות הייעוץ ועל הפנייה הראשונה.',
      intro:
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Hovering International Law Firm הוא משרד עורכי דין הפועל בטאיוואן. הוא עובד לפי דין טאיוואן ולו סניפים בטאיפיי (臺北), בקאוסיונג (高雄), בטאיצ׳ונג (臺中) ובפינגטונג (屏東). אנו מייעצים לעסקים, מנהלים הליכים בבית המשפט ומלווים לקוחות מחוץ לטאיוואן בצעדים הנדרשים שם.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'איננו מבטיחים מתורגמן, מועד למענה ולא פגישה דרך עמוד זה. אם אינכם יכולים להשתמש באף אחת מארבע השפות, העמוד «יצירת קשר» מסביר כיצד אנו בוחנים דרך תקשורת.',
          ],
        },
        {
          heading: 'קבוצות העבודה',
          paragraphs: [
            'היקף העבודה כולל את שש הקבוצות הבאות. העמוד «תחומים» מתאר כל קבוצה בדיוק רב יותר ומציין מה אינו מובטח.',
          ],
          items: [
    ...
    services: {
      ...
      description:
        'שש קבוצות העבודה של המשרד בטאיוואן והגבולות שכדאי להכיר תחילה.',
      intro:
        'להלן הקבוצות שבהן אנו מטפלים בפועל והשאלות העולות לעיתים קרובות בשלב הראשון. התיאור יסייע לכם להעריך אם העניין שלכם נכלל בהיקף שלנו; הוא כללי ואינו ניתוח משפטי של תיק מסוים.',
      sections: [
        {
          heading: 'השקעה והקמת חברות בטאיוואן',
          paragraphs: [
            'אנו מלווים משקיעים ועסקים זרים בהקמת חברה בטאיוואן או בניהולה: בחירת צורת ההתאגדות, הכנת מסמכים והגשתם, הזרמת הון, עניינים בנקאיים, בדיקת מען העסק ודרישות ענפיות. אנו תומכים גם בהנהלת חשבונות ובמיסוי הנובעים מההקמה ומהפעילות בטאיוואן.',
        ...
        },
        {
          ...
          paragraphs: [
            'קבוצה זו כוללת סכסוכים חוזיים, פיצויים בשל עוולה וסכסוכי צרכנות. העבודה מתחילה בדרך כלל בציר זמן, בבדיקת המסמכים והראיות הקיימות, ורק לאחר מכן באים הצעדים הבאים.',
        ...
        },
        {
          ...
          paragraphs: [
            'אנו מטפלים בגירושין (離婚), בחלוקת רכוש, בהפעלת הזכויות והחובות כלפי ילדים קטינים ובנשיאה בהן (未成年子女權利義務之行使或負擔), בקשר עם הילד (會面交往) ובירושה (繼承), גם כאשר הצדדים או הנכסים מצויים במדינות שונות. עניינים משפחתיים חוצי גבולות מצריכים לעיתים קרובות בדיקה נוספת של מרשם התושבים (戶籍), של צורת המסמכים ושל כוחם הראייתי בטאיוואן.',
        ...
        },
        {
          ...
          paragraphs: [
            'קבוצה זו כוללת סיום יחסי עבודה, פיצוי לפי דין טאיוואן (資遣費; אין להשוותו למוסדות דומים במדינות אחרות), שכר וסכסוכים מחוזה העבודה (勞動契約), הן מצד העובד והן מצד המעסיק. בבדיקה אנו מבחינים בין עילת הסיום לבין שאלות של הודעה מוקדמת, תשלום ומועדים.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'לעניינים פליליים יש לעיתים קרובות מועדים קצרים ושלבים קבועים. אם כבר קיבלתם מסמך מרשות החקירה או מבית המשפט, ציינו מוקדם את התאריך שעליו, כדי שהתוכן ייבדק בסדר הנכון.',
          ],
        },
        {
          heading: 'קניין רוחני',
          paragraphs: [
            'אנו תומכים ברישום סימני מסחר (商標) ופטנטים (專利), בזכויות יוצרים ובסכסוכים על זכויות אלה בטאיוואן.',
            'בקבוצה זו סדר הצעדים מכריע: היקף ההגנה, מועד ההגשה והשימוש בפועל משפיעים על הבחירה. הגשת בקשה אינה אומרת כשלעצמה שהיא תתקבל.',
          ],
        },
        {
          heading: 'ההיקף ואישורו',
          paragraphs: [
            'המשרד עובד לפי דין טאיוואן ומטפל בעניינים מהקבוצות שצוינו. היקף כל עניין מאושר בנפרד לאחר שעורכת דין או עורך דין בדקו את ההודעה שלכם.',
    ...
    about: {
      ...
      intro:
        'Hovering International Law Firm הוא משרד עורכי דין בטאיוואן. עורכות ועורכי הדין עוסקים מייעוץ לעסקים ועד ניהול הליכים בבית המשפט. חלק זה מתאר את היווסדות המשרד, את מקומותיו ואת העבודה עם צדדים זרים.',
      sections: [
        {
          heading: 'ייסוד ומבנה',
          paragraphs: [
            ...
            'יש לנו סניפים בטאיפיי (臺北), בקאוסיונג (高雄), בטאיצ׳ונג (臺中) ובפינגטונג (屏東). הסניף בקאוסיונג מתמקד בניהול עסקים ומטפל בסכסוכים אזרחיים, פליליים ומנהליים. הסניף בטאיצ׳ונג מטפל בעניינים הנדסיים, בקניין רוחני ובעניינים בעלי זיקה לקוריאה וליפן. הסניף בפינגטונג נפתח בשנת 2017 לצרכים המקומיים.',
            'לצד העבודה המשפטית פועל מאז שנת 2020 גם Hovering Accounting Office, המציע הנהלת חשבונות ותכנון מס ליזמים וליחידים בעלי נכסים.',
          ],
        },
        {
          heading: 'עבודה עם צדדים זרים',
          paragraphs: [
            'העבודה החוצה גבולות כוללת הקמת חברות, אשרות, הגשות של סימני מסחר ופטנטים, בדיקת סיכון משפטי וייעוץ מס לעסקים. הסניף בטאיצ׳ונג מטפל במיוחד בעניינים הנדסיים, בקניין רוחני ובעניינים בעלי זיקה לקוריאה וליפן. עורכת הדין Wei Tseng (曾雋崴) מלווה לקוחות מקוריאה, מיפן ולקוחות בין־לאומיים נוספים בקבוצות שצוינו.',
            'אם נוכל לקבל עניין תלוי בתוכן ובשפת התקשורת. אם העניין שלכם נכלל בקבוצות שצוינו וניתן לדון בו באחת מארבע שפות הייעוץ, אפשר לשלוח תקציר לבדיקה.',
          ],
        },
        {
          heading: 'כאשר אתם פונים אלינו',
          paragraphs: [
            'לאחר קבלת התקציר שלכם בודקת עורכת דין או בודק עורך דין את התוכן, ולאחר מכן משוחחים על היקף העבודה האפשרי, על המסמכים הנדרשים עדיין ועל הצעדים הבאים. בעניינים של מס או הנהלת חשבונות יכול המשרד לעבוד עם מחלקת הנהלת החשבונות ברצף אחד.',
    ...
    lawyers: {
      ...
      description: 'פרופילים של עורכות ועורכי הדין, של ההנהלה התפעולית ושל ביקורת החשבונות השותפה של Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
      ...
      description:
        'הסבר הסדר: תחילה היקף העבודה, לאחר מכן אישור העלויות, ומדוע אין בעמוד זה מחירון.',
      intro:
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            'התקציר שאתם שולחים בתחילה הוא הבסיס להיקף זה. ככל שיתאר בבירור רב יותר את ההשתלשלות, את בקשתכם ואת המועדים, כך אפשר יהיה לקבוע את ההיקף בדיוק רב יותר.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'הייעוץ עם עורכת דין או עורך דין עשוי להיות שירות בתשלום. עמוד זה אינו אומר שהשיחה הראשונה היא ללא תשלום, ואין לקרוא אף חלק ממנו במובן זה.',
    ...
    contact: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'ציינו מה קרה, לאיזו עזרה אתם זקוקים, מהי זיקת העניין לטאיוואן, ואת המועד אם הוא ידוע לכם. אם כבר קיבלתם מסמך מבית משפט או מרשות, ציינו את התאריך שעליו.',
      ...
      faqs: [
        {
          ...
          answer:
            'אנו מטפלים בשש קבוצות: השקעה והקמת חברות בטאיוואן, סכסוכים אזרחיים ופיצויים, נישואין, משפחה וירושה, סכסוכי עבודה, עניינים פליליים וקניין רוחני. אם עניין יתקבל — הדבר נקבע לאחר בדיקת התוכן.',
        },
        {
        ...
        {
          question: 'מה לעשות אם איני יכול להשתמש באף אחת מארבע השפות?',
          answer:
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'תוכן המשלוח שלכם נשמר במקום שאינו נגיש לציבור. רק בעלי הרשאה במשרד יכולים לגשת אליו, לצורך הטיפול בפנייה.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'עמוד זה אינו נוקב בתקופת שמירה קבועה, משום שהמשך הזמן בפועל תלוי בהתפתחות העניין ובחובות הכרוכות בו. אם ברצונכם מחיקה מוקדמת יותר, ציינו זאת בפנייה.',
          ],
        },
        {
          heading: 'מקום השמירה וספקים',
          paragraphs: [
            'אתר זה מתארח אצל Vercel, והמשלוח שלכם נשמר במאגר אובייקטים לא ציבורי של שירות זה. הודעות הדואר האלקטרוני נשלחות באמצעות שירות הדואר שבו משתמש המשרד.',
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'התוכן אינו ייעוץ לפי דין של שיטת משפט אחרת מזו של טאיוואן, ובכלל זה דין מקום מגוריכם. אם חלק מהעניין שלכם נוגע לשיטת משפט אחרת, נברר עמכם איזה בעל מקצוע מוסמך נדרש לאותו חלק.',
          ],
        },
        {
