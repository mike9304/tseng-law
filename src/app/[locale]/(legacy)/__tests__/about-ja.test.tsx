...
describe('Japanese About integration', () => {
  it('publishes Japanese metadata with the canonical locale and four-language alternates', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      'zh-Hans': `${SITE_URL}/zh-hans/about`,
      ms: `${SITE_URL}/ms/about`,
      ...
      cs: `${SITE_URL}/cs/about`,
      hu: `${SITE_URL}/hu/about`,
      ro: `${SITE_URL}/ro/about`,
      uk: `${SITE_URL}/uk/about`,
      el: `${SITE_URL}/el/about`,
      he: `${SITE_URL}/he/about`,
      bn: `${SITE_URL}/bn/about`,
      ur: `${SITE_URL}/ur/about`,
      fa: `${SITE_URL}/fa/about`,
      my: `${SITE_URL}/my/about`,
      ta: `${SITE_URL}/ta/about`,
      ne: `${SITE_URL}/ne/about`,
      km: `${SITE_URL}/km/about`,
      mn: `${SITE_URL}/mn/about`,
      sk: `${SITE_URL}/sk/about`,
      bg: `${SITE_URL}/bg/about`,
      hr: `${SITE_URL}/hr/about`,
      sr: `${SITE_URL}/sr/about`,
      sl: `${SITE_URL}/sl/about`,
      lt: `${SITE_URL}/lt/about`,
      lv: `${SITE_URL}/lv/about`,
      et: `${SITE_URL}/et/about`,
      ca: `${SITE_URL}/ca/about`,
      is: `${SITE_URL}/is/about`,
