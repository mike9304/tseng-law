...
const cards: BuilderCanvasNode[] = articles.flatMap((a, i) => {
  ...
  return [
    ...
    heading(`${prefix}-t`, { x: 24, y: 52, width: 312, height: 72 }, a.title, 3, '#1f2622', 'left', prefix),
    createTextNode({
      id: `${prefix}-d`,
      parentId: prefix,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-cafeblog-grid-title', { x: 80, y: GRID_Y, width: 400, height: 50 }, '최신 글', 2, '#1f2622', 'left'),
  ...cards,
  ...buildCategoryProofSections('cafe', 'cafe-blog', STAGE_H),
]);
