...
[Artikel 101 i Taiwans förordning om trafiksäkerhet (道路交通安全規則)](https://law.moj.gov.tw/LawClass/LawSingle.aspx?pcode=K0040013&flno=101) reglerar både de villkor under vilka omkörning är förbjuden och den ordning som ska följas när omkörning i samma körfält är tillåten.

Artikel 101 förbjuder omkörning på avsnitt med skyltar som anger kurva, brant lutning, smal bro, tunnel eller korsning, samt vid järnvägsövergångar och på vägarbetsområden.
...
Därefter ska det omkörande fordonet tända vänster blinkers, passera till vänster med minst 0,5 meters avstånd till fordonet framför och, när ett säkert avstånd är säkrat, tända höger blinkers och återgå tryggt till ursprungligt körfält.

Denna ordning av signaler och företräde i samma körfält betyder inte att omkörning skulle vara tillåten på en förbjuden plats eller under ett förbjudet villkor. Innan omkörningen påbörjas måste alla villkor i artikel 101 bedömas tillsammans.

## Anonymiserat olycksfall som byrån har hanterat
