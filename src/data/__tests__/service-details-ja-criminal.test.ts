...
const expectedCriminal = {
  ...
  keyPoints: [
    ...
    '台湾会社法第9条の刑事責任は、会社が受け取るべき株金について、実際には払い込まれていないのに申請書類上は全額払込済みと表示した場合、または株主が実際に払い込んだ株金を、登記後に会社責任者が株主へ返還し、もしくは株主による回収を許した場合に問題となります。会社責任者には5年以下の有期刑、拘役（台湾法上の短期自由刑）または50万以上250万新台湾ドル（NT$）以下の罰金が科され得ますが、通常の適法な会社資金の使用一般を処罰する規定ではありません。',
