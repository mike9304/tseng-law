...
> = {
  ...
  hu: {
    services: {
      answer:
        'Az iroda hat ügycsoportban jár el a tajvani jog szerint: befektetés és cégalapítás, polgári jogviták és kártérítés, házasság, család és öröklés, munkaügy, büntetőügyek és szellemi tulajdon. Az egyes ügyek terjedelmét külön erősítjük meg azt követően, hogy egy ügyvéd megvizsgálta a beküldött tartalmat. A tanácsadás kizárólag angolul, kínaiul, japánul és koreaiul zajlik.',
      sources: ['/hu/faq', '/hu/contact'],
    },
    about: {
      answer:
        'A Hovering International Law Firm tajvani ügyvédi iroda, amelyet 2016-ban a National Taiwan University (國立臺灣大學) végzettjei alapítottak, irodákkal Tajpejben, Kaohsziungban, Tajcsungban és Pingtungban. 2020 óta könyvviteli részleg is működik; a tajcsungi iroda koreai és japán kötődésű ügyekben jár el. Az iroda nem ígér eredményt. A tanácsadás kizárólag angolul, kínaiul, japánul és koreaiul zajlik.',
  ...
  el: {
    ...
    lawyers: {
      answer:
        'Η σελίδα αυτή δείχνει τα προφίλ των δικηγόρων της Hovering, του νομικού συνεργάτη, του υπευθύνου λειτουργιών και του συνεργαζόμενου λογιστή. Η δικηγόρος Wei Tseng (曾雋崴) έχει άδεια στην Ταϊβάν και είναι η διευθύνουσα δικηγόρος του γραφείου· συνεργάζεται με εντολείς από την Κορέα και την Ιαπωνία και με άλλους διεθνείς εντολείς. Η συμβουλευτική διεξάγεται μόνο στα αγγλικά, κινεζικά, ιαπωνικά και κορεατικά.',
  ...
  bn: {
    ...
    pricing: {
      answer:
        'এই পাতা মূল্যতালিকা প্রকাশ করে না। আগে আপনার পাঠানো সার থেকে কাজের পরিধি ঠিক হয়, তারপর ব্যয়ের অঙ্ক ও হিসাবের পদ্ধতি কাজ শুরুর আগে আপনার সঙ্গে নিশ্চিত হয়। আইনজীবীর সঙ্গে কথা হলে ফি লাগতে পারে; আইনজীবীর পারিশ্রমিকের বাইরে আদালত বা কর্তৃপক্ষের খরচও লাগতে পারে। পরামর্শ কেবল ইংরেজি, চীনা, জাপানি ও কোরীয় ভাষায় হয়।',
    ...
    faq: {
      answer:
        'এই অংশ সাধারণ তথ্যের স্তরে সচরাচর জিজ্ঞাসিত প্রশ্নের উত্তর দেয়: ছয় কর্মদল, যোগাযোগের আগে প্রস্তুতি, ব্যয় ঠিক হওয়ার পদ্ধতি এবং পাঠানো বার্তার অর্থ। পাঠানো অনুরোধ আইনজীবীর যাচাইয়ের অপেক্ষা করে; এটি আইনি মতামত নয়, সাক্ষাৎ নির্ধারণ নয় এবং আইনজীবী ও মক্কেলের সম্পর্ক তৈরি করে না। পরামর্শ কেবল ইংরেজি, চীনা, জাপানি ও কোরীয় ভাষায় হয়।',
  ...
  ur: {
    ...
    about: {
      answer:
        'Hovering International Law Firm تائیوان کا ایک قانونی دفتر ہے، 2016 میں National Taiwan University (國立臺灣大學) کے فارغ التحصیل وکلا نے قائم کیا، تائپے، کاؤشنگ، تائچونگ اور پنگٹنگ میں دفاتر کے ساتھ۔ 2020 سے اکاؤنٹنگ شعبہ ہے؛ تائچونگ دفتر کوریا اور جاپان سے جڑے معاملات کا کام کرتا ہے۔ دفتر نتیجے کا وعدہ نہیں کرتا۔ مشورہ صرف انگریزی، چینی، جاپانی اور کوریائی میں ہوتا ہے۔',
      sources: ['/ur/lawyers', '/ur/services'],
    },
    lawyers: {
      answer:
        'یہ صفحہ Hovering کے وکلا، دفتر کے انتظام کی قیادت اور شراکت دار سرٹیفائیڈ پبلک اکاؤنٹنٹ کی پروفائلز دکھاتا ہے۔ وکیلہ Wei Tseng (曾雋崴) تائیوان میں مجاز ہیں اور دفتر کی منتظمہ وکیلہ ہیں؛ وہ کوریا، جاپان اور دیگر بین الاقوامی موکلوں کے ساتھ کام کرتی ہیں۔ مشورہ صرف انگریزی، چینی، جاپانی اور کوریائی میں ہوتا ہے۔',
  ...
  ne: {
    ...
    faq: {
      answer:
        'यो भाग सामान्य जानकारीको तहमा बारम्बार सोधिने प्रश्नको उत्तर दिन्छ: छ वटा कार्यक्षेत्र, सम्पर्कअघिको तयारी, लागत तय हुने तरिका र पठाइएको सन्देशको अर्थ। पठाइएको अनुरोध अधिवक्ताको जाँचको प्रतीक्षा गर्छ; यो कानुनी राय होइन, निर्धारित भेट होइन र अधिवक्ता तथा पक्षकारबीचको सम्बन्ध बन्दैन। परामर्श अङ्ग्रेजी, चिनियाँ, जापानी र कोरियालीमा मात्र हुन्छ।',
  ...
  mn: {
    ...
    pricing: {
      answer:
        'Энэ хуудас үнийн жагсаалт нийтлэхгүй. Ажлын хэмжээг эхлээд таны илгээсэн товч тоймоор тогтоож, дараа нь хөлсний дүн, тооцох аргыг ажил эхлэхээс өмнө тантай баталгаажуулна. Өмгөөлөгчийн зөвлөгөө төлбөртэй үйлчилгээ байж болно; хөлснөөс гадна шүүх, захиргааны зардал гарч болно. Зөвлөгөө зөвхөн англи, хятад, япон, солонгос хэлээр явагдана.',
