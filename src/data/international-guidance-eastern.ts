...
export const greekGuidanceContent: GuidanceLocaleContent = {
  ...
  pages: {
    home: {
      ...
      description:
        'Γενικές εξηγήσεις στα ελληνικά για το αντικείμενο εντολής της Hovering International Law Firm στην Ταϊβάν, για τις γλώσσες της συμβουλευτικής και για την πρώτη επικοινωνία.',
      intro:
        'Η Hovering International Law Firm αναλαμβάνει υποθέσεις εντολέων από το εξωτερικό, και όσους έχουν δεσμό με την Ταϊβάν, σε ζητήματα του δικαίου της Ταϊβάν: επενδύσεις και σύσταση εταιρειών, αστικές διαφορές, γάμος, οικογένεια και κληρονομικά, εργατικό δίκαιο, ποινικές υποθέσεις και διανοητική ιδιοκτησία. Αυτό το ελληνικό μέρος σας βοηθά να αναγνωρίσετε ποια εργασία εμπίπτει στο αντικείμενό μας, τι να ετοιμάσετε και πώς να μας προσεγγίσετε. Πρόκειται για γενικές πληροφορίες, όχι για νομική συμβουλή στη δική σας υπόθεση.',
      sections: [
        {
    ...
    services: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Παριστάμεθα στην προκαταρκτική διαδικασία και ενώπιον του δικαστηρίου, τόσο υπόπτους και κατηγορουμένους όσο και παθόντες, και αξιολογούμε τους ποινικούς κινδύνους της επιχειρηματικής δραστηριότητας.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Στην κατηγορία αυτή κρίνει η σειρά των βημάτων: το εύρος της προστασίας, ο χρόνος της κατάθεσης και η πραγματική χρήση επηρεάζουν την επιλογή. Η κατάθεση αίτησης δεν σημαίνει από μόνη της ότι θα γίνει δεκτή.',
          ],
        },
        {
    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Η διασυνοριακή εργασία περιλαμβάνει σύσταση εταιρειών, θεωρήσεις, καταθέσεις σημάτων και διπλωμάτων ευρεσιτεχνίας, έλεγχο νομικού κινδύνου και φορολογική συμβουλευτική επιχειρήσεων. Το γραφείο στο Ταϊτσούνγκ χειρίζεται ιδίως υποθέσεις κατασκευών, διανοητικής ιδιοκτησίας και υποθέσεις με δεσμό προς την Κορέα και την Ιαπωνία. Η δικηγόρος Wei Tseng (曾雋崴) αναλαμβάνει υποθέσεις εντολέων από την Κορέα, την Ιαπωνία και άλλους διεθνείς εντολείς στις κατηγορίες που αναφέρθηκαν.',
        ...
        },
        {
          ...
          paragraphs: [
            'Μετά την άφιξη της περίληψής σας, δικηγόρος εξετάζει το περιεχόμενο και μιλά κατόπιν για το πιθανό αντικείμενο της εντολής, για τα έγγραφα που χρειάζονται ακόμη και για τα επόμενα βήματα. Σε φορολογικά ή λογιστικά ζητήματα το γραφείο μπορεί να εργαστεί μαζί με το λογιστικό τμήμα στο πλαίσιο ενιαίας διαδικασίας.',
    ...
    lawyers: {
      ...
      description: 'Προφίλ των δικηγόρων, της λειτουργικής διεύθυνσης και του συνεργαζόμενου λογιστικού γραφείου της Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Η σελίδα αυτή δεν δίνει απόλυτη εγγύηση ασφάλειας. Κανένας δρόμος μετάδοσης και κανένας χώρος αποθήκευσης δεν είναι απολύτως ασφαλής· τα ευαίσθητα έγγραφα θα πρέπει επομένως να αποστέλλονται μόνο μετά από ειδική οδηγία της δικηγόρου ή του δικηγόρου.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Ο ιστότοπος αυτός φιλοξενείται στη Vercel, και η αποστολή σας φυλάσσεται σε ιδιωτικό χώρο αποθήκευσης της ίδιας υπηρεσίας. Τα μηνύματα ηλεκτρονικού ταχυδρομείου αποστέλλονται μέσω της ταχυδρομικής υπηρεσίας που χρησιμοποιεί το γραφείο.',
