...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-proof',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-showcase',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-cta',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-proof-label',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-proof-title',
    parentId: 'tpl-ecommercecontact-wix-proof',
    rect: { x: 56, y: 92, width: 560, height: 82 },
    text: 'ecommerce contact 페이지의 핵심 신뢰 요소를 한눈에 보여줍니다',
    fontSize: 36,
    color: '#123b63',
    fontWeight: 'bold',
    lineHeight: 1.16,
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-proof-copy',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-metric-1',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-1-value',
    parentId: 'tpl-ecommercecontact-wix-metric-1',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-1-label',
    parentId: 'tpl-ecommercecontact-wix-metric-1',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-metric-2',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-2-value',
    parentId: 'tpl-ecommercecontact-wix-metric-2',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-2-label',
    parentId: 'tpl-ecommercecontact-wix-metric-2',
    rect: { x: 22, y: 76, width: 168, height: 38 },
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-metric-3',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-3-value',
    parentId: 'tpl-ecommercecontact-wix-metric-3',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-3-label',
    parentId: 'tpl-ecommercecontact-wix-metric-3',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-metric-4',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-4-value',
    parentId: 'tpl-ecommercecontact-wix-metric-4',
    rect: { x: 24, y: 28, width: 140, height: 42 },
    text: '3x',
    fontSize: 34,
    color: '#e8a838',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-metric-4-label',
    parentId: 'tpl-ecommercecontact-wix-metric-4',
    rect: { x: 24, y: 82, width: 150, height: 42 },
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-label',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-title',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-copy',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-showcase-visual',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-visual-title',
    parentId: 'tpl-ecommercecontact-wix-showcase-visual',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-visual-copy',
    parentId: 'tpl-ecommercecontact-wix-showcase-visual',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-1',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-1-title',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-1',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-1-copy',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-1',
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-2',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-2-title',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-2',
    rect: { x: 24, y: 26, width: 250, height: 34 },
    text: '선택 기준',
    fontSize: 22,
    color: '#123b63',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-2-copy',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-2',
    rect: { x: 24, y: 78, width: 250, height: 60 },
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-3',
    parentId: 'tpl-ecommercecontact-wix-showcase',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-3-title',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-3',
    rect: { x: 24, y: 26, width: 250, height: 34 },
    text: '다음 행동',
    fontSize: 22,
    color: '#123b63',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-showcase-card-3-copy',
    parentId: 'tpl-ecommercecontact-wix-showcase-card-3',
    rect: { x: 24, y: 78, width: 250, height: 60 },
  ...
  createContainerNode({
    id: 'tpl-ecommercecontact-wix-quote',
    parentId: 'tpl-ecommercecontact-wix-proof',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-quote-mark',
    parentId: 'tpl-ecommercecontact-wix-quote',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-quote-body',
    parentId: 'tpl-ecommercecontact-wix-quote',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-quote-role',
    parentId: 'tpl-ecommercecontact-wix-quote',
  ...
  createTextNode({
    id: 'tpl-ecommercecontact-wix-cta-label',
    parentId: 'tpl-ecommercecontact-wix-cta',
