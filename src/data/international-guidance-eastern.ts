    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Цей сайт розміщено у Vercel, і Ваше надсилання зберігається в непублічному об’єктному сховищі цієї служби. Листи надсилають через службу електронної пошти, якою користується фірма.',
