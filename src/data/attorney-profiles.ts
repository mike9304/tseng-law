  ...
  ja: {
    'wei-tseng': {
      ...
      summary: [
        ...
        '韓国人留学生のジム負傷損害賠償事件でNT$157万の損害賠償を認める一審判決を獲得した代表事例があり、WEI Lawyerチャンネルや外部メディアを通じて台湾法を解説しています。',
      ],
      ...
      notableMatters: [
        '韓国人留学生のジム負傷事件でNT$157万の損害賠償を認める一審判決を獲得',
      ...
      proofPoints: [
        ...
        '韓国人留学生のジム負傷損害賠償事件でNT$157万の損害賠償を認める一審判決を獲得した公開事例があります。',
