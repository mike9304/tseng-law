...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-ecabout-val-1-title', { x: 24, y: 16, width: 292, height: 32 }, '품질 우선', 3, '#1a1a2e', 'left', 'tpl-ecabout-val-1'),
  createTextNode({
  ...
  heading('tpl-ecabout-val-2-title', { x: 24, y: 16, width: 292, height: 32 }, '지속 가능성', 3, '#1a1a2e', 'left', 'tpl-ecabout-val-2'),
  createTextNode({
  ...
  heading('tpl-ecabout-val-3-title', { x: 24, y: 16, width: 292, height: 32 }, '고객 중심', 3, '#1a1a2e', 'left', 'tpl-ecabout-val-3'),
  createTextNode({
  ...
  ...buildCategoryContactMethods('ecommerce', 'ecommerce-about-dir', STAGE_H),
  ...buildCategoryProofSections('ecommerce', 'ecommerce-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
