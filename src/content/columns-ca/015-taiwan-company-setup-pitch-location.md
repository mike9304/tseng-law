---
title: "Constitució de societats a Taiwan — part avançada 3: cerca del local de negoci"
...
# Constitució de societats a Taiwan — part avançada 3: cerca del local de negoci

![Imatge principal](../images/015-taiwan-company-setup-pitch-location/featured-01.jpg)

(Els requisits de cada govern local de Taiwan difereixen, i el text següent és un exemple d’obertura d’un negoci de restauració a la ciutat de Taipei.)
...
Pot consultar sense cost si a l’adreça desitjada és possible obrir un «establiment de restauració».

Tanmateix, en consultar ha de carregar la «certificació registral de l’immoble de tipus 2» (建物登記第二類謄本, que conté informació detallada de l’edifici) de l’adreça del local de negoci.
...
![«rams objecte de consulta d’ofici» (主動查詢之營業項目)](../images/015-taiwan-company-setup-pitch-location/img-02.jpg)

«rams objecte de consulta d’ofici» (主動查詢之營業項目)
