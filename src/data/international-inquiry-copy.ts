...
export const internationalInquiryCopy: Record<InquiryCopyLocale, InternationalInquiryCopy> = {
  ...
  ur: {
    ...
    methodConfirmationNotice:
      'اگر آپ چار زبانوں میں سے کسی کا استعمال نہ کر سکیں تو "رابطے کے راستے کی تصدیق ضروری ہے" منتخب کریں۔ ہم جواب دیتے ہیں تاکہ دیکھا جا سکے کہ کوئی قابلِ عمل رابطے کا راستہ ہے یا نہیں؛ کسی اور زبان میں خدمت کی ضمانت نہیں اور جواب کی مدت کا وعدہ نہیں ہے۔',
    preparationNotice:
    ...
    successMessage:
      'ہم نے آپ کی درخواست وصول کر لی؛ وہ جانچ کا انتظار کرتی ہے۔ اس کا مطلب یہ نہیں کہ مشورہ ہو چکا یا ملاقات کا وقت تصدیق ہوا۔',
    savedNotificationPendingMessage:
      'آپ کی درخواست محفوظ ہے، مگر دفتر کو اطلاع ابھی تصدیق نہیں ہوئی۔ جو آپ نے لکھا وہ نہیں کھو تا۔ اگر جواب نہ ملے تو رابطہ صفحے کے ای میل پتے پر بھی لکھ سکتے ہیں۔',
    ...
    languageOptions: {
      ...
      ko: 'کوریائی (한국어)',
      'needs-method-confirmation':
        'چار زبانوں میں سے کوئی کارآمد نہیں — رابطے کے راستے کی تصدیق ضروری ہے',
    },
  },
  fa: {
    guidanceNotice:
  ...
  my: {
    ...
    methodConfirmationNotice:
      'ဘာသာစကား လေးမျိုးအနက် တစ်မျိုးမျိုး မသုံးနိုင်ပါက “ဆက်သွယ်နည်းကို အတည်ပြုရမည်” ကို ရွေးပါ။ အသုံးပြုနိုင်သော ဆက်သွယ်နည်း ရှိမရှိ စစ်ဆေးရန် ကျွန်ုပ်တို့ ပြန်ကြားသည်။ အခြားဘာသာဖြင့် ဝန်ဆောင်မှု ပေးမည်ဟု အာမမခံသည့်အပြင် ပြန်ကြားချိန်ကိုလည်း အာမမခံပါ။',
    preparationNotice:
    ...
    languageOptions: {
      ...
      ko: 'ကိုရီးယား (한국어)',
      'needs-method-confirmation':
        'ဘာသာစကား လေးမျိုးအနက် တစ်မျိုးမျိုး မသုံးနိုင်ပါ — ဆက်သွယ်နည်းကို အတည်ပြုရမည်',
    },
  },
  ta: {
    guidanceNotice:
    ...
    consultationNotice:
      'ஆலோசனை நான்கு மொழிகளில் நடைபெறும்: ஆங்கிலம், சீனம் (中文), ஜப்பானியம் மற்றும் கொரியன்.',
    methodConfirmationNotice:
      'நான்கு மொழிகளில் எதையும் பயன்படுத்த முடியாவிட்டால், “தகவல் தொடர்பு வழியை உறுதிப்படுத்த வேண்டும்” என்பதைத் தேர்ந்தெடுங்கள். சாத்தியமான தகவல் தொடர்பு வழி உள்ளதா என்று ஆய்வு செய்ய நாங்கள் பதிலளிக்கிறோம்; பிற மொழியில் சேவை உறுதி செய்யப்படவில்லை, பதிலளிக்கும் காலக்கெடும் வாக்குறுதி அல்ல.',
    preparationNotice:
    ...
    intro:
      'உங்கள் வழக்கைச் சுருக்கமாக விவரியுங்கள். அடுத்த படி குறித்துப் பேசுவதற்கு முன் வழக்கறிஞர் உள்ளடக்கத்தை ஆய்வு செய்கிறார்.',
    submitLabel: 'கோரிக்கையை அனுப்பவும்',
    submittingLabel: 'அனுப்பப்படுகிறது…',
    successMessage:
      'உங்கள் கோரிக்கையைப் பெற்றுள்ளோம்; அது ஆய்வுக்காகக் காத்திருக்கிறது. ஆலோசனை முடிந்துவிட்டது அல்லது சந்திப்பு உறுதிப்பட்டது என்று இதற்குப் பொருளல்ல.',
    savedNotificationPendingMessage:
      'உங்கள் கோரிக்கை பாதுகாக்கப்பட்டுள்ளது, ஆனால் அலுவலகத்திற்கு அறிவிப்பு இன்னும் உறுதிப்படவில்லை. நீங்கள் எழுதியது தொலைவதில்லை. பதில் வராவிட்டால், தொடர்புப் பக்கத்தின் மின்னஞ்சல் முகவரியிலும் எழுதலாம்.',
    receiptIdLabel: 'பெறுகை எண்',
    failureMessage:
  ...
  km: {
    ...
    methodConfirmationNotice:
      'បើលោកអ្នកប្រើមិនបានភាសាណាមួយក្នុង ៤ ភាសានេះ សូមជ្រើស «ត្រូវបញ្ជាក់វិធីទំនាក់ទំនង»។ យើងនឹងឆ្លើយតបដើម្បីពិនិត្យវិធីសាស្ត្រទំនាក់ទំនងដែលអាចប្រើបាន ប៉ុន្តែមិនធានាសេវាក្នុងភាសាផ្សេង និងមិនសន្យារយៈពេលឆ្លើយតបឡើយ',
    preparationNotice:
      'លោកអ្នកអាចសរសេរសេចក្ដីសង្ខេបជាភាសារបស់ខ្លួន។ អត្ថបទដើមត្រូវបានរក្សាទុកដូចដែលសរសេរ ហើយមិនត្រូវបានបកប្រែដោយស្វ័យប្រវត្តិឡើយ',
    heading: 'ផ្ញើសំណើពិគ្រោះយោបល់',
    intro:
      'សូមពណ៌នារឿងរបស់លោកអ្នកដោយសង្ខេប។ មេធាវីនឹងពិនិត្យខ្លឹមសារមុនជូនដំណឹងជំហានបន្ត។',
    ...
    savedNotificationPendingMessage:
      'សំណើរបស់លោកអ្នកត្រូវបានរក្សាទុកហើយ ប៉ុន្តែមិនទាន់បញ្ជាក់បានថាការជូនដំណឹងដល់ការិយាល័យបានសម្រេច។ អត្ថបទដែលលោកអ្នកសរសេរមិនបាត់បង់។ បើមិនទាន់បានទាក់ទងតប លោកអ្នកអាចផ្ញើអ៊ីមែលតាមអាសយដ្ឋាននៅទំព័រទំនាក់ទំនង។',
    ...
    originalTextPlaceholder:
      'សូមបញ្ជាក់ថាអ្វីបានកើតឡើង លោកអ្នកត្រូវការជំនួយអ្វី និងមានកាលកំណត់ឬទេ។ សូមកុំបញ្ចូលលេខលិខិតឆ្លងដែន លេខអត្តសញ្ញាណប័ណ្ណ ឬទិន្នន័យគណនីធនាគារ។',
    nameLabel: 'ឈ្មោះ',
    emailLabel: 'អ៊ីមែល',
    consentLabel:
    ...
    invalidEmailMessage: 'សូមបញ្ចូលអាសយដ្ឋានអ៊ីមែលឲ្យត្រឹមត្រូវ',
    tooLongMessage: 'អត្ថបទវែងពេក។ សូមធ្វើឲ្យខ្លីរួចផ្ញើម្ដងទៀត។',
    sourceLanguageNotice:
      'អត្ថបទនេះមានតែជាភាសា {language} ប៉ុណ្ណោះ ហើយតំណនឹងបើកទំព័រដើមនោះ',
    unavailableTranslationNotice:
      'ធាតុនេះមិនទាន់ត្រូវបានបកប្រែជាភាសានៃទំព័រនេះទេ។ តំណដែលសម្គាល់ភាសាដើមច្បាស់លាស់នឹងបើកទំព័រដើមឲ្យលោកអ្នកអាន។',
    ...
    languageOptions: {
      ...
      ja: 'ភាសាជប៉ុន (日本語)',
      ko: 'ភាសាកូរ៉េ (한국어)',
      'needs-method-confirmation': 'ប្រើមិនបានភាសាណាមួយក្នុង ៤ ភាសានេះ — ត្រូវបញ្ជាក់វិធីទំនាក់ទំនង',
    },
  },
  mn: {
    guidanceNotice:
  ...
  bg: {
    ...
    preparationNotice:
      'Можете да напишете кратко изложение на делото на своя език. Изходният текст се запазва така, както сте го написали, и не се превежда автоматично.',
    ...
    sourceLanguageNotice:
      'Тази статия е публикувана само на езика {language}; връзката отваря изходната страница.',
    unavailableTranslationNotice:
      'Този елемент още не е преведен на езика на тази страница. Връзката, която посочва езика на оригинала, отваря изходния текст.',
  ...
  sl: {
    ...
    languageOptions: {
      ...
      ko: 'Korejščina (한국어)',
      'needs-method-confirmation':
        'Noben od štirih jezikov ni uporaben — način sporazumevanja je treba potrditi',
    },
  },
  lt: {
    guidanceNotice:
