...
import { buildLawProofSections, SUBPAGE_PROOF_HEIGHT } from '../_shared/subpage-proof-sections';
...
function buildBlogCard(post: BlogPost, idx: number): BuilderCanvasNode[] {
  ...
  return [
    ...
    heading(`${cid}-title`, { x: 20, y: 196, width: 330, height: 72 }, post.title, 3, '#123b63', 'left', cid),
    createTextNode({
      id: `${cid}-date`,
      parentId: cid,
...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildLawProofSections('law-blog-list', STAGE_H),
]);
