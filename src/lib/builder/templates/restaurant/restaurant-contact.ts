...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('restaurant', 'restaurant-contact-dir', STAGE_H),
  ...buildCategoryProofSections('restaurant', 'restaurant-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
