...
Tuja znamka kozmetike, ki namerava na Tajvanu dajati izdelke v obtok, mora določiti, komu zaupa uvoz, kdaj dokonča registracijo izdelka (產品登錄), kdo upravlja informacijsko mapo izdelka (產品資訊檔案, Product Information File, PIF) in kje se hrani, in po kakšnem merilu se presoja označevanje (標示) in oglaševanje (廣告). Tuja znamka lahko bodisi uporabi krajevnega uvoznika bodisi dejavnost na Tajvanu opravlja sama, zato priprava prodaje ni končana že s tem, da je bila ustanovljena družba.
