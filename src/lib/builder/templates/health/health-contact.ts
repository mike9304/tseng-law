...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  createButtonNode({
    ...
    href: '#',
    variant: 'primary',
    style: { backgroundColor: '#2f8f75', borderRadius: 6 },
  }),
  ...
  ...buildCategoryContactMethods('health', 'health-contact-dir', STAGE_H),
  ...buildCategoryProofSections('health', 'health-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
