...
คำว่า “โลจิสติกส์” เป็นถ้อยคำในทางปฏิบัติที่มีความหมายกว้าง ความจำเป็นในการมีใบอนุญาตธุรกิจขนส่งสินค้าด้วยรถยนต์จึงมิได้ถูกกำหนดโดยชื่อบริษัทหรือประเภทกิจการที่จดทะเบียน (營業項目) เพียงอย่างเดียว หากบริษัทรับค่าตอบแทนและใช้รถยนต์บรรทุกสินค้าขนส่งสินค้าของผู้อื่น ก็อาจเข้าลักษณะธุรกิจขนส่งสินค้าด้วยรถยนต์ ในทางกลับกัน การเก็บรักษาสินค้าในคลัง การบรรจุหีบห่อ การดำเนินงานด้านระบบ การส่งสินค้าในฐานะเจ้าของสินค้า (貨主) และการเป็นตัวแทนรับจัดการขนส่ง (運送承攬) นั้น ต้องพิจารณาเป็นรายกรณีโดยอาศัยความสัมพันธ์ตามสัญญา ความรับผิดในการขนส่ง เนื้อหาของค่าตอบแทน ตลอดจนสภาพการเดินรถที่เป็นจริง
...
ธุรกิจขนส่งสินค้าด้วยรถยนต์ประเภททั่วไปโดยหลักต้องมีทุนขั้นต่ำ 25,000,000 ดอลลาร์ไต้หวันใหม่ (新臺幣, TWD) และรถยนต์บรรทุกสินค้าใหม่ตั้งแต่ 20 คันขึ้นไป อย่างไรก็ดี กิจการที่ประกอบธุรกิจขนย้ายบ้าน (搬家) โดยเฉพาะ ใช้เกณฑ์ 10,000,000 ดอลลาร์ไต้หวันใหม่ (TWD) และตั้งแต่ 8 คันขึ้นไป ส่วนกิจการที่ประกอบธุรกิจในพื้นที่จินเหมิน (金門) และเหลียนเจียง (連江, มัตสึ/馬祖) ใช้เกณฑ์ 10,000,000 ดอลลาร์ไต้หวันใหม่ (TWD) และตั้งแต่ 5 คันขึ้นไป โดยกรณีหลังมีข้อจำกัดด้านเขตพื้นที่ประกอบการด้วย สำหรับธุรกิจขนส่งด้วยรถบรรทุกขนาดเล็กที่บุคคลธรรมดาประกอบกิจการ มีข้อยกเว้นเฉพาะที่จำกัดต่างหาก ได้แก่ การใช้รถบรรทุกขนาดเล็กซึ่งเป็นของตนเอง 1 คัน อายุรถไม่เกิน 2 ปี การมีใบอนุญาตขับขี่รถยนต์ขนาดเล็กประเภทอาชีพ (小型車職業駕駛執照) และการมีทะเบียนราษฎรอยู่ในเขตอำนาจนั้น ทั้งนี้ ต้องแยกตรวจสอบแต่ละเรื่อง ได้แก่ การลงทุนของคนต่างชาติ การอนุมัติของกระทรวงคมนาคม ใบอนุญาตเตรียมการจัดตั้ง (籌設許可) การจดทะเบียนบริษัทหรือจดทะเบียนพาณิชย์ การเตรียมรถและสิ่งอำนวยความสะดวก ใบอนุญาตประกอบกิจการ (營業執照) และการเข้าเป็นสมาชิกสมาคมผู้ประกอบการประเภทเดียวกัน (同業公會)

### ทุนจดทะเบียน เกณฑ์จำนวนรถ และข้อยกเว้นที่จำกัด

เมื่อบริษัททั่วไปจะประกอบธุรกิจขนส่งสินค้าด้วยรถยนต์ขึ้นใหม่ โดยหลักต้องมีทุนขั้นต่ำ 25,000,000 ดอลลาร์ไต้หวันใหม่ (TWD) และรถใหม่ตั้งแต่ 20 คันขึ้นไป กรณีประกอบธุรกิจขนย้ายบ้านโดยเฉพาะ ใช้เกณฑ์ทุนขั้นต่ำ 10,000,000 ดอลลาร์ไต้หวันใหม่ (TWD) และรถใหม่ตั้งแต่ 8 คันขึ้นไป ส่วนกรณีประกอบกิจการในพื้นที่จินเหมินและเหลียนเจียง (มัตสึ) ใช้เกณฑ์ต่างหาก คือ ทุนขั้นต่ำ 10,000,000 ดอลลาร์ไต้หวันใหม่ (TWD) และรถใหม่ตั้งแต่ 5 คันขึ้นไป ผู้ประกอบการที่ใช้เกณฑ์จินเหมินและเหลียนเจียง ย่อมถูกจำกัดขอบเขตการประกอบกิจการตามเขตพื้นที่ที่ได้รับอนุญาต
...
ป้ายทะเบียนรถเพื่อการพาณิชย์ที่ออกให้แก่ผู้ประกอบธุรกิจขนส่งด้วยยานยนต์รายใหม่ ไม่อาจนำมาเพิกถอนโดยการส่งคืน (繳銷) หรือโอนเปลี่ยนชื่อผู้ถือกรรมสิทธิ์ตามทะเบียนรถ (過戶轉讓) ได้ภายในหนึ่งปีนับแต่วันที่ออกป้ายทะเบียน
...
หน่วยงานผู้รับผิดชอบการลงทุนของคนต่างชาติโดยทั่วไปในปัจจุบัน คือ กรมพิจารณาการลงทุน กระทรวงเศรษฐกิจ (經濟部投資審議司) อย่างไรก็ดี มิใช่ว่าการลงทุนของคนต่างชาติทุกกรณีจะใช้ช่องทางและขั้นตอนเดียวกัน การลงทุนในหลักทรัพย์จดทะเบียนในตลาดหลักทรัพย์หรือหลักทรัพย์นอกตลาด สาขา (分公司) ของบริษัทต่างชาติ เรื่องที่หน่วยงานผู้มีอำนาจของอุทยานวิทยาศาสตร์หรือนิคมอุตสาหกรรมเป็นผู้ดำเนินการ และการลงทุนจากจีนแผ่นดินใหญ่ อาจใช้ช่องทางที่ต่างกันหรืออยู่ภายใต้ระบบต่างหาก ในกรณีลงทุนในธุรกิจขนส่งสินค้าด้วยรถยนต์ ต้องตรวจสอบช่องทางการลงทุนที่ใช้บังคับ พร้อมทั้งต้องมีการอนุมัติประเภทกิจการตามมาตรา 35 แห่งพระราชบัญญัติทางหลวงด้วย
...
4. ดำเนินการจดทะเบียนบริษัทหรือจดทะเบียนพาณิชย์ให้แล้วเสร็จ แล้วจัดเตรียมสถานประกอบการที่ได้รับอนุมัติ สถานที่จอดรถ ระบบซ่อมบำรุง รถ การประกันภัย และการจัดองค์กร
5. ยื่นคำขอใบอนุญาตประกอบกิจการ เข้าเป็นสมาชิกสมาคมผู้ประกอบการประเภทเดียวกันที่เกี่ยวข้อง แล้วจึงเปิดดำเนินกิจการตามขอบเขตกิจการที่ได้รับอนุมัติ
...
- การเข้าเป็นสมาชิกสมาคมผู้ประกอบการประเภทเดียวกัน คำสั่งหรือการดำเนินการทางปกครอง (行政處分) ตลอดจนการค้างชำระภาษี ค่าธรรมเนียม หรือค่าปรับทางปกครอง (罰鍰)
...
### การลงทุน ใบอนุญาตทำงาน และสถานะการพำนัก (居留) เป็นคนละขั้นตอนกัน

แม้คนต่างชาติจะเป็นผู้ถือหุ้นหรือผู้ลงทุนของบริษัทเป้าหมาย ข้อเท็จจริงเพียงเท่านั้นย่อมไม่ทำให้ได้มาซึ่งสิทธิที่จะทำงานหรือสถานะการพำนักในไต้หวัน หากปฏิบัติงานในทางปฏิบัติในไต้หวัน เช่น การบริหารจัดการกิจการ การขาย การจัดรถ และการดูแลลูกค้า ต้องตรวจสอบก่อนเริ่มทำงานว่าจำเป็นต้องมีใบอนุญาตทำงานที่สอดคล้องกับหน้าที่การงานที่เป็นจริงหรือไม่ และต้องดำเนินขั้นตอนเกี่ยวกับการพำนักในลำดับถัดไปแยกต่างหากด้วย

การทำงานโดยไม่ได้รับอนุญาต อาจต้องรับค่าปรับทางปกครองและคำสั่งให้เดินทางออกนอกประเทศ แนวทางปฏิบัติว่าด้วยการห้ามเข้าประเทศที่ใช้บังคับอยู่ ซึ่งกำหนดโดยสำนักงานตรวจคนเข้าเมือง กระทรวงมหาดไทยไต้หวัน (內政部移民署) กำหนดระยะเวลาห้ามเข้าประเทศไว้โดยทั่วไป 3 ปีสำหรับการทำงานโดยผิดกฎหมาย แต่เงื่อนไขการยกเว้นหรือการลดระยะเวลาที่แนวทางฉบับเดียวกันกำหนดไว้ ก็อาจนำมาใช้บังคับได้ ผลมิได้ถูกชี้ขาดไปเองเพียงเพราะบุคคลภายนอกได้แจ้งเบาะแส แต่หน่วยงานที่มีอำนาจจะพิจารณาข้อเท็จจริง กฎหมายที่ใช้บังคับ และพฤติการณ์เฉพาะราย
...
- [กรมพิจารณาการลงทุน กระทรวงเศรษฐกิจ](https://mnscdn.moea.gov.tw/Mns/dir/content/Content.aspx?menu_id=42885)
