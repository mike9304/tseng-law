...
# Kā vērtē atbildību apdzīšanas negadījumā Taivānā?

![Attēls, kas skaidro atbildības vērtējumu apdzīšanas negadījumā Taivānā un drošu apdzīšanas gaitu](../images/012-taiwan-overtaking-accident-liability/featured-01.jpg)

Ja priekšējais transportlīdzeklis brauc lēni, apdzīšana (超車) var šķist parasta izvēle, taču tā ir braukšanas darbība ar ievērojamu risku. Pirms apdzīšanas sākšanas kopīgi jāizvērtē ceļa posms, satiksme abos virzienos, priekšā braucošo transportlīdzekļu kustība un tas, vai ir vieta drošai atgriešanai sākotnējā joslā.

## Apdzīšanas priekšnoteikumi, ko nosaka Ceļu satiksmes drošības noteikumu (道路交通安全規則) 101. pants

[Taivānas Ceļu satiksmes drošības noteikumu (道路交通安全規則) 101. pants](https://law.moj.gov.tw/LawClass/LawSingle.aspx?pcode=K0040013&flno=101) kopīgi regulē gan nosacījumus, kuros apdzīšana ir aizliegta, gan kārtību, kas jāievēro, kad apdzīšana tajā pašā joslā ir atļauta.

Ceļu satiksmes drošības noteikumu 101. pants aizliedz apdzīšanu posmos, kuros ir zīmes, kas apzīmē līkumu, stāvu slīpumu, šauru tiltu, tuneli vai krustojumu, kā arī dzelzceļa pārbrauktuvēs un ceļa būvdarbu posmos.
...
## Anonimizēta negadījuma lieta, ko kārtoja birojs
...
Pirms apdzīšanas vispirms jāpārbauda, vai vieta vai satiksmes situācija ietilpst apdzīšanas aizliegumā. Ja piemērojama tās pašas joslas gaita, jāsniedz noteiktais skaņas signāla vai tālās gaismas signāls, nepiespiežot priekšējo transportlīdzekli atbrīvot ceļu, jāgaida skaidra atbrīvošanas izpausme un apdzīšana jāpabeidz ar pietiekamu atstatumu un drošu atgriešanās attālumu.
...
> - [Jautājumi un atbildes par rīcību pēc ceļu satiksmes negadījuma Taivānā](/lv/columns/taiwan-traffic-accident-procedure)

Šis raksts ir vispārīga juridiskā informācija par apdzīšanas noteikumiem un atbildības vērtējumu negadījumos Taivānā; tas nav padoms par konkrētu lietu un nesola noteiktu iznākumu. Faktiskā atbildība var atšķirties pēc negadījuma vietas, transportlīdzekļu kustības, ātruma, signāliem, pierādījumiem, ekspertīzes (鑑定) un spēkā esošajām tiesībām; konkrētas lietas jāizvērtē atsevišķi pēc attiecīgajiem materiāliem.
