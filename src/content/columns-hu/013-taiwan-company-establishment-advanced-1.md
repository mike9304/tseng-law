...
# Társaságalapítás Tajvanon – elmélyítő rész 1
...
A Beruházásvizsgáló Főosztálynak ellenőriznie kell, hogy az érintett tőkét (資本額) ténylegesen beruházási célra használják-e fel,
...
Egy tajvani banki alkalmazott személyesen a számlanyitás szigorodásáról beszélt.

Az utóbbi időben sok külföldi a számla megnyitása után eltűnik, ezért a számlanyitás egyre szigorúbban folyik.

Már az alapozó részben egy olvasó azt jelezte, hogy a számlanyitás a legnehezebb lépés; a gyakorlat ezt megerősíti.
...
A külföldiek befektetéséről szóló törvény (外國人投資條例) 9. cikke szerint a jóváhagyott tőkehozzájárulásnak az illetékes szerv által rögzített határidőn (核定期限) belül teljes egészében meg kell érkeznie; a határidőt az egyes ügy jóváhagyási iratában kell ellenőrizni (a gyakorlatban gyakran körülbelül 1 évre rögzítik).

E határidőn belül van elég idő a cím megtalálására és a bérleti szerződés aláírására,

a banknál az előkészítő számla megnyitására és a tőke átutalására.
...
de a bevándorlási hivatal (移民署) nagyon zsúfolt; ezért korán kell érkezni, és sorszámot kell venni.
...
de a vizsgálat nem túlzottan szigorú.

Említhetők változatos munkahelyi tapasztalatok, ideértve a részmunkaidőt,
...
Ezért érdemes az üzlethelyiséget korán megkeresni.

Ha a bérbeadóval a tárgyalás nem folyik gördülékenyen,

szükség esetén javasolható a bérleti szerződés közjegyzői hitelesítése (公證) vagy további kaució.
...
Mint fentebb szerepel, a bank megvizsgálja a bérleti szerződést, és a helyszínen ellenőrzi a társaság címét.
