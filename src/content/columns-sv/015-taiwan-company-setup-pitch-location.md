...
Du kan utan avgift kontrollera om ”restaurangverksamhet” kan bedrivas på den önskade adressen.

För kontrollen måste du dock ladda upp ”utdrag ur byggnadsregistrering av typ 2” (建物登記第二類謄本, som innehåller detaljerade uppgifter om byggnaden) för driftställets adress.
...
Var därför uppmärksam på den punkten.
