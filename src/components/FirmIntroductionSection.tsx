  ...
  return (
    <section className="section section--light firm-intro-section" data-tone="light">
      <div className="container">
        <SectionLabel data-builder-surface-key="section-label">{content.sectionLabel}</SectionLabel>
        <article className="firm-intro-card">
          <div className="firm-intro-logo-wrap">
            <Image
              ...
              width={508}
              height={80}
              data-builder-surface-key="logo"
            />
          </div>
          <h2 className="firm-intro-title" data-builder-surface-key="headline">
            {content.title}
          </h2>
          <p className="firm-intro-subtitle" data-builder-surface-key="subtitle">
            {content.subtitle}
          </p>
          ...
          <p className="firm-intro-source">
            <a
              ...
              data-builder-surface-key="source-link"
            >
              {content.sourceLabel}
            </a>
          </p>
