...
export const internationalInquiryCopy: Record<InquiryCopyLocale, InternationalInquiryCopy> = {
  ...
  fil: {
    ...
    consultationNotice:
      'Ang aktuwal na konsultasyon ay isinasagawa lamang sa apat na wika: Ingles, Tsino (中文), Hapon, at Koreano.',
    methodConfirmationNotice:
    ...
    originalLanguagePlaceholder:
      'Halimbawa: Filipino, Biyetnames, Indonesyo, Thai, o ibang wika',
  ...
  uk: {
    ...
    methodConfirmationNotice:
      'Якщо Ви не володієте жодною з чотирьох мов, оберіть «Спосіб спілкування потребує підтвердження». Ми відповідаємо, щоб розглянути придатний спосіб спілкування, якщо такий є; послуги іншою мовою не гарантовано, а строку відповіді не обіцяно.',
    preparationNotice:
  ...
  el: {
    guidanceNotice:
      'Η σελίδα αυτή είναι γραμμένη στα ελληνικά ως γενικός προσανατολισμός, όχι ως νομική συμβουλή για την υπόθεσή σας.',
    consultationNotice:
      'Η συμβουλευτική διεξάγεται σε τέσσερις γλώσσες: αγγλικά, κινεζικά (中文), ιαπωνικά και κορεατικά.',
    methodConfirmationNotice:
      'Αν δεν μιλάτε καμία από τις τέσσερις γλώσσες, επιλέξτε «Ο τρόπος επικοινωνίας χρειάζεται επιβεβαίωση». Απαντούμε για να εξετάσουμε έναν εφικτό τρόπο επικοινωνίας, αν υπάρχει· υπηρεσία σε άλλη γλώσσα δεν είναι εγγυημένη, ούτε δίνεται υπόσχεση για προθεσμία απάντησης.',
    preparationNotice:
  ...
  fa: {
    ...
    methodConfirmationNotice:
      'اگر به هیچ‌یک از این چهار زبان صحبت نمی‌کنید، «لازم است شیوهٔ ارتباط تأیید شود» را برگزینید. پاسخ می‌دهیم تا ببینیم آیا روش ممکنی برای ارتباط هست؛ خدمت به زبان دیگر تضمین نمی‌شود و مهلت پاسخ وعده داده نمی‌شود.',
    preparationNotice:
    ...
    languageOptions: {
      ...
      ko: 'کره‌ای (한국어)',
      'needs-method-confirmation':
        'به هیچ‌یک از چهار زبان صحبت نمی‌کنم — لازم است شیوهٔ ارتباط تأیید شود',
    },
  },
  my: {
    guidanceNotice:
  ...
  mn: {
    ...
    methodConfirmationNotice:
      'Дөрвөн хэлний аль нэгээр нь ч харилцаж чадахгүй бол «Холбоо барих аргыг баталгаажуулах шаардлагатай» гэснийг сонгоно уу. Бид хариу өгч, хэрэгжүүлж болох холбоо барих арга байгаа эсэхийг шалгана; өөр хэл дээрх үйлчилгээ баталгаажихгүй бөгөөд хариу өгөх хугацааг амлахгүй.',
    preparationNotice:
    ...
    successMessage:
      'Таны хүсэлтийг хүлээн авсан; хяналтыг хүлээнэ. Энэ нь зөвлөгөө болсон эсвэл цаг товлолт баталгаажсан гэсэн үг биш.',
    savedNotificationPendingMessage:
      'Таны хүсэлтийг хадгалсан боловч фирмд очих мэдэгдэл хараахан баталгаажаагүй. Таны бичсэн зүйл алдагдахгүй. Хариу ирэхгүй бол холбоо барих хуудсын цахим шуудангийн хаяг руу ч бичиж болно.',
  ...
  sl: {
    ...
    methodConfirmationNotice:
      'Če ne obvladate nobenega od štirih jezikov posveta, izberite »Način sporazumevanja je treba potrditi«. Odgovorimo zato, da ocenimo, ali obstaja izvedljiv način sporazumevanja; storitev v drugem jeziku ni zagotovljena in rok za odgovor se ne obljublja.',
    preparationNotice:
