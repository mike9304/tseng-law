...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  /* ── Booking area ───────────────────────────────────────── */
  heading('tpl-petcon-book-title', { x: 80, y: BOOKING_Y, width: 400, height: 50 }, '진료 예약', 2, '#2b2018', 'left'),
  createContainerNode({
  ...
  ...buildCategoryContactMethods('pet', 'pet-contact-dir', STAGE_H),
  ...buildCategoryProofSections('pet', 'pet-contact', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
