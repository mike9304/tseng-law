...
export const DEFAULT_FAQ_CATEGORIES: BuilderFaqCategory[] = [
  ...
  },
  {
    ...
    slug: 'civil-traffic',
    label: { ko: '민사·교통사고', 'zh-hant': '民事與交通事故', en: 'Civil & Traffic' },
    description: {
  ...
  },
  {
    ...
    slug: 'family-divorce',
    label: { ko: '가사·이혼', 'zh-hant': '家事與離婚', en: 'Family & Divorce' },
    description: {
  ...
  },
  {
    ...
    slug: 'consultation',
    label: { ko: '상담·비용', 'zh-hant': '諮詢與費用', en: 'Consultation' },
    description: {
...
export function getFaqCategoryLabel(categoryId: string, locale: Locale): string {
