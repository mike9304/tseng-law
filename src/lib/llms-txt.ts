...
export const GUIDANCE_LLMS_NOTICES: Record<GuidanceLocale4, GuidanceLlmsNotices> = {
  vi: {
    ...
    discoveryNotice:
      'Tệp llms.txt này chỉ là bản đồ tra cứu các trang công khai; nó không hứa hẹn thứ hạng trên công cụ tìm kiếm, sự giới thiệu, khuyến nghị của trí tuệ nhân tạo hay việc đăng quảng cáo.',
    confidentialNotice:
  ...
  th: {
    ...
    discoveryNotice:
      'ไฟล์ llms.txt นี้เป็นเพียงแผนผังสำหรับค้นหน้าเว็บสาธารณะ ไม่ได้รับประกันอันดับในผลการค้นหา การได้รับการแนะนำ การแนะนำโดย AI หรือการลงโฆษณา',
    confidentialNotice:
  ...
  es: {
    ...
    discoveryNotice:
      'El archivo llms.txt es solo un mapa para localizar páginas públicas; no promete posicionamiento en buscadores, respaldo, recomendación ni visibilidad garantizada.',
    confidentialNotice:
  ...
  pt: {
    ...
    discoveryNotice:
      'O ficheiro llms.txt é apenas um mapa para localizar páginas públicas; não promete posicionamento em motores de busca, apoio, recomendação por inteligência artificial nem visibilidade garantida.',
    confidentialNotice:
  ...
  he: {
    ...
    discoveryNotice:
      'הקובץ llms.txt הוא מפה בלבד לאיתור העמודים הפומביים; אין בו הבטחה לדירוג בחיפוש, לגיבוי, להמלצה של בינה מלאכותית או לחשיפה מובטחת.',
    confidentialNotice:
  ...
  ta: {
    ...
    discoveryNotice:
      'llms.txt கோப்பு பொதுப் பக்கங்களைக் கண்டறிய உதவும் வரைபடம் மட்டுமே; தேடல் வரிசை, பரிந்துரை, செயற்கை நுண்ணறிவுப் பரிந்துரை அல்லது உறுதிசெய்யப்பட்ட தெரிவுநிலையை வாக்குறுதி அளிக்காது.',
    confidentialNotice:
  ...
  sk: {
    ...
    discoveryNotice:
      'Súbor llms.txt je iba mapou na nájdenie verejných stránok; nesľubuje poradie vo vyhľadávaní, zaštítanie, odporúčanie umelej inteligencie ani zaručenú viditeľnosť.',
    confidentialNotice:
  ...
  sr: {
    ...
    discoveryNotice:
      'Datoteka llms.txt samo je mapa za pronalaženje javnih stranica; ne obećava plasman u pretrazi, podršku, preporuku veštačke inteligencije niti zagarantovanu vidljivost.',
    confidentialNotice:
  ...
  sl: {
    ...
    discoveryNotice:
      'Datoteka llms.txt je le zemljevid za iskanje javnih strani; ne obljublja uvrstitve v iskanju, potrditve, priporočila umetne inteligence ali zagotovljene vidnosti.',
    confidentialNotice:
  ...
  ca: {
    ...
    discoveryNotice:
      'El fitxer llms.txt és només un mapa per localitzar pàgines públiques; no promet posicionament en cercadors, suport, recomanació ni visibilitat garantida.',
    confidentialNotice:
  ...
  is: {
    ...
    discoveryNotice:
      'Skráin llms.txt er aðeins kort til að finna opinberar síður; hún lofar hvorki sæti í leitarvélum, né meðmælum, né tillögu gervigreindar, né birtingu.',
    confidentialNotice:
