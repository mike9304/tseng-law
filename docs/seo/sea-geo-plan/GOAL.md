...
- [x] 2026-09-14 S0-e AI 인용 베이스라인(손빗 브라우저): **Perplexity 31/31 Y9·N22, ChatGPT 31/31 Y1(S0-17)·N30**, Google AIO 미실측(SERP CAPTCHA), Gemini/Claude/Grok 미실측(손빗 추가 시도 예정, 오면 추기) → docs/seo/geo-sea-baseline-2026-09.md §2.6·§3, evidence/aicite-2026-09-14/. 베이스라인 확정 = PP 9/31 · CG 1/31
...
- 9/14 14:0x 손빗 CG 실측 도착·커밋 → S0-e [x]. 남은 보드 항목 = S6 W1(9/16)·S4-d(9/23)뿐. Gemini 등 추가 결과는 오면 추기.
