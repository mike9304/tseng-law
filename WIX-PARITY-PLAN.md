...
| M158 | CMS | CMS collections/content manager v1 | F07~F16 | 24h | M157 | 🟡 F07~F11/F14/F15/F16 green; editable CRUD + duplicate/search/sort + bulk publish/draft/archive/delete + CSV mapping/summary/rollback + revisions + typed filters/saved views/stable pagination + typed field/validation UI + permissions UI/gates are in; F12~F13 hardening remain |
