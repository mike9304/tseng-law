...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  heading('tpl-blogabout-team-1-name', { x: 24, y: 12, width: 200, height: 28 }, '이수진', 3, '#1a1a1a', 'left', 'tpl-blogabout-team-1'),
  createTextNode({
  ...
  heading('tpl-blogabout-team-2-name', { x: 24, y: 12, width: 200, height: 28 }, '박준영', 3, '#1a1a1a', 'left', 'tpl-blogabout-team-2'),
  createTextNode({
  ...
  heading('tpl-blogabout-team-3-name', { x: 24, y: 12, width: 200, height: 28 }, '최하나', 3, '#1a1a1a', 'left', 'tpl-blogabout-team-3'),
  createTextNode({
  ...
  ...buildCategoryProofSections('blog', 'blog-about', STAGE_H),
]);
