    ...
    home: {
      ...
      sections: [
        ...
        },
        {
          heading: '页面语言与咨询语言',
          paragraphs: [
            '本页面以简体中文撰写。律师咨询以英语、中文、日语和韩语进行。咨询使用的中文，指普通话与书面中文。阅读本简体中文页面，并不表示某次咨询会以简体中文书面进行。',
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          question: '可以用中文咨询吗？',
          answer:
            '可以。律师咨询以英语、中文、日语和韩语进行。咨询使用的中文，指普通话与书面中文。阅读本简体中文页面，并不表示某次咨询会以简体中文书面进行。本页不承诺口译。书面翻译是另外的安排：您写下的原文会按原样保存，不会被自动翻译。',
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            '因此请不要仅凭一篇文章在真实事项中采取行动。文章只可作概览，具体问题仍须就您的文件与律师讨论；本页不是咨询步骤。',
          ],
        },
      ],
    },
