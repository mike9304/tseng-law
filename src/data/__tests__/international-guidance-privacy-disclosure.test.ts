...
const PENDING_CONFIRMATION: Record<(typeof GUIDANCE_LOCALES_4)[number], RegExp> = {
  ...
  my: /ရုံး၏အတည်ပြုချက်ကို စောင့်ဆိုင်း|ရုံးက မအတည်ပြုရသေး/,
  ...
  km: /រង់ចាំការបញ្ជាក់|មិនទាន់បានបញ្ជាក់/,
  mn: /фирмийн баталгааг хүлээж|фирм хараахан баталгаажуулаагүй/,
