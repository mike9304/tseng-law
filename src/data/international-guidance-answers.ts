...
> = {
  vi: {
    services: {
      answer:
        'Văn phòng nhận sáu lĩnh vực theo pháp luật Đài Loan: đầu tư và thành lập doanh nghiệp, tranh chấp dân sự và bồi thường, hôn nhân, gia đình và thừa kế, tranh chấp lao động, hình sự và sở hữu trí tuệ. Phạm vi từng vụ việc được xác nhận riêng sau khi luật sư xem xét nội dung quý vị gửi. Tư vấn chỉ được thực hiện bằng tiếng Anh, tiếng Trung, tiếng Nhật và tiếng Hàn.',
      sources: ['/vi/faq', '/vi/contact'],
    },
    about: {
      answer:
        'Hovering International Law Firm là văn phòng luật Đài Loan, thành lập năm 2016 bởi các luật sư tốt nghiệp Đại học Quốc lập Đài Loan (國立臺灣大學), có cơ sở tại Đài Bắc, Cao Hùng, Đài Trung, Bình Đông. Từ 2020 có bộ phận kế toán; cơ sở Đài Trung phụ trách việc liên quan đến Hàn Quốc, Nhật Bản. Văn phòng không cam kết kết quả. Tư vấn chỉ bằng tiếng Anh, tiếng Trung, tiếng Nhật và tiếng Hàn.',
      sources: ['/vi/lawyers', '/vi/services'],
    },
    lawyers: {
      answer:
        'Trang này giới thiệu các luật sư, quản lý nghiệp vụ và kế toán viên công chứng hợp tác của Hovering. Luật sư Wei Tseng (曾雋崴) có tư cách hành nghề tại Đài Loan và là luật sư điều hành của văn phòng, làm việc với khách hàng Hàn Quốc, Nhật Bản và khách hàng quốc tế. Việc tư vấn của văn phòng chỉ được thực hiện bằng bốn ngôn ngữ: tiếng Anh, tiếng Trung, tiếng Nhật và tiếng Hàn.',
  ...
  fil: {
    services: {
      answer:
        'Anim na larangan ng usapin ang hinahawakan ng tanggapan sa ilalim ng batas ng Taiwan: pamumuhunan at pagtatatag ng kompanya sa Taiwan, sibil na hidwaan at danyos, usaping pag-aasawa, pampamilya, at pagmamana, hidwaan sa paggawa, usaping kriminal, at intelektuwal na ari-arian. Hiwalay na kinukumpirma ang saklaw ng bawat usapin matapos suriin ng abogado ang ipinadala ninyo. Isinasagawa lamang sa Ingles, Tsino, Hapon, at Koreano ang konsultasyon sa abogado.',
  ...
  ur: {
    services: {
      answer:
        'دفتر تائیوان کے قانون کے مطابق چھ کام کے شعبوں میں خدمت دیتا ہے: سرمایہ کاری اور کمپنی کا قیام، دیوانی تنازعات اور تلافی، شادی، خاندان اور وراثت، ملازمت، فوجداری اور دانشورانہ ملکیت۔ ہر معاملے کا دائرہ اس مواد کی جانچ کے بعد الگ سے تصدیق ہوتا ہے جو آپ بھیجتے ہیں۔ مشورہ صرف انگریزی، چینی، جاپانی اور کوریائی میں ہوتا ہے۔',
    ...
    pricing: {
      answer:
        'یہ صفحہ نرخ نامہ شائع نہیں کرتا۔ پہلے آپ کے بھیجے خلاصے سے کام کا دائرہ طے ہوتا ہے، پھر لاگت کی رقم اور حساب کا طریقہ کام شروع ہونے سے پہلے آپ کے ساتھ تصدیق ہوتا ہے۔ وکیل سے بات معاوضے والی خدمت ہو سکتی ہے؛ وکیل کی فیس کے علاوہ عدالت یا ادارے کی لاگتیں بھی لگ سکتی ہیں۔ مشورہ صرف انگریزی، چینی، جاپانی اور کوریائی میں ہوتا ہے۔',
  ...
  my: {
    ...
    lawyers: {
      answer:
        'ဤစာမျက်နှာသည် Hovering ၏ ရှေ့နေများ၊ လုပ်ငန်းစီမံခန့်ခွဲမှုနှင့် တွဲဖက်စာရင်းကိုင်၏ ကိုယ်ရေးအချက်အလက်များကို ပြသည်။ ရှေ့နေမ Wei Tseng (曾雋崴) သည် ထိုင်ဝမ်တွင် လုပ်ကိုင်ခွင့်ရှိပြီး ရုံး၏ အမှုဆောင်ရှေ့နေမဖြစ်သည်။ သူမသည် ကိုရီးယား၊ ဂျပန်နှင့် အခြား နိုင်ငံတကာ အမှုသည်များနှင့် လုပ်ကိုင်သည်။ တိုင်ပင်ဆွေးနွေးမှုကို အင်္ဂလိပ်၊ တရုတ် (中文)၊ ဂျပန်နှင့် ကိုရီးယားဖြင့်သာ ဆောင်ရွက်သည်။',
    ...
    faq: {
      answer:
        'မကြာခဏမေးသော မေးခွန်းအပိုင်းသည် အထွေထွေအချက်အလက် အဆင့်တွင် ဖြေသည်။ လုပ်ငန်းအုပ်စု ခြောက်ခု၊ ဆက်သွယ်မီ ပြင်ဆင်ပုံ၊ ကုန်ကျစရိတ် သတ်မှတ်ပုံနှင့် ပေးပို့ပြီးသော စာ၏ အဓိပ္ပာယ်တို့ ပါဝင်သည်။ ပေးပို့ပြီးသော တောင်းဆိုချက်သည် ရှေ့နေ စစ်ဆေးရန် စောင့်ဆိုင်းသည်။ ဥပဒေအကြံဉာဏ် မဟုတ်၊ ချိန်းဆိုမှု မဟုတ်၊ ရှေ့နေနှင့်အမှုသည် ဆက်ဆံရေး မဖြစ်ပေါ်ပါ။ တိုင်ပင်ဆွေးနွေးမှုကို အင်္ဂလိပ်၊ တရုတ် (中文)၊ ဂျပန်နှင့် ကိုရီးယားဖြင့်သာ ဆောင်ရွက်သည်။',
  ...
  ta: {
    services: {
      answer:
        'அலுவலகம் தைவான் சட்டத்தின்படி ஆறு பணித்துறைகளில் சேவை செய்கிறது: முதலீடு மற்றும் நிறுவனம் அமைத்தல், உரிமையியல் தகராறுகள் மற்றும் இழப்பீடு, திருமணம், குடும்பம் மற்றும் வாரிசுரிமை, தொழிலாளர், குற்றவியல் மற்றும் அறிவுசார் சொத்து. ஒவ்வொரு வழக்கின் எல்லையும் நீங்கள் அனுப்பும் உள்ளடக்கத்தை வழக்கறிஞர் ஆய்வு செய்த பிறகு தனித்தனியாக உறுதிப்படுகிறது. ஆலோசனை ஆங்கிலம், சீனம், ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
      sources: ['/ta/faq', '/ta/contact'],
    },
    about: {
      answer:
        'Hovering International Law Firm தைவானின் ஒரு சட்ட அலுவலகம்; 2016-இல் National Taiwan University (國立臺灣大學) பட்டதாரிகளால் நிறுவப்பட்டது; தைப்பே, காவோசியூங், தைச்சுங் மற்றும் பிங்துங் அலுவலகங்களுடன். 2020 முதல் கணக்கியல் பிரிவு உள்ளது; தைச்சுங் அலுவலகம் கொரியா மற்றும் ஜப்பான் தொடர்பான வழக்குகளைக் கையாளுகிறது. அலுவலகம் முடிவை உறுதி செய்வதில்லை. ஆலோசனை ஆங்கிலம், சீனம், ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
      sources: ['/ta/lawyers', '/ta/services'],
    },
    lawyers: {
      answer:
        'இந்தப் பக்கம் Hovering வழக்கறிஞர்கள், செயல்பாட்டு நிர்வாகம் மற்றும் கூட்டாளர் கணக்காளரின் சுயவிவரங்களைக் காட்டுகிறது. வழக்கறிஞர் Wei Tseng (曾雋崴) தைவானில் தகுதி பெற்றவர் மற்றும் அலுவலகத்தின் நிர்வாக வழக்கறிஞர்; அவர் கொரியா, ஜப்பான் மற்றும் பிற பன்னாட்டுக் கட்சிக்காரர்களுடன் பணி செய்கிறார். வழக்கறிஞருடனான ஆலோசனை ஆங்கிலம், சீனம் (中文), ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றில் மட்டுமே நடைபெறும்; பிற மொழிகளில் ஆலோசனை வழங்கப்படுவதில்லை.',
      sources: ['/ta/about', '/ta/contact'],
    },
    pricing: {
      answer:
        'இந்தப் பக்கம் விலைப் பட்டியலை வெளியிடவில்லை. முதலில் நீங்கள் அனுப்பும் சுருக்கத்திலிருந்து பணி எல்லை தீர்மானிக்கப்படுகிறது; பிறகு செலவின் தொகையும் கணக்கீட்டு முறையும் பணி தொடங்கும் முன் உங்களுடன் உறுதிப்படுத்தப்படும். வழக்கறிஞருடனான உரையாடல் கட்டணச் சேவையாக இருக்கலாம்; வழக்கறிஞர் கட்டணத்திற்கு அப்பால் நீதிமன்றம் அல்லது அதிகார அமைப்பின் செலவுகளும் வரலாம். ஆலோசனை ஆங்கிலம், சீனம், ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
      sources: ['/ta/contact', '/ta/faq'],
    },
    contact: {
      answer:
        'தொடர்புப் படிவத்தின் வழியாக உங்கள் சுருக்கத்தை அனுப்புங்கள்: என்ன நடந்தது, எந்த உதவி தேவை, வழக்கிற்கும் தைவானுக்கும் உள்ள தொடர்பு, தெரிந்தால் காலக்கெடு. தொடக்கத்தில் அடையாள ஆவணங்கள் அல்லது முழுச் சான்றையும் அனுப்ப வேண்டியதில்லை. அலுவலகம் பதிலளிக்கும் காலக்கெடுவை வாக்குறுதி அளிக்கவில்லை; இந்தப் பக்கத்திலிருந்து சந்திப்பையும் உறுதிப்படுத்தவில்லை. ஆலோசனை ஆங்கிலம், சீனம், ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
      sources: ['/ta/faq', '/ta/pricing'],
    },
    faq: {
      answer:
        'இந்தப் பகுதி பொதுவான தகவல் மட்டத்தில் அடிக்கடி கேட்கப்படும் கேள்விகளுக்குப் பதில் தருகிறது: ஆறு பணிக் குழுக்கள், தொடர்புக்கு முன் தயாரிப்பு, செலவு தீர்மானிக்கப்படும் முறை மற்றும் அனுப்பிய செய்தியின் பொருள். அனுப்பிய கோரிக்கை வழக்கறிஞரின் ஆய்வுக்காகக் காத்திருக்கிறது; இது சட்டக் கருத்து அல்ல, உறுதிப்படுத்தப்பட்ட சந்திப்பு அல்ல, வழக்கறிஞருக்கும் கட்சிக்காரருக்கும் இடையே உறவையும் உருவாக்காது. ஆலோசனை ஆங்கிலம், சீனம், ஜப்பானியம் மற்றும் கொரியன் ஆகியவற்றிலேயே நடைபெறும்.',
  ...
  ne: {
    ...
    lawyers: {
      answer:
        'यो पृष्ठ Hovering का अधिवक्ता, सञ्चालन नेतृत्व र साझेदार लेखापालका प्रोफाइल देखाउँछ। अधिवक्ता Wei Tseng (曾雋崴) ताइवानमा व्यवसाय गर्न अधिकृत हुनुहुन्छ र फर्मकी प्रबन्ध अधिवक्ता हुनुहुन्छ; उहाँ कोरिया, जापान र अन्य अन्तर्राष्ट्रिय पक्षकारसँग काम गर्नुहुन्छ। परामर्श अङ्ग्रेजी, चिनियाँ, जापानी र कोरियालीमा मात्र हुन्छ।',
  ...
  km: {
    ...
    lawyers: {
      answer:
        'ទំព័រនេះណែនាំប្រវត្តិមេធាវី អ្នកគ្រប់គ្រងប្រតិបត្តិ និងដៃគូគណនេយ្យករនៃ Hovering។ មេធាវីស្ត្រី Wei Tseng (曾雋崴) មានសិទ្ធិអនុវត្តវិជ្ជាជីវៈនៅតៃវ៉ាន់ និងជាមេធាវីគ្រប់គ្រងនៃការិយាល័យ។ លោកស្រីធ្វើការជាមួយអតិថិជនពីកូរ៉េ ពីជប៉ុន និងអតិថិជនអន្តរជាតិផ្សេងទៀត។ ការពិគ្រោះយោបល់ធ្វើឡើងតែជាភាសាអង់គ្លេស ភាសាចិន (中文) ភាសាជប៉ុន និងភាសាកូរ៉េ។',
  ...
  bg: {
    ...
    about: {
      answer:
        'Hovering International Law Firm е адвокатска кантора в Тайван, основана през 2016 г. от възпитаници на National Taiwan University (國立臺灣大學), с офиси в градовете Тайпе, Гаосюн, Тайджун и Пиндун. От 2020 г. има счетоводно подразделение; офисът в Тайджун води дела, свързани с Корея и Япония. Кантората не обещава резултат. Консултацията се провежда само на английски, китайски, японски и корейски.',
