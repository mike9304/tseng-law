---
title: "Constitución de sociedades en Taiwán — parte avanzada 1"
...
# Constitución de sociedades en Taiwán — parte avanzada 1
...
Ello se debe a que el Departamento de Revisión de Inversiones debe confirmar si ese capital se utiliza realmente con fines de inversión.

También debe confirmar que no se trata de una entrada de fondos desde el exterior con otro pretexto.

Al redactar el plan de inversión no es necesario escribir la dirección exacta de la sociedad; basta con indicar la zona (por ejemplo, la ciudad de Taipéi). ​

Sin embargo, cuando más adelante se abre en el banco la cuenta de la sociedad en constitución (公司籌備處帳戶), muchos bancos revisan el contrato de arrendamiento (租賃契約) e inspeccionan in situ la dirección de la sociedad.

Un empleado de un banco taiwanés me dijo en persona lo siguiente.

Recientemente hay muchos casos de extranjeros que, tras abrir la cuenta, desaparecen, de modo que la apertura de cuentas se ha vuelto cada vez más estricta.

En la parte básica anterior un lector mencionó que la apertura de la cuenta es el trámite más difícil, y estoy de acuerdo.
...
Redacte el plan de inversión y busque la dirección de registro de la sociedad al mismo tiempo.

Según el artículo 9 del Estatuto de Inversión de Extranjeros (外國人投資條例), la aportación aprobada debe llegar por entero dentro del plazo fijado por la autoridad competente (核定期限), y ese plazo debe confirmarse en el documento de aprobación de cada caso (en la práctica suele fijarse en torno a 1 año).

Dentro de ese plazo, una vez encontrada la dirección de la sociedad y firmado el contrato de arrendamiento, queda margen.

Hay tiempo suficiente para abrir en el banco la cuenta de la sociedad en constitución y remitir el capital.
...
Si no tiene tarjeta de residencia, puede solicitar en la Administración de Inmigración de Taiwán el «formulario de datos básicos del número de identificación unificado» (統一證號基本資料表).

Puede expedirse el mismo día.

La Administración de Inmigración está muy concurrida, de modo que conviene ir temprano y tomar número.
...
El examen no es excesivamente estricto.

Puede mencionar experiencias laborales diversas, incluido el trabajo a tiempo parcial.

Conviene explicarlas con detalle de modo que pueda convencer a los revisores.
...
No es fácil que un extranjero arriende un local, porque el depósito de garantía en Taiwán es relativamente bajo (por lo general 2 meses) y la protección del propietario es escasa.

Los propietarios se resisten a arrendar a extranjeros.

Por tanto, se recomienda buscar el local de negocio desde temprano.

Si la negociación con el propietario no avanza con fluidez, cabe ofrecer algo más.

Si es necesario, puede proponer la notarización del contrato de arrendamiento o un depósito de garantía adicional.
...
Si se trata de un local de oficinas ordinario, el registro de la sociedad no es posible.
