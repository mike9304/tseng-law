...
describe('applyTranslationToLocaleDraft compact middle-dot rich text mark boundaries', () => {
  ...
  it('keeps compact middle-dot separators outside adjacent link and underline marks', async () => {
    ...
    if (node?.kind !== 'text') throw new Error('translated compact middle-dot text node was not written');
