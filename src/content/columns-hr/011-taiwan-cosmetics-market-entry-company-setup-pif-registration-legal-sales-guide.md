---
title: "Stupanje na tržište kozmetike na Tajvanu: izbor uvoznika, registracija proizvoda, sastavljanje i čuvanje PIF-a te regulacija reklame"
url: "https://www.wei-wei-lawyer.com/post/taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide"
lastmod: "2026-07-25"
date_display: "4. veljače 2026."
...
faq:
  ...
  - q: "Na koje izraze treba paziti u reklami kozmetike na Tajvanu?"
    a: "Reklama se ocjenjuje ne samo prema rečenici, nego prema cijelom izrazu, uključujući naziv proizvoda, tekst, sliku, simbol i zvuk. Zabranjeni su neistiniti ili pretjerani izrazi i tvrdnje o terapijskom učinku, a osobitu pozornost treba posvetiti medicinskim izrazima, kao što su liječenje akni, protuupalno djelovanje ili baktericidno djelovanje. Upravna novčana kazna iznosi 40.000 do 200.000 tajvanskih dolara (新臺幣, TWD) za neistinitu ili pretjeranu reklamu i 600.000 do 5.000.000 TWD za tvrdnju o terapijskom učinku. Objave influencera i drugih također treba ocjenjivati prema istom mjerilu, ako su u biti reklama."
---

# Stupanje na tržište kozmetike na Tajvanu: izbor uvoznika, registracija proizvoda, sastavljanje i čuvanje PIF-a te regulacija reklame

![Podloge proizvoda i pregled propisa potrebni za stupanje na tržište kozmetike na Tajvanu](../images/011-taiwan-cosmetics-market-entry-company-setup-pif-registration-legal-sales-guide/featured-01.jpg)

Strana marka kozmetike koja namjerava na Tajvanu stavljati proizvode u promet mora odrediti kome povjerava uvoz, kada dovršava registraciju proizvoda (產品登錄), tko upravlja informacijskim spisom proizvoda (產品資訊檔案, Product Information File, PIF) i gdje, te prema kojem se mjerilu ocjenjuje označavanje (標示) i reklama (廣告). Strane marke mogu rabiti mjesnog uvoznika i mogu djelatnost na Tajvanu voditi same, pa priprema prodaje nije dovršena samim osnivanjem društva.

Primjenjive se obveze mogu razlikovati prema vrsti proizvoda i mjestu proizvodnje (製造場所), stvarnom obliku uvoza, načinu prometa i sadržaju reklame. Niže se odvojeno objašnjavaju oblik stupanja i zakonski subjekt odgovornosti, registracija proizvoda kod TFDA-a, sastavljanje, ažuriranje i čuvanje PIF-a, označavanje i reklama te inspekcija i mjere ispravka. Prije utvrđivanja stvarnog rasporeda opskrbe treba ponovno, proizvod po proizvod, provjeriti najnovije propise i upute nadležnog tijela (主管機關).
...
Ako tajvanski uvoznik ili prodajni zastupnik (銷售代理商) obavlja uvoz i prodaju, strana marka može odabrati i strukturu bez vlastitog kćerinskog društva ili podružnice na Tajvanu. Prodajni zastupnik može istodobno djelovati kao uvoznik, ili se može uključiti zaseban uvoznik. Pravno pripisivanje odgovornosti međutim se ne određuje samo ugovornim nazivom, kao što su zastupnik, isključivi distributer ili trgovac.
...
Registracija proizvoda i PIF nisu isti postupak. Registracija proizvoda zasebna je radnja koja se provodi na platformi registracije kozmetičkih proizvoda TFDA-a (衛生福利部食品藥物管理署). PIF je spis koji okuplja podatke o kakvoći, sigurnosti, sastavu, tvrdnji o funkciji, načinu proizvodnje, rezultatima ispitivanja i ocjeni sigurnosti te koji proizvođač ili uvoznik kozmetike sastavlja, ažurira i čuva; sam PIF nije isprava koju bi trebalo unaprijed podnijeti TFDA-u. Od 1. srpnja 2026. načelno svi kozmetički pripravci spadaju pod režim PIF-a, s iznimkom krutog ručno izrađenog sapuna (固態手工香皂) proizvedenog na mjestu proizvodnje oslobođenom od upisa tvornice (工廠登記).
...
Registracija proizvoda radnja je prijave utvrđenih podataka na platformi. Dovršetak registracije ne znači da su potpune sve podloge potrebne za PIF, niti je ocjena da su označavanje ili reklama proizvoda u skladu s pravom. Raspored registracije proizvoda, upravljanje PIF-om i pregled označavanja i reklame treba voditi kao zasebne točke usklađenosti.

### Podloge PIF-a i stupnjevita primjena

PIF je zbirka podloga uređena tako da se i nadalje mogu objasniti kakvoća i sigurnost proizvoda. Osim kakvoće, sigurnosti, sastava, tvrdnje o funkciji (宣稱功能), načina proizvodnje, rezultata ispitivanja i ocjene sigurnosti, prema proizvodu treba urediti osnovne podatke o proizvodu i proizvođaču te potporne podloge, na primjer etiketu. Pravilnik o upravljanju informacijskim spisom kozmetičkih proizvoda (化粧品產品資訊檔案管理辦法) potrebne podloge razvrstava u 16 kategorija, pa prema vrsti proizvoda treba provjeriti podloge svake kategorije i zahtjeve za potpis i kvalifikaciju.
...
Reklama se ocjenjuje ne samo prema rečenici, nego prema cijelom izrazu, uključujući naziv proizvoda, tekst, sliku, simbol i zvuk. Zabranjeni su neistiniti ili pretjerani izrazi i tvrdnje o terapijskom učinku, a osobitu pozornost treba posvetiti medicinskim izrazima, kao što su liječenje akni, protuupalno djelovanje ili baktericidno djelovanje. Upravna novčana kazna iznosi 40.000 do 200.000 TWD za neistinitu ili pretjeranu reklamu i 600.000 do 5.000.000 TWD za tvrdnju o terapijskom učinku. Objave influencera i drugih također treba ocjenjivati prema istom mjerilu, ako su u biti reklama.
...
Upravna novčana kazna za neistinitu ili pretjeranu reklamu (虛偽誇大廣告) iznosi 40.000 do 200.000 TWD, a upravna novčana kazna za tvrdnju o terapijskom učinku iznosi 600.000 do 5.000.000 TWD. Budući da se raspon razlikuje prema vrsti povrede, prije objave treba usporediti cijeli reklamni izraz s potpornim podlogama.
...
Osnovnu strukturu društva i podružnice možete vidjeti u [Osnove osnivanja društva na Tajvanu](/hr/columns/taiwan-company-establishment-basics), opseg povezane potpore u [U čemu zastupamo klijente](/hr/services), a podatke o mjerodavnoj odvjetnici u [Međunarodni tim Hovering](/hr/lawyers).

### Službene podloge

- [Zakon o upravljanju higijenom i sigurnošću kozmetike](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030013)
- [Pravilnik o registraciji kozmetičkih proizvoda (化粧品產品登錄辦法)](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030097)
- [Pravilnik o upravljanju informacijskim spisom kozmetičkih proizvoda](https://law.moj.gov.tw/LawClass/LawAll.aspx?pcode=L0030098)
- [TFDA — objava o opsegu predmeta registracije kozmetičkih proizvoda](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30612)
- [TFDA — objava o stupnjevitoj primjeni PIF-a](https://www.fda.gov.tw/tc/newsContent.aspx?cid=3&id=30614)
- [TFDA — upute za sastavljanje PIF-a](https://www.fda.gov.tw/tc/includes/GetFile.ashx?id=f639179794512621908&iid=13384)
- [TFDA — posebna zona registracije kozmetičkih proizvoda](https://www.fda.gov.tw/TC/siteContent.aspx?sid=3435)
- [TFDA — posebna zona informacijskog spisa kozmetičkih proizvoda](https://www.fda.gov.tw/TC/site.aspx?sid=12523)
- [Mjerila ocjene označavanja, promocije i reklame kozmetike (化粧品標示宣傳廣告認定準則)](https://law.moj.gov.tw/LawClass/LawAll.aspx?PCODE=L0030099)
- [Službeni dodatak mjerila ocjene reklame kozmetike](https://law.moj.gov.tw/LawClass/LawGetFile.ashx?FileId=0000249593&lan=C)
- [Ministarstvo zdravstva i socijalne skrbi (衛生福利部) — objava o regulaciji reklame kozmetike](https://www.mohw.gov.tw/cp-4256-48110-1.html)
