...
Kui kaup Taiwani klientidega algab, võib välismaine peakontor saada mitmesuguseid palveid: käsitleda pakkumisi ja lepinguid Taiwanis, hoida varu kiireks asendamiseks või paigutada personali paigaldusse ja hooldusse (子公司). Siis küsitakse meelsasti esmalt: „Kas äriühingu asutamine Taiwanis (子公司) piisab selle lahendamiseks?“
...
See tekst on üldine juhis pooljuhtmaterjalide, -komponentide ja -seadmete ettevõtetele, kes kujundavad turule sisenemise struktuuri Taiwanis. Järgmised stsenaariumid ja kontrollikohad on hüpoteetilised näited ja hindamisettepanekud, mitte kindla ettevõtte tegelik volitus ega ühetaoline asutamise eeldus. Maksud, ekspordikontroll, tootespetsiifilised load ja investori liigitus nõuavad veel eraldi analüüsi.

## 1. Müügi ja tegevuse jaotus selgitatakse enne registreerimisvormi valikut

Oletame, et välismaine täppiskomponentide tootja müüb Taiwani klientidele. Alguses saadab peakontor otse, kuid klient palub hoida varuosi Taiwanis ja saada inseneride tuge kohapeal. Aadressist ei piisa: vaja on subjekti, kes saab müüa, importida, ladustada, palgata, anda tehnilist tuge ja kanda vastutust.

Enne turule sisenemise struktuuri otsustamist saab peakontor sisemiselt selgitada:

| Tegevuskoht | Küsimused, mis tuleb esmalt selgitada |
|---|---|
| Lepingud klientidega | Kes saab lepingupooleks: välismaine peakontor, Taiwani tütarettevõte või kohalik esindaja? |
| Pakkumised ja tellimused | Kes kinnitab lõplikult hinna ja tarneaja ning kui kaugele ulatub Taiwani vastutaja volitus? |
| Kaup ja varud | Kes impordib, hoiab ja juhib varusid ning käitleb tagastusi ja asendusi? |
| Personal | Kas peakontori töötajad reisivad, kas palgatakse Taiwanis või usaldatakse töö välisele teenuseosutajale? |
| Paigaldus ja tehniline tugi | Kes vastutab toe eest kliendile ja käitleb probleeme kohapealses töös? |
| Arveldamine ja kulud | Kes esitab arveid ja kogub tasu ning kuidas kulud arveldatakse peakontori ja Taiwani organisatsiooni vahel? |
| Kvaliteet ja vaidlused | Kes kinnitab kontrolli tulemuse ning võtab vastu kaebused puuduste või kahju kohta? |

Eriti kui ostulepingu müüja ei ole see ettevõte, kes annab tehnilist tuge, peavad dokumendid eristama, kellelt klient võib nõuda milliseid kohustusi.

## 2. Eristus tütarettevõtte, filiaali ja välismaise äriühingu esindusbüroo vahel Taiwanis

Sisenemise kavandamisel peab pooljuhtettevõte eristama, milline kohalolek Taiwanis asutatakse ja kuidas müük ning klienditeenindus korraldatakse. Esimene koht puudutab õigussubjektsust, registreerimise eeldusi ja tegevusala; teine tehinguviisi, volitusi ja vastutuse jaotust.
...
Kui otsustatakse asutada iseseisev juriidiline isik Taiwanis, tuleb ka valida selle vorm. Taiwanis on piiratud vastutusega äriühing (有限公司) ja aktsiaselts (股份有限公司).

### Piiratud vastutusega äriühing (有限公司): kergem juhtimine, kuid rangemalt piiratud osaluste üleandmine

Selle saab moodustada 1 või enama füüsilise isikuga (有限公司) või Taiwani või välismaiste juriidiliste isikutega osanikena; osanikud vastutavad põhimõtteliselt sissemakse summani. Äriühingul on 1–3 juhatuse liiget, valitud osanike hulgast. Osanikud, kes ei täida tegevust, võivad kasutada järelevalveõigust (監察人), seega ei ole vaja eraldi järelevalvajat nimetada. Kui põhikirjas ei ole teisiti määratud, kehtib 1 hääl iga 1 osaniku kohta, seega ei pea valitsev mõju vastama sissemakse suhtele. Tavalise osaniku sissemakse üleandmine eeldab põhimõtteliselt teiste hääleõiguste üle poole nõusolekut; juhatuse liikmele 2/3 või rohkem. See sobib paremini lihtsatele osanikesuhetele ja stabiilsele valitsevale mõjule kui korduvale kapitali kaasamisele või osaluste kauplemisele. Hiljem saab selle muuta aktsiaseltsiks (股份有限公司).

### Aktsiaselts (股份有限公司): sobiv, kui soovitakse võtta teisi investoreid või noteerimine on ette näha

Kapital jagatakse aktsiateks. Põhimõtteliselt nõutakse 2 osanikku või rohkem (股份有限公司), kuid riik või juriidiline isik võib selle asutada üksi ning välismaine juriidiline isik võib hoida 100 %. Aktsiad on põhimõtteliselt vabalt üleantavad, seadusjärgsete eranditega; eri liiki aktsiaid ja optsioone töötajatele saab kujundada seaduse järgi. See sobib ettevõtetele, kes ootavad investoreid, aktsiakauplemist, kapitalistiimuleid töötajatele või hilisemat ühinemist, omandamist või noteerimist; see ei piirdu suurte ettevõtetega. Juhtimises võib äriühing, mis ei ole teinud avalikku aktsiapakkumist, põhikirjaga olla ilma juhatuseta ning tal võib olla ainult 1 või 2 juhatuse liiget. Äriühing, mille ainus osanik on riik või juriidiline isik, võib põhikirjaga olla ilma järelevalvajata (監察人). Iga aktsiaselts (股份有限公司) ei pea andma majandusaasta aruannet vandeaudiitori kinnitamiseks (會計師查核簽證). Tavalise äriühingu olulisimad audiitorkünnised on sissemakstud kapital TWD 30.000.000 (新臺幣) või, selle all, käive TWD 100.000.000 või 100 töötajat Taiwani töötajate kindlustuses (勞工保險); avaliku aktsiapakkumise teinud äriühingud järgivad väärtpaberireguleerimist.
...
Kui välismaine äriühing asutab Taiwani tütarettevõtte, tehakse põhimõtteliselt nime eeluuring ning taotletakse investeerimisluba Majandusministeeriumi investeeringute läbivaatamise osakonnalt (經濟部投資審議司). Heakskiidu järel kantakse vahendid, kinnitatakse investeerimissumma ja vandeaudiitor (會計師) kontrollib kapitali, seejärel viiakse asutamine ja maksuregistreerimine lõpule.
...
Eelnev kirjeldab ainult menetlust, mitte seda, kuidas leping tuleks sõnastada. Ühe konkreetse vormi omamine ei tee tehingut seaduslikuks ega enneta vaidlusi.
...
Tööloa saamine on suhteliselt lihtsam Taiwani tütarettevõtte või välismaise äriühingu filiaali juhile. Teisele välismaalasele või järgmistele taotlemiseks nõuab tööministeerium valdkonna järgi künniseid kapitalile, käibele või muule (子公司). Kui on ette näha, et välismaist personali töötab Taiwanis, tuleb enne äriühingu asutamist kinnitada, kas kavandatud kapital saavutab kehtiva künnise.

## 7. Struktuurid, mis võivad tegevuse etapi järgi sobida

Järgmised stsenaariumid on hüpoteetilised kaalumise abiks; need ei kinnita, et kindel viis oleks seaduslik või parem (子公司).
...
### Kui Taiwanis on kliente, kas sinna tuleb tingimata asutada äriühing?

Seda ei saa otsustada ainuüksi seetõttu, et klient on Taiwanis. Tuleb vaadata kliendi nõudeid ja tegelikku tegevust müügi, rajatiste, personali ja tehingustruktuuri kohta Taiwanis ning seejärel valida üksus, mis vastab asjaoludele.
