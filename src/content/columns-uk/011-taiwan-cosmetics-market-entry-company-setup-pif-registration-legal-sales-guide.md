...
Чи маркування, просування (宣傳) або реклама є неправдивими чи перебільшеними, або чи заявляють медичну дієвість (醫療效能), не судять лише за одним визначеним словом. Разом розглядають назву товару, фразу, зображення, символ, звук, попередній і подальший контекст і загальне враження, яке отримує споживач. Враження, сформоване центральним рекламним поданням, не зникає автоматично лише обмежувальним написом дрібним шрифтом, тож треба переглядати і окремі формулювання, і готовий рекламний матеріал.
...
У договорі співпраці та в операційних вказівках можна визначити обсяг дозволених висловів і обґрунтувальні дані, розгляд перед публікацією та процедуру виправлення і видалення висловів, що не відповідають вимогам. Варто також включити до предмета перевірки вислови, додані в коментарях, усні пояснення в прямих трансляціях або коротких відео та розбіжність між сторінкою продажу та етикеткою. Переглянутий чернетковий текст, історію схвалення, прохання про виправлення та кінцеву публікацію треба зберігати, щоб пізніше можна було підтвердити факти.
...
Ця стаття є освітнім матеріалом, призначеним загально пояснити режим, пов’язаний із виходом бренду на ринок косметики Тайваню; це не юридична думка щодо конкретного продукту чи реклами і вона не стверджує, що дозвіл чи реєстрацію буде отримано, що продаж буде можливим, ані що строк розгляду буде дотримано. Форму виходу, дані продукту, зміст маркування та реклами і найновішу практику компетентного органу треба підтверджувати в кожній справі.
