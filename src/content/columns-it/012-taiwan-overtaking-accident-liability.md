...
Quando il veicolo davanti circola lentamente, sorpassare (超車) può sembrare un gesto abituale, ma si tratta di una manovra che comporta un rischio notevole. Prima di cominciare il sorpasso, si deve esaminare insieme il tratto di strada, la situazione del traffico nei 2 sensi, il movimento dei veicoli che precedono e lo spazio per tornare in sicurezza alla corsia originaria.
...
Per sorpassare il veicolo davanti nella stessa corsia, il conducente del veicolo di dietro deve prima suonare il clacson 2 volte brevemente o fare 1 solo lampeggio con i fari. Il clacson e i fari non devono essere utilizzati in modo ripetuto per forzare il veicolo davanti a cedere il passo.
