...
import {
  ...
  turkishGuidanceContent,
} from '@/data/international-guidance-western';

export type GuidanceLocale =
  | 'vi'
  | 'id'
  | 'th'
  | 'fil'
...
export const guidanceContent: Record<GuidanceLocale, GuidanceLocaleContent> = {
  ...
  th: {
    ...
    pages: {
        ...
        sections: [
          {
            ...
            paragraphs: [
              'สำนักงานให้ความช่วยเหลือแก่นักลงทุนและบริษัทต่างชาติที่จัดตั้งหรือดำเนินกิจการในไต้หวัน ทั้งการเลือกรูปแบบนิติบุคคล การเตรียมและยื่นเอกสาร การชำระเงินลงทุน (การนำทุนเข้าไต้หวัน) การดำเนินการกับธนาคาร การพิจารณาสถานประกอบการ และเงื่อนไขเฉพาะของแต่ละประเภทธุรกิจ นอกจากนี้ยังช่วยดูแลเรื่องบัญชีและภาษีที่เกิดจากการจัดตั้งและการดำเนินกิจการในไต้หวันด้วย',
          ...
          },
          {
            ...
            paragraphs: [
              'กลุ่มนี้ครอบคลุมการเลิกจ้าง ค่าชดเชยตามกฎหมายไต้หวัน (資遣費) ซึ่งไม่ควรถือว่าเหมือนกับหลักเกณฑ์ค่าชดเชยหรือการคุ้มครองเมื่อถูกเลิกจ้างของประเทศอื่น ค่าจ้าง และข้อพิพาทที่เกิดจากข้อกำหนดในสัญญาจ้างแรงงาน (勞動契約) ทั้งในฝ่ายลูกจ้างและฝ่ายนายจ้าง ในการตรวจสอบ เราจะแยกเหตุแห่งการเลิกจ้างออกจากประเด็นเรื่องการบอกกล่าว เงินที่ต้องจ่าย และกำหนดเวลา',
        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              'สำนักงานมีที่ทำการที่ไทเป (臺北) เกาสง (高雄) ไถจง (臺中) และผิงตง (屏東) สาขาเกาสงเน้นงานด้านการบริหารกิจการและกฎหมายบริษัท พร้อมทั้งรับข้อพิพาททางแพ่ง ทางอาญา และทางปกครอง สาขาไถจงรับงานก่อสร้าง ทรัพย์สินทางปัญญา และงานที่เกี่ยวข้องกับเกาหลีและญี่ปุ่น ส่วนสาขาผิงตงเปิดขึ้นในปี 2017 เพื่อรองรับความต้องการในพื้นที่',
              'นอกจากงานด้านทนายความแล้ว ในปี 2020 ได้มีการก่อตั้ง Hovering Accounting Office ซึ่งให้บริการด้านบัญชีและการวางแผนภาษีแก่เจ้าของกิจการและบุคคลผู้มีฐานะมั่งคั่ง',
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'ผลของแต่ละเรื่องขึ้นอยู่กับข้อเท็จจริงและเอกสารเฉพาะราย เราจึงไม่รับประกันผล หากท่านต้องการคำตอบที่แน่นอนสำหรับกรณีของท่าน ต้องนำเอกสารและข้อเท็จจริงนั้นไปหารือกับทนายความโดยตรง ในภาษาใดภาษาหนึ่งจาก 4 ภาษาที่ใช้ให้คำปรึกษา',
            ],
          },
        ],
      },
      ...
      pricing: {
        ...
        intro:
          'หน้านี้อธิบายวิธีกำหนดค่าใช้จ่าย ไม่ได้ระบุตัวเลข จำนวนค่าใช้จ่ายขึ้นอยู่กับขอบเขตงานของแต่ละเรื่อง และจะกำหนดตัวเลขได้ก็ต่อเมื่อขอบเขตดังกล่าวชัดเจนแล้ว',
        sections: [
          {
        ...
        sections: [
          {
            ...
            paragraphs: [
              'หากท่านไม่พบคำตอบสำหรับสถานการณ์ของท่าน โดยทั่วไปเป็นเพราะคำตอบขึ้นอยู่กับข้อเท็จจริงเฉพาะราย โปรดเขียนข้อเท็จจริงดังกล่าวไว้ในสรุปเรื่องเมื่อติดต่อเข้ามา แทนที่จะสรุปเอาเองจากเนื้อหาในหน้านี้',
            ],
          },
        ],
        faqs: [
        ...
        sections: [
          {
            ...
            items: [
              ...
              'ความยินยอมของท่านในการส่งเรื่อง',
          ...
          },
          {
            ...
            paragraphs: [
              'เมื่อส่งเรื่องสำเร็จ ระบบจะแจ้งไปยังสำนักงาน หากยังยืนยันไม่ได้ว่าการแจ้งเตือนไปถึงสำนักงานแล้ว ข้อความที่ท่านเขียนยังคงถูกบันทึกไว้และไม่สูญหาย',
          ...
          },
          {
            ...
            paragraphs: [
              'ท่านสามารถขอเข้าถึง แก้ไข หรือลบข้อมูลของท่าน หรือถอนความยินยอมได้ทางอีเมลตามที่อยู่ในหน้าติดต่อ หากมีหน้าที่ต้องเก็บรักษาตามกฎเกณฑ์ที่ใช้บังคับ หรือเนื่องจากมีเรื่องที่กำลังดำเนินอยู่ เราจะชี้แจงเหตุผลของข้อจำกัดนั้น',
  ...
  fil: {
    ...
    contactCta: 'Ipadala ang katanungan',
    footerNotice:
    ...
    mega: {
      services: {
        description: 'Hinahawakan ng tanggapan ang mga pangunahing larangan sa ilalim ng batas ng Taiwan.',
        viewAllLabel: 'Tingnan ang lahat',
      },
      columns: {
      ...
      lawyers: {
        description: 'Pagpapakilala sa mga abogado at sa paraan ng pakikipag-ugnayan sa tanggapan.',
        viewAllLabel: 'Tingnan ang lahat',
      },
      pricing: {
    ...
    home: {
      ...
      columnsOriginalLanguageBadge: 'Orihinal na wika',
      columnsOriginalLanguageNote:
      ...
      home: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'Anim na larangan ang saklaw ng gawain ng tanggapan. Mas detalyadong ipinapaliwanag ng pahinang “Mga usaping hinahawakan ng tanggapan” ang bawat larangan at ang mga bagay na hindi ginagarantiya.',
            ],
            items: [
          ...
          },
          {
            ...
            paragraphs: [
              'Basahin muna ang pahinang “Mga usaping hinahawakan ng tanggapan” upang makita kung kabilang sa saklaw ng gawain ang usapin ninyo, saka ang pahinang “Saklaw at bayarin” at “Makipag-ugnayan” upang malaman kung paano itinatakda ang saklaw at kinukumpirma ang bayarin bago magsimula ang trabaho.',
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Karaniwang maikli ang mga takdang panahon sa usaping kriminal at nakatakda ang mga yugto nito, kaya kung may natanggap na kayong papeles mula sa awtoridad, banggitin ninyo agad ang petsang nakasulat doon upang masuri ang nilalaman ayon sa tamang pagkakasunod-sunod.',
            ],
          },
          {
      ...
      contact: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'Sa form ng katanungan, maaari ninyong piliin ang “Kailangang kumpirmahin ang paraan ng pakikipag-ugnayan”. Sasagot kami upang magkasamang kumpirmahin kung paano tayo makakapag-usap kung may posibleng paraan, ngunit hindi garantisado ang serbisyo sa ibang wika at walang pangako sa panahon ng pagsagot.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Sa unang yugto ay hindi pa ninyo kailangang ipadala ang numero ng pasaporte, numero ng ID, detalye ng bank account, talaang medikal, o buong hanay ng ebidensya. Hintayin ang tagubilin ng abogado, at saka ipadala ang mga sensitibong dokumento sa ligtas na paraan.',
            ],
          },
          {
            heading: 'Ang mga hindi ginagarantiya ng pahinang ito',
            paragraphs: [
              'Hindi kami nangangako ng panahon ng pagsagot, hindi namin kinukumpirma ang appointment sa pahinang ito, hindi namin ipinapangako kung sinong abogado ang hahawak ng usapin, at hindi kami nangangako ng interpreter para sa pasalitang pag-uusap. Hiwalay dito ang usapin ng nakasulat na salin: hindi awtomatikong isinasalin ang mensaheng ipinadala ninyo.',
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'Iniimbak ang ipinadala ninyo sa isang lugar na hindi bukas sa publiko, at ang mga awtorisadong tao lamang sa tanggapan ang maaaring makakita nito upang asikasuhin ang mensahe.',
          ...
          },
          {
            ...
            paragraphs: [
              'Naka-host sa Vercel ang website na ito, at iniimbak ang ipinadala ninyo sa pribadong imbakan ng serbisyong iyon — hindi ito bukas sa publiko. Ipinapadala naman ang email sa pamamagitan ng serbisyo ng email na ginagamit ng tanggapan.',
              'Maaaring nasa labas ng Taiwan ang mga server ng ilang tagapagbigay ng serbisyo, kaya maaaring maimbak at maproseso roon ang impormasyon ninyo. Kapag natupad na ang layunin ng pag-iingat, binubura ang impormasyon nang walang pagkaantala; iniingatan naman sa buong takdang panahon ang impormasyong may tungkuling itago alinsunod sa mga umiiral na tuntunin. Tinatanggap sa wei@hoveringlaw.com.tw ang mga kahilingang may kinalaman sa personal na impormasyon.',
            ],
          },
        ],
      },
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Nabubuo lamang ang ugnayang iyon matapos masuri ang usapin at matapos kumpirmahin ng dalawang panig, sa sulat, na tinanggap ng tanggapan ang usapin.',
            ],
          },
          {
  ...
  ar: {
    ...
    home: {
      ...
      servicesAssistanceBefore:
        'إذا لم يتّضح لك إلى أي مجال تنتمي قضيتك، فإن صفحة ',
    ...
    pages: {
      home: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'يشمل نطاق عمل المكتب المجالات الستة الآتية. وتعرض صفحة «مجالات الخدمات» تفصيلًا أوفى لكل مجال وتبيّن ما لا يمكن ضمانه.',
            ],
            items: [
      ...
      services: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'يشمل هذا المجال منازعات العقود، ودعاوى التعويض عن الفعل الضار، ومنازعات المستهلك. ويبدأ العمل عادةً بترتيب مجريات الواقعة، وتحديد المستندات والأدلة المتوفرة، ثم بحث الخيارات المتاحة.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'وفي هذا المجال يكون الترتيب مهمًا: فنطاق الحماية ووقت تقديم الطلب وواقع الاستخدام الفعلي كلها تؤثّر في الخيارات المتاحة. وتقديم الطلب لا يضمن بذاته صدور سند الحماية.',
            ],
          },
          {
            heading: 'النطاق وكيفية تأكيده',
            paragraphs: [
              'يعمل المكتب وفق القانون التايواني ويقبل القضايا الداخلة في المجالات المذكورة أعلاه. ويُؤكَّد نطاق كل قضية على حدة بعد مراجعة المحامي لما ترسله.',
              'أما صفة الإقامة وتصريح العمل وما شابههما فتُبحَث على أساس ملف كل شخص ووقائعه، لا استنادًا إلى الجنسية. وإذا كان في قضيتك شقّ يتصل بهذه المسائل فاذكره بوضوح عند التواصل ليحدّد المحامي المجال الصحيح؛ ولا تتضمّن هذه الصفحة أي التزام بنتيجة أو بمدة للرد.',
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              'وللمكتب مكاتب في تايبيه (臺北) وكاوهسيونغ (高雄) وتايتشونغ (臺中) وبينغتونغ (屏東). ويركّز مكتب كاوهسيونغ على حوكمة الشركات وعلى المنازعات المدنية والجزائية والإدارية. ويتولّى مكتب تايتشونغ قضايا البناء والملكية الفكرية والأعمال المتصلة بكوريا واليابان. وافتُتح مكتب بينغتونغ عام 2017 لتلبية احتياجات المنطقة.',
      ...
      contact: {
        ...
        intro:
          'قبل التواصل، يُرجى الانتباه إلى ثلاثة أمور منفصلة. يسهل الخلط بينها، لكن لكل منها معنى خاص.',
        sections: [
          {
            heading: 'ثلاثة أمور ينبغي التمييز بينها',
            paragraphs: [
              'لغة عرض الصفحة، ولغة الجلسة مع المحامي، واللغة التي تكتب بها رسالتك، ثلاثة أمور مستقلة بعضها عن بعض.',
            ],
            items: [
        ...
        faqs: [
          {
            ...
            answer:
              'يقبل المكتب القضايا الداخلة في ستة مجالات: الاستثمار وتأسيس الشركات في تايوان، والمنازعات المدنية ودعاوى التعويض، وقضايا الزواج والأسرة والميراث، ومنازعات العمل، والقضايا الجزائية، والملكية الفكرية. أما قبول قضية بعينها فيتقرّر بعد مراجعة محتواها.',
          },
          {
          ...
          },
          {
            ...
            answer:
              'اختر بند «يلزم تأكيد طريقة التواصل» عند إرسال الطلب. وسيستخدم المكتب رسالة الرد لتأكيد طريقة التواصل إن وُجدت طريقة ممكنة. وهذه خطوة تأكيد، لا التزامٌ بأن نتمكّن من تقديم الدعم بلغة أخرى.',
          },
          {
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              'يُحفَظ ما ترسله في مكان غير متاح للعموم، ولا يُسمح بالاطلاع عليه إلا للأشخاص المخوّلين في المكتب لغرض معالجة الطلب.',
              'ولا تقدّم هذه الصفحة ضمانًا مطلقًا لأمن المعلومات. فلا يوجد نظام نقل وتخزين آمن أمانًا مطلقًا، ولذلك ينبغي ألا تُرسَل المستندات الحسّاسة إلا وفق إرشاد خاص من المحامي.',
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              'يمكنك طلب الاطلاع على معلوماتك أو تصحيحها أو حذفها، أو سحب موافقتك، بالتواصل عبر عنوان البريد الإلكتروني المذكور في صفحة التواصل. وإذا وُجد التزام قانوني بالحفظ، أو التزام بسبب قضية جارية، فسنبيّن سبب التقييد.',
          ...
          },
          {
            ...
            paragraphs: [
              'هذا الموقع مستضاف على Vercel، ويُحفَظ ما ترسله في مستودع بيانات غير علني لدى تلك الخدمة. ويُرسَل البريد الإلكتروني عبر خدمة البريد التي يستخدمها المكتب.',
              'وقد تكون خوادم بعض مقدّمي الخدمات خارج تايوان، وعندئذٍ قد تُحفَظ معلوماتك وتُعالَج هناك. وعند تحقّق الغرض من الحفظ تُحذَف المعلومات دون تأخير؛ أما المعلومات التي يوجد التزام قانوني بحفظها فتُحفَظ للمدة المقابلة. وتُستقبَل جميع الطلبات المتعلقة بالبيانات الشخصية على wei@hoveringlaw.com.tw.',
            ],
          },
        ],
      },
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'ومحتوى هذه الصفحات ليس رأيًا قانونيًا وفق قانون أي نظام قانوني آخر غير تايوان، بما في ذلك قانون مكان إقامتك. وإذا كان في قضيتك شقّ يخضع لاختصاص دولة أخرى، فسنؤكّد معك أي مختص مؤهَّل يلزم لذلك الشقّ.',
            ],
          },
          {
  ...
  'zh-hans': simplifiedChineseGuidanceContent,
