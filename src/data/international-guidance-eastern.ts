    ...
    pricing: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Витрати залежать від самої справи: від зусиль, кількості сторін, документів, строків і від того, чи вже триває провадження. Заздалегідь названа сума не відбила б витрат саме у Вашій справі. Тому ми спершу визначаємо обсяг роботи, а витрати повідомляємо потім, до початку роботи.',
