---
title: "Zagraniczne przedsiębiorstwa podzespołów półprzewodników, które wchodzą na Tajwan: jak ocenić spółkę zależną, oddział lub agenta"
lastmod: "2026-09-17"
date_display: "17 września 2026"
...
faq:
  ...
  - q: "Czy odpowiedzialność centrali zanika całkowicie, gdy zakłada się spółkę tajwańską?"
    a: "Jeśli zakładają Państwo spółkę zależną, a nie oddział, centrala co do zasady nie przyjmuje obowiązków umownych podpisanych w imieniu spółki zależnej. Trzeba jednak sprawdzić wyjątki z tytułu nadużycia osobowości prawnej oraz to, czy centrala udzieliła poręczenia lub przyjęła własne obowiązki umowne."
  - q: "Czy można zacząć od dystrybutora, a następnie przejść na spółkę na Tajwanie?"
    a: "Przejście etapami można zaplanować, ale trzeba też ponownie przejrzeć wygaśnięcie lub zmianę umów istniejących, umowy z klientami, zapasy, obsługę wad i personel."
---

# Zagraniczne przedsiębiorstwa podzespołów półprzewodników, które wchodzą na Tajwan: jak ocenić spółkę zależną, oddział lub agenta
...
Gdy zaczynają się operacje z klientami tajwańskimi, zagraniczna centrala może otrzymać różne wymagania: obsługiwać oferty i umowy na Tajwanie, posiadać zapas części do pilnej wymiany albo skierować personel instalacji i utrzymania. Łatwo wtedy zapytać najpierw: „Czy wystarczy założyć spółkę na Tajwanie, aby to rozwiązać?”

To, co trzeba najpierw wyjaśnić, to kto czym się zajmuje na Tajwanie. Struktura do oceny zmienia się zależnie od tego, czy zagraniczna centrala nadal podpisuje umowy sprzedaży, czy spółka tajwańska kupuje i odsprzedaje, czy też personel lokalny zapewnia tylko wsparcie techniczne.

Ten tekst jest ogólnym objaśnieniem dla zagranicznych przedsiębiorstw materiałów, podzespołów i urządzeń półprzewodnikowych, które projektują strukturę wejścia na Tajwan. Poniższe scenariusze i punkty kontroli są przykładami hipotetycznymi i propozycjami oceny, nie rzeczywistym zleceniem konkretnego przedsiębiorstwa ani jednolitym wymogiem założenia. Podatki, kontrola wywozu, zezwolenia według produktu i klasyfikacja inwestora wymagają jeszcze osobnej analizy.

## 1. Wyjaśnić podział operacji i handlu przed wyborem formy rejestracji

Załóżmy, że zagraniczny wytwórca podzespołów precyzyjnych sprzedaje klientom tajwańskim. Na początku centrala wysyła bezpośrednio, lecz klient prosi o składowanie części zamiennych na Tajwanie i wsparcie inżynierów na miejscu. Sam adres nie wystarczy: potrzebny jest podmiot, który może sprzedawać, importować, składować, zatrudniać, zapewniać wsparcie techniczne i ponosić odpowiedzialność.

Zanim centrala zdecyduje o strukturze wejścia, może wewnętrznie wyjaśnić:

| Punkt operacyjny | Pytania do wyjaśnienia najpierw |
|---|---|
| Umowy z klientami | Kto będzie stroną umowy: zagraniczna centrala, tajwańska spółka zależna czy lokalny agent? |
...
Zwłaszcza jeśli sprzedawca umowy sprzedaży nie jest przedsiębiorstwem, które zapewnia wsparcie techniczne, dokumenty muszą rozróżniać, od kogo klient może żądać jakich obowiązków.

## 2. Rozróżnienie spółki zależnej, oddziału i biura przedstawicielskiego spółki zagranicznej na Tajwanie
...
|---|---|---|
| Tajwańska spółka zależna | Zakłada się ją zgodnie z prawem Tajwanu, z własną osobowością prawną, i jest podmiotem prawnym odrębnym od zagranicznej spółki matki. | Ponieważ spółka zależna jest niezależną osobą prawną, trzeba potwierdzić, jak organizuje się dostawy, usługi, licencję technologiczną i podział kosztów ze spółką matką. |
| Tajwański oddział spółki zagranicznej | Oddział wpisany zgodnie z prawem na Tajwanie, bez osobowości prawnej odrębnej od centrali, różny od spółki zależnej założonej osobno. | Oddział jest częścią zagranicznej centrali, nie niezależną osobą prawną, więc centrala przyjmuje obowiązki bezpośrednio. Potwierdzić zakres uprawnień przedstawiciela oddziału oraz wewnętrzny podział umów zewnętrznych, dostawy, pokrycia wad i serwisu posprzedażowego. |
| Biuro przedstawicielskie na Tajwanie | Obecność wpisana zgodnie z art. 386 ustawy o spółkach (公司法第386條); nie może prowadzić działalności gospodarczej na Tajwanie. | Ponieważ nie może prowadzić działalności gospodarczej, potwierdzić, czy rzeczywista aktywność pozostaje w zakresie dozwolonym. |

## 3. Formy tajwańskiej spółki zależnej: spółka z ograniczoną odpowiedzialnością (有限公司) i spółka akcyjna (股份有限公司)

Jeśli zdecydują Państwo założyć niezależną osobę prawną na Tajwanie, trzeba też wybrać jej formę. Na Tajwanie istnieją spółka z ograniczoną odpowiedzialnością (有限公司) i spółka akcyjna (股份有限公司).

### Spółka z ograniczoną odpowiedzialnością (有限公司): zarządzanie prostsze, lecz zbywanie udziałów bardziej zamknięte

Może powstać z 1 lub więcej osób fizycznych albo ze wspólników będących osobami prawnymi tajwańskimi lub zagranicznymi; wspólnicy odpowiadają co do zasady do wysokości wkładu. Spółka ma od 1 do 3 dyrektorów, wybieranych spośród wspólników. Wspólnicy, którzy nie prowadzą spraw spółki, mogą wykonywać uprawnienia nadzoru, bez potrzeby odrębnego organu nadzoru (監察人). O ile statut nie stanowi inaczej, każdy wspólnik ma 1 głos, więc kontrola nie musi pokrywać się z proporcją wkładów. Zbycie wkładu zwykłego wspólnika wymaga co do zasady zgody więcej niż połowy praw głosu pozostałych, a dla dyrektora — zgody 2/3 lub więcej praw głosu pozostałych wspólników. Lepiej to pasuje do prostych relacji wspólników i stabilnej kontroli niż do częstego pozyskiwania kapitału lub obrotu udziałami. Później można przekształcić ją w spółkę akcyjną (股份有限公司).
...
Zakończenie rejestracji na Tajwanie nie oznacza, że personel zagranicznej centrali może automatycznie pracować na Tajwanie. Cudzoziemiec, który pracuje na Tajwanie, potrzebuje legalnego zezwolenia na pracę, a przy dłuższym pobycie — zezwolenia na pobyt. Co do zasady pracodawca występuje o zezwolenie na pracę i odpowiadające zezwolenie na pobyt.
...
Przy pierwszym spotkaniu można zebrać dane podstawowe centrali i inwestorów, ogólny opis produktu lub usługi, przewidywany przepływ operacji, plany personelu i instalacji na Tajwanie oraz warunki umowy i wsparcia, których żądają klienci. To, czego jeszcze nie ustalono, można oznaczyć jako „do ustalenia”.
...
### Czy odpowiedzialność centrali zanika całkowicie, gdy zakłada się spółkę tajwańską?

Jeśli zakładają Państwo spółkę zależną, a nie oddział, centrala co do zasady nie przyjmuje obowiązków umownych podpisanych w imieniu spółki zależnej. Trzeba jednak sprawdzić wyjątki z tytułu nadużycia osobowości prawnej oraz to, czy centrala udzieliła poręczenia lub przyjęła własne obowiązki umowne.

### Czy można zacząć od dystrybutora, a następnie przejść na spółkę na Tajwanie?

Przejście etapami można zaplanować, ale trzeba też ponownie przejrzeć wygaśnięcie lub zmianę umów istniejących, umowy z klientami, zapasy, obsługę wad i personel.
