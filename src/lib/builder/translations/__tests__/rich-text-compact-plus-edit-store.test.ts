...
describe('applyTranslationToLocaleDraft compact plus rich text mark boundaries', () => {
  ...
  it('keeps compact plus separators outside adjacent link and underline marks', async () => {
    ...
    if (node?.kind !== 'text') throw new Error('translated compact plus text node was not written');
