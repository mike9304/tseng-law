 ...
 */
// WO-X1 (EN-01, user decision 2026-09-23): the canonical EN profile now lists
// English, so every guidance language names it too.
export const guidanceLanguageNames: Record<GuidanceLocale, Record<string, string>> = {
  vi: { English: 'tiếng Anh', Korean: 'tiếng Hàn', Chinese: 'tiếng Trung', Japanese: 'tiếng Nhật' },
  id: { English: 'bahasa Inggris', Korean: 'bahasa Korea', Chinese: 'bahasa Mandarin', Japanese: 'bahasa Jepang' },
  th: { English: 'ภาษาอังกฤษ', Korean: 'ภาษาเกาหลี', Chinese: 'ภาษาจีน', Japanese: 'ภาษาญี่ปุ่น' },
  fil: { English: 'Ingles', Korean: 'Koreano', Chinese: 'Tsino', Japanese: 'Hapon' },
  ar: { English: 'الإنجليزية', Korean: 'الكورية', Chinese: 'الصينية', Japanese: 'اليابانية' },
  de: { English: 'Englisch', Korean: 'Koreanisch', Chinese: 'Chinesisch', Japanese: 'Japanisch' },
  es: { English: 'inglés', Korean: 'coreano', Chinese: 'chino', Japanese: 'japonés' },
  fr: { English: 'anglais', Korean: 'coréen', Chinese: 'chinois', Japanese: 'japonais' },
  pt: { English: 'inglês', Korean: 'coreano', Chinese: 'chinês', Japanese: 'japonês' },
  'zh-hans': { English: '英语', Korean: '韩语', Chinese: '中文', Japanese: '日语' },
  ms: { English: 'bahasa Inggeris', Korean: 'bahasa Korea', Chinese: 'bahasa Cina', Japanese: 'bahasa Jepun' },
  ru: { English: 'английский', Korean: 'корейский', Chinese: 'китайский', Japanese: 'японский' },
  tr: { English: 'İngilizce', Korean: 'Korece', Chinese: 'Çince', Japanese: 'Japonca' },
  it: { English: 'inglese', Korean: 'coreano', Chinese: 'cinese', Japanese: 'giapponese' },
  nl: { English: 'Engels', Korean: 'Koreaans', Chinese: 'Chinees', Japanese: 'Japans' },
  pl: { English: 'angielski', Korean: 'koreański', Chinese: 'chiński', Japanese: 'japoński' },
  hi: { English: 'अंग्रेज़ी', Korean: 'कोरियाई', Chinese: 'चीनी', Japanese: 'जापानी' },
  sv: { English: 'engelska', Korean: 'koreanska', Chinese: 'kinesiska', Japanese: 'japanska' },
  da: { English: 'engelsk', Korean: 'koreansk', Chinese: 'kinesisk', Japanese: 'japansk' },
  nb: { English: 'engelsk', Korean: 'koreansk', Chinese: 'kinesisk', Japanese: 'japansk' },
  fi: { English: 'englanti', Korean: 'korea', Chinese: 'kiina', Japanese: 'japani' },
  cs: { English: 'angličtina', Korean: 'korejština', Chinese: 'čínština', Japanese: 'japonština' },
  hu: { English: 'angol', Korean: 'koreai', Chinese: 'kínai', Japanese: 'japán' },
  ro: { English: 'engleză', Korean: 'coreeană', Chinese: 'chineză', Japanese: 'japoneză' },
  uk: { English: 'англійська', Korean: 'корейська', Chinese: 'китайська', Japanese: 'японська' },
  el: { English: 'αγγλικά', Korean: 'κορεατικά', Chinese: 'κινεζικά', Japanese: 'ιαπωνικά' },
  he: { English: 'אנגלית', Korean: 'קוריאנית', Chinese: 'סינית', Japanese: 'יפנית' },
  bn: { English: 'ইংরেজি', Korean: 'কোরীয়', Chinese: 'চীনা', Japanese: 'জাপানি' },
  ur: { English: 'انگریزی', Korean: 'کوریائی', Chinese: 'چینی', Japanese: 'جاپانی' },
  fa: { English: 'انگلیسی', Korean: 'کره‌ای', Chinese: 'چینی', Japanese: 'ژاپنی' },
  my: { English: 'အင်္ဂလိပ်', Korean: 'ကိုရီးယား', Chinese: 'တရုတ်', Japanese: 'ဂျပန်' },
  ta: { English: 'ஆங்கிலம்', Korean: 'கொரிய மொழி', Chinese: 'சீனம்', Japanese: 'ஜப்பானியம்' },
  ne: { English: 'अङ्ग्रेजी', Korean: 'कोरियाली', Chinese: 'चिनियाँ', Japanese: 'जापानी' },
  km: { English: 'ភាសាអង់គ្លេស', Korean: 'ភាសាកូរ៉េ', Chinese: 'ភាសាចិន', Japanese: 'ភាសាជប៉ុន' },
  mn: { English: 'англи', Korean: 'солонгос', Chinese: 'хятад', Japanese: 'япон' },
  sk: { English: 'angličtina', Korean: 'kórejčina', Chinese: 'čínština', Japanese: 'japončina' },
  bg: { English: 'английски', Korean: 'корейски', Chinese: 'китайски', Japanese: 'японски' },
  hr: { English: 'engleski', Korean: 'korejski', Chinese: 'kineski', Japanese: 'japanski' },
  sr: { English: 'engleski', Korean: 'korejski', Chinese: 'kineski', Japanese: 'japanski' },
  sl: { English: 'angleščina', Korean: 'korejščina', Chinese: 'kitajščina', Japanese: 'japonščina' },
  lt: { English: 'anglų', Korean: 'korėjiečių', Chinese: 'kinų', Japanese: 'japonų' },
  lv: { English: 'angļu', Korean: 'korejiešu', Chinese: 'ķīniešu', Japanese: 'japāņu' },
  et: { English: 'inglise', Korean: 'korea', Chinese: 'hiina', Japanese: 'jaapani' },
  ca: { English: 'anglès', Korean: 'coreà', Chinese: 'xinès', Japanese: 'japonès' },
  is: { English: 'enska', Korean: 'kóreska', Chinese: 'kínverska', Japanese: 'japanska' },
};
...
> = {
  ...
  nl: {
    ...
    'son-jungmin': {
      ...
      experience: ['Werkzaamheden voor Korea, Hovering International Law Firm'],
    },
    'huang-shengping': {
      intro: [
  ...
  hi: {
    ...
    'son-jungmin': {
      intro: [
        ...
        'सूचना विज्ञान की पढ़ाई के आधार पर दस्तावेज़ प्रणालियों और कार्यप्रवाह के जरिए विभागों के बीच समन्वय में सहायता करते हैं।',
      ],
  ...
  cs: {
    ...
    'son-jungmin': {
      intro: [
        ...
        'Koordinuje součinnost mezi regiony pomocí systémů dokumentů a pracovních postupů; vychází přitom ze vzdělání v informatice.',
      ],
      education: [
  ...
  uk: {
    ...
    'son-jungmin': {
      intro: [
        ...
        'Підтримує узгодження між напрямами за допомогою систем документів і робочих процесів; має освіту в галузі інформатики.',
      ],
      education: [
  ...
  el: {
    ...
    'son-jungmin': {
      intro: [
        ...
        'Υποστηρίζει την επικοινωνία μεταξύ των ομάδων μέσω συστημάτων εγγράφων και ροών εργασίας, με υπόβαθρο σπουδών πληροφορικής.',
      ],
      education: [
  ...
  my: {
    ...
    'chang-rongxuan': {
      intro: [
        'ယခင်က ထိုင်ဝမ် ပညာရေးဝန်ကြီးဌာန ဥပဒေရေးရာဌာန (Ministry of Education, Legal Affairs Division) တွင် အုပ်ချုပ်ရေးနှင့် တရားမအငြင်းပွားမှုကို အလေးထား၍ တာဝန်ထမ်းဆောင်ခဲ့သည်။',
      ...
      experience: [
        'ထိုင်ဝမ် ပညာရေးဝန်ကြီးဌာန ဥပဒေရေးရာဌာန',
  ...
  ta: {
    ...
    'son-jungmin': {
      intro: [
        ...
        'கணினி அறிவியல் அடிப்படையில் ஆவண அமைப்புகள் மற்றும் பணி ஓட்டம் மூலம் பிரிவுகளுக்கு இடையே ஒருங்கிணைப்பை ஆதரிக்கிறார்.',
      ],
