...
(na primer kada poslodavac kaže zaposlenom da će ga po prijemu poslati u inostrani ogranak koji u stvari ne postoji)
...
5. Kada poslodavac ne isplaćuje naknadu (工作報酬) prema ugovoru o radu, ili ne obezbeđuje dovoljnu količinu posla zaposlenom čija se naknada računa po komadu (按件計酬)

6. Kada poslodavac prekrši ugovor o radu ili radno pravo, tako da postoji rizik povrede prava i interesa zaposlenog

​

Najčešći primer jeste da poslodavac

ne isplaćuje platu (工資) na vreme,
...
Zakon o radnim standardima (勞動基準法) međutim predviđa da,
