...
export const LANGUAGE_REGION_LABELS: Record<PublicLocale8, Record<LanguageRegion, string>> = {
  ...
  ne: {
    global: 'विश्वव्यापी',
    'asia-pacific': 'एसिया–प्रशान्त',
    'middle-east': 'मध्यपूर्व',
    europe: 'युरोप',
  ...
  sk: {
    global: 'Celosvetovo',
    'asia-pacific': 'Ázia a Tichomorie',
  ...
  et: {
    global: 'Üleilmne',
    'asia-pacific': 'Aasia ja Vaikne ookean',
    'middle-east': 'Lähis-Ida',
    europe: 'Euroopa',
    americas: 'Ameerika',
  },
  ca: {
    global: 'Arreu del món',
    'asia-pacific': 'Àsia-Pacífic',
...
> = {
  ...
  bn: {
    open: 'অঞ্চল ও ভাষা বেছে নিন',
    title: 'অনুগ্রহ করে আপনার অঞ্চল ও ভাষা বেছে নিন',
    close: 'বন্ধ করুন',
  ...
  ne: {
    open: 'क्षेत्र र भाषा छान्नुहोस्',
    title: 'कृपया आफ्नो क्षेत्र र भाषा छान्नुहोस्',
  ...
  sk: {
    ...
    title: 'Zvoľte svoj región a jazyk',
    close: 'Zavrieť',
    current: 'Súčasný jazyk',
  },
  bg: {
  ...
  sr: {
    open: 'Izaberite region i jezik',
    title: 'Izaberite svoj region i jezik',
    close: 'Zatvorite',
  ...
  et: {
    ...
    title: 'Valige oma piirkond ja keel',
    close: 'Sulge',
    current: 'Praegune keel',
  },
  ca: {
    open: 'Seleccionar la regió i l’idioma',
    title: 'Seleccioni la seva regió i el seu idioma',
    close: 'Tancar',
    current: 'Idioma actual',
  },
  is: {
