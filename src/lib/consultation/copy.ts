...
const consultationCopy: Record<Locale, ConsultationCopy> = {
  ko: {
    ...
    assistantFallbackError:
      '지금은 AI 응답 연결이 불안정합니다. 아래 상담 신청란을 이용하시거나 이메일로 바로 문의해 주세요.',
    ...
    channelsDescription:
      '긴급하거나 사실관계가 복잡한 경우에는 AI 설명보다 이메일 문의가 더 적합합니다.',
    ...
    submitFailure:
      '지금은 자동 접수가 완료되지 않았습니다. 변호사 이메일로 바로 문의해 주세요.',
    sendLabel: '질문 보내기',
    ...
    placeholders: {
      ...
      phoneOrMessenger: 'name@example.com',
    ...
    fieldPrompts: {
      ...
      phone_or_messenger: '연락받을 이메일 주소를 남겨 주세요.',
  ...
  'zh-hant': {
    ...
    assistantFallbackError:
      '目前 AI 回覆連線不穩定。請改用下方諮詢表單，或直接透過 Email 聯繫我們。',
    ...
    channelsDescription:
      '若案件緊急、涉及期限，或事實關係複雜，Email 會比 AI 更合適。',
    ...
    fieldPrompts: {
      ...
      email: '若方便，請留下 Email。',
      phone_or_messenger: '請留下方便聯繫的 Email。',
  ...
  en: {
    ...
    assistantFallbackError:
      'The AI connection is unstable right now. Please use the intake form below or contact the firm directly through email.',
    ...
    channelsDescription:
      'If the matter is urgent, deadline-driven, or fact-intensive, email will be more appropriate than AI guidance.',
    ...
    submitFailure:
      'Automatic intake is unavailable right now. Please contact the firm directly through the lawyer review email.',
    ...
    fieldPrompts: {
      ...
      phone_or_messenger: 'Please leave the email address that is easiest for you.',
