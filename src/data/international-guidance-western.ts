...
export const russianGuidanceContent: GuidanceLocaleContent = {
  ...
  home: {
    ...
    columnsReviewLabel: 'Проверено адвокатом Вэй Цзэн',
  ...
  pages: {
      ...
      sections: [
        {
          ...
          paragraphs: [
            'Hovering International Law Firm — адвокатская фирма, учреждённая на Тайване. Она работает по праву Тайваня и имеет офисы Тайбэй (臺北), Гаосюн (高雄), Тайчжун (臺中) и Пиндун (屏東). Мы консультируем компании, ведём дела в суде и сопровождаем доверителей из-за рубежа через шаги, необходимые на Тайване.',
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'У уголовных дел часто короткие сроки и установленные стадии. Если Вы уже получили письмо органа уголовного преследования или суда, назовите дату на письме рано, чтобы содержание рассмотрели в верном порядке.',
          ],
        },
        {
    ...
    about: {
      ...
      intro:
        'Hovering International Law Firm — адвокатская фирма на Тайване. Адвокаты работают от консультации компаний до судебного разбирательства. Этот раздел описывает возникновение фирмы, места и работу с иностранными участниками.',
      sections: [
        {
          heading: 'Основание и структура',
          paragraphs: [
            'Hovering International Law Firm (昊鼎國際法律事務所) основана в 2016 году адвокатами, учившимися в National Taiwan University (國立臺灣大學). Китайское имя 昊鼎 соединяет знак 昊 («широкое небо») со знаком 鼎 («прочное основание») и описывает направление фирмы с момента основания.',
            'У нас есть офисы Тайбэй (臺北), Гаосюн (高雄), Тайчжун (臺中) и Пиндун (屏東). Офис Гаосюн сосредоточен на управлении компаниями и ведёт гражданские, уголовные и административные споры. Офис Тайчжун ведёт строительные дела, интеллектуальную собственность и дела, связанные с Кореей и Японией. Офис Пиндун открыт в 2017 году для местных нужд.',
        ...
        },
        {
          ...
          paragraphs: [
            'Трансграничная работа включает учреждение компаний, визы, подачу заявок на товарные знаки и патенты, проверку правовых рисков и налоговое консультирование компаний. Офис Тайчжун особенно ведёт строительные дела, интеллектуальную собственность и дела, связанные с Кореей и Японией. Адвокат Вэй Цзэн (曾雋崴) сопровождает доверителей из Кореи, Японии и других международных доверителей в названных группах.',
        ...
        },
        {
          ...
          paragraphs: [
            'После поступления Вашего краткого изложения адвокат рассматривает содержание и затем обсуждает возможный объём работы, ещё нужные документы и следующие шаги. При налоговых или бухгалтерских вопросах фирма может работать с бухгалтерским подразделением в одном процессе.',
            'Исход каждого дела зависит от фактов и имеющихся документов; мы не обещаем результата. Если Вам нужен обязывающий ответ по Вашему положению, документы необходимо обсудить с адвокатом на одном из четырёх языков консультации.',
          ],
        },
      ],
    },
    lawyers: {
      ...
      description: 'Профили адвокатов, руководства по операциям и партнёрской бухгалтерии Hovering.',
      intro: '',
      sections: [],
    },
    pricing: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Помимо гонорара адвоката могут возникнуть судебные, административные или расходы третьих лиц. Они отделены от гонорара и зависят от соответствующей процедуры.',
          ],
        },
      ],
    },
    contact: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Назовите, что произошло, какая помощь Вам нужна, какое отношение дело имеет к Тайваню, и срок, если Вы его знаете. Если Вы уже получили письмо суда или органа, назовите дату на письме.',
        ...
        },
        {
          ...
          paragraphs: [
            'Мы не обещаем срок ответа, не подтверждаем запись через эту страницу, не обещаем конкретного адвоката и не предоставляем переводчика. Письменный перевод — другое: Ваше сообщение автоматически не переводится.',
            'Если Вы отправляете запрос, содержание сохраняется и ждёт рассмотрения. Если через некоторое время ответа нет, Вы можете снова написать на адрес электронной почты, указанный на странице контактов.',
          ],
        },
      ],
    },
    faq: {
      ...
      intro:
        'Следующие вопросы отвечаются на уровне общих сведений. Ответ по Вашему делу возможен лишь после того, как адвокат рассмотрит документы.',
      sections: [
        {
          heading: 'Как пользоваться этим разделом',
          paragraphs: [
            'Если Вы не находите ответа на Ваше положение, ответ обычно зависит от особых фактов. Тогда запишите эти факты в краткое изложение, вместо того чтобы выводить их самостоятельно с этой страницы.',
          ],
        },
      ],
      faqs: [
        ...
        },
        {
          ...
          answer:
            'Нет. Эти сведения написаны на русском языке, но консультация с адвокатом проводится только на английском, китайском (中文), японском и корейском языках. Мы также не обещаем переводчика. Письменный перевод — другое: исходный текст, который Вы пишете, сохраняется как есть и автоматически не переводится.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'Исходный текст, который Вы пишете, сохраняется как есть и автоматически не переводится. При необходимости язык дальнейшего общения подтверждается вместе с Вами.',
        },
        {
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Номер получения, чтобы найти запрос снова',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'Содержание Вашей отправки хранится в месте, недоступном публично. Только уполномоченные лица в фирме могут получать к нему доступ для обработки запроса.',
        ...
        {
          heading: 'Уведомление и номер получения',
          paragraphs: [
            ...
            'Номер получения служит тому, чтобы найти Ваш запрос в наших записях. Он показывается после сохранения; Вы можете назвать его при повторном обращении.',
          ],
        },
        {
          heading: 'Ваши права и путь связи',
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            'Этот сайт размещён у Vercel, и Ваша отправка хранится в закрытом объектном хранилище этой службы. Письма отправляются через почтовую службу, которой пользуется фирма.',
    ...
    disclaimer: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Фирма практикует по праву Тайваня, и эта страница говорит только о работе в этих рамках.',
