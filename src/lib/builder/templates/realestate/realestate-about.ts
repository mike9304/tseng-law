...
const nodes: BuilderCanvasNode[] = assignCanvasNodeZIndices([
  ...
  ...buildCategoryContactMethods('realestate', 'realestate-about-dir', STAGE_H),
  ...buildCategoryProofSections('realestate', 'realestate-about', STAGE_H + CONTACT_METHODS_HEIGHT),
]);
