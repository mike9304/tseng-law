...
describe('Japanese contact route integration', () => {
  it('publishes the exact reviewed Japanese metadata contract', () => {
    ...
    expect(metadata.alternates?.languages).toEqual({
      ...
      cs: `${SITE_URL}/cs/contact`,
      hu: `${SITE_URL}/hu/contact`,
      ro: `${SITE_URL}/ro/contact`,
      uk: `${SITE_URL}/uk/contact`,
      el: `${SITE_URL}/el/contact`,
      he: `${SITE_URL}/he/contact`,
      bn: `${SITE_URL}/bn/contact`,
      ur: `${SITE_URL}/ur/contact`,
      fa: `${SITE_URL}/fa/contact`,
      my: `${SITE_URL}/my/contact`,
      ta: `${SITE_URL}/ta/contact`,
      ne: `${SITE_URL}/ne/contact`,
      km: `${SITE_URL}/km/contact`,
      mn: `${SITE_URL}/mn/contact`,
      sk: `${SITE_URL}/sk/contact`,
      bg: `${SITE_URL}/bg/contact`,
      hr: `${SITE_URL}/hr/contact`,
      sr: `${SITE_URL}/sr/contact`,
      sl: `${SITE_URL}/sl/contact`,
      lt: `${SITE_URL}/lt/contact`,
      lv: `${SITE_URL}/lv/contact`,
      et: `${SITE_URL}/et/contact`,
      ca: `${SITE_URL}/ca/contact`,
      is: `${SITE_URL}/is/contact`,
